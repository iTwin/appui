...
import { P as ConditionalStringValue, aI as purify, aJ as DOMPurifyNS } from "./appui-react-B-HDB5XE.js";
...
function Icon(props) {
  ...
  if (typeof iconSpecValue === "string") {
    ...
    if (iconString.startsWith("data:") || iconString.endsWith(".svg") || webComponentString) {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: cx("icon", "core-svg-icon", props.className), children: webComponentNode });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "i",
      {
        className: cx("icon", iconString, props.className),
        style: props.style
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "i",
    {
      className: cx("icon", "core-svg-icon", props.className),
      style: props.style,
