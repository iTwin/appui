const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./test-utils-WNGx7jEZ.js","./index-DVOlmhHI.js","./index-CdGyBOBZ.js","./react-18-Bmx1fhKs.js","./client-DmvY241V.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./iframe-D__3V3e7.js";
import { _ as __toESM, a as __commonJS, b as __export } from "./chunk-XP5HYGXS-BF4Vd9N7.js";
import { r as reactExports, R as React, a as React3 } from "./index-DVOlmhHI.js";
...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") ;
    ...
    let deprecatedTestUtils = await __vitePreload(() => import("./test-utils-WNGx7jEZ.js").then((n) => n.t), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
  let { renderElement, unmountElement } = await __vitePreload(async () => {
    const { renderElement: renderElement2, unmountElement: unmountElement2 } = await import("./react-18-Bmx1fhKs.js");
    return { renderElement: renderElement2, unmountElement: unmountElement2 };
  }, true ? __vite__mapDeps([3,1,4,2]) : void 0, import.meta.url), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? React.createElement(Story, { ...storyContext }) : React.createElement(ErrorBoundary, { showMain, showException }, React.createElement(Story, { ...storyContext })), element = Wrapper ? React.createElement(Wrapper, null, content) : content;
...
var parameters = { renderer: "react" }, decorators = [(story, context) => {
  ...
  try {
    let { configure } = await __vitePreload(async () => {
      const { configure: configure2 } = await import("./index-SfiJ37zs.js").then((n) => n.a);
