import { L as Logger, h as BeEvent } from "./Dialog-DTkGrnAC.js";
import { bo as SafeAreaInsetsHelpers, E as useBackstageManager, U as UiFramework, bp as useActiveFrontstageId, aH as ConditionalBooleanValue, aF as ConditionalStringValue, bq as Badge, br as isProviderItem, o as Icon, J as Icon$1, bs as useAvailableUiItemsProviders, bt as UiItemsManager, G as useIsBackstageOpen, bu as SafeAreaContext, bv as Backstage, r as SyncUiEventDispatcher } from "./appui-react-D5ydBozH.js";
...
class BackstageSeparator extends reactExports.PureComponent {
  render() {
    const className = cx("nz-backstage-separator", this.props.className);
...
class BackstageItem extends reactExports.PureComponent {
  render() {
    const className = cx("nz-backstage-item", this.props.isActive && "nz-active", this.props.isDisabled && "nz-disabled", this.props.safeAreaInsets && SafeAreaInsetsHelpers.getCssClassNames(this.props.safeAreaInsets), this.props.className);
    return (
