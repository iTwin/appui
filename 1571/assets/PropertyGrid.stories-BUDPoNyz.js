import { r as reactExports, R as React, j as jsxRuntimeExports, c as classnames, K as ButtonGroup, I as IconButton } from "./iframe-Vh1VhiK6.js";
import { a as BeEvent, f as PropertyValueFormat, e as ProgressRadial, m as BentleyError, n as BentleyStatus, h as assert, l as PropertyRecord, S as StandardTypeNames } from "./Key.enum-D1Zc0n-Y.js";
import { b0 as MutableCategorizedProperty, b1 as FlatGridItemType, b2 as MutableCategorizedPrimitiveProperty, b3 as MutableCustomGridCategory, b4 as MutableGridCategory, b5 as DRAFTABLE, aN as produce, b6 as VirtualizedPropertyGrid, aI as from, b7 as LinkifyIt, b8 as Orientation$1, b9 as UnderlinedButton, x as usePackageTranslation, ba as PropertyValueRendererManager, O as Orientation$2 } from "./components-react-DzfsRLZU.js";
import { U as UiComponents$1 } from "./UiComponents-BJoZ3eXm.js";
import { A as AppUiDecorator } from "./Decorators-ytBaitmo.js";
import { a as SubscriptionScheduler, d as defer, s as share, b as scheduleSubscription } from "./SubscriptionScheduler-P4lzPMa0.js";
...
const SvgCopy = (props) => {
  return reactExports.createElement(
    ...
    reactExports.createElement("path", { d: "M5 10H3a1 1 0 01-1-1V2a1 1 0 011-1h5a1 1 0 011 1v2h1V2a2 2 0 00-2-2H3a2 2 0 00-2 2v7a2 2 0 002 2h2zm8-4a1 1 0 011 1v7a1 1 0 01-1 1H8a1 1 0 01-1-1V7a1 1 0 011-1zm0-1H8a2 2 0 00-2 2v7a2 2 0 002 2h5a2 2 0 002-2V7a2 2 0 00-2-2z" })
  );
};
const SvgSelection = (props) => {
  return reactExports.createElement(
    "svg",
    { viewBox: "0 0 16 16", width: "1rem", height: "1rem", fill: "var(--iui-color-icon-muted, currentColor)", ...props },
    reactExports.createElement("path", { d: "M2 8H1V6h1zm10-8h-2v1h2zM2 3H1v2h1zm12-1h1V0h-2v1h1zm1 1h-1v2h1zm-1 5h1V6h-1zm0 1v.569l1 1.136V9zm-7 2h2v-1H7zM4 1h2V0H4zm3 0h2V0H7zM2 9H1v2h2v-1H2zm2 2h2v-1H4zM1 2h1V1h1V0H1zm9.993 11.994V8.208a.247.247 0 01.053-.146.184.184 0 01.283-.014l3.616 4.109a.229.229 0 01.045.076.234.234 0 01-.11.29l-1.264.572.828 2.273a.24.24 0 01-.11.291l-.723.338h-.08a.186.186 0 01-.18-.132l-.828-2.254-1.264.572a.153.153 0 01-.18 0 .246.246 0 01-.086-.189z" })
  );
};
...
const VirtualizedPropertyGridWithDataProvider = (props) => {
  ...
  return React.createElement(DelayedLoaderRenderer, { shouldRenderLoader: inProgress || !model }, model && React.createElement(VirtualizedPropertyGrid, {
    ...props,
    model,
    eventHandler,
...
const createStructRecord = (property2, value) => {
  return new PropertyRecord({
    ...
    typename: "struct",
    name: property2.displayLabel,
    ...property2
  });
};
const createArrayRecord = (property2, value) => {
  return new PropertyRecord({
    valueFormat: PropertyValueFormat.Array,
    items: Array.from({
      length: value.count
    }, (_, index) => value.createItem(index)),
...
const PropertyActions = {
  args: {
    ...
    actionButtonRenderers: [({
      ...
      if (property2.property.displayLabel === "Property with actions" && isPropertyHovered) {
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(ButtonGroup, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { label: "Copy", styleType: "borderless", size: "small", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SvgCopy, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { label: "Focus", styleType: "borderless", size: "small", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SvgSelection, {}) })
        ] });
      }
    }]
  }
...
const __namedExportsOrder = ["Basic", "ComplexProperties", "SimpleCategorization", "StructRendering", "ArrayRendering", "NestedCategories", "Links", "PropertyActions", "Editable", "MergedProperties", "AlwaysVisibleEditor"];
export {
  AlwaysVisibleEditor,
  ArrayRendering,
  Basic,
