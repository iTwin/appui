...
import { e as PropertyValueFormat, A as AlternateDateFormats, m as TimeDisplay, L as Logger, n as Id64, S as StandardTypeNames, K as Key_enum, c as classnames, o as PropertyEditorParamTypes, U as UiAdmin, M as MessageSeverity, R as RelativePosition, B as Button, l as PropertyRecord, p as BentleyError, q as BentleyStatus, I as IconButton, i as BeEvent, G as Guid, r as assert, d as ProgressRadial, s as StandardEditorNames } from "./Dialog-DB4_e5QV.js";
import { U as UiComponents$1, I as ImageRenderer } from "./ImageRenderer-UAIJnAYw.js";
import { r as reactExports, R as React } from "./index-DDLqOySG.js";
import { cb as LinkifyIt, cc as Orientation$1, cd as TimeFormat$1, bO as from, bR as mergeMap, bS as observeOn, bT as subscribeOn, ap as usePackageTranslation, j as Icon, ce as SvgChevronLeft, cf as SvgChevronRight, H as Input, cg as IconInput, aL as Checkbox, p as placeholderSvg, ac as Select, ch as SvgChevronDown, ci as Popup, cj as ImageCheckBox, ck as NumberInput, cl as Div, bd as SvgCheckmark, ax as SvgRemove, ak as Slider, cm as Textarea, cn as ToggleSwitch, co as ElementSeparator, cp as UnderlinedButton, aV as SvgSearch, aW as SvgClose, b as MenuItem, cq as ComboBox, a9 as Flex, af as Text, aw as SvgAdd, cr as SvgDelete, aM as SvgStatusError, cs as Anchor, w as UiError, ct as DRAFTABLE, cu as Geometry, E as ExpandableBlock, cv as VariableSizeList, cw as areEqual, bW as produce, cx as useTargeted, bz as Observable, cy as TreeNodePlaceholder, cz as TreeNode, cA as Tree, c5 as concat, cB as timer } from "./appui-react-BA4WsKUV.js";
import "./client-D6MDPju-.js";
import { S as Subject, t as tap, q as queueScheduler, a as asapScheduler, o as onErrorResumeNextWith, d as defer, c as connectable, i as iif, E as EMPTY, f as finalize, s as share } from "./tap-B9Nh1U-K.js";
...
class TextEditor extends reactExports.PureComponent {
  ...
  render() {
    ...
    if (this.state.iconSpec) {
      ...
      reactNode = // eslint-disable-next-line @typescript-eslint/no-deprecated
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        IconInput,
        {
          ...inputProps,
