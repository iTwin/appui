...
import { S as Subject, t as tap, q as queueScheduler, a as asapScheduler, o as onErrorResumeNextWith, d as defer, c as connectable, i as iif, E as EMPTY, f as finalize, k as share, s as shareReplay, m as merge, b as of, e as distinctUntilChanged, g as filter, h as concatMap, j as toArray } from "./tap-h0Ibaa9b.js";
...
function EditorContainer(props) {
  ...
  const setEditorRef = (ref) => editorRef.current = ref;
  const createEditor = () => {
    const editorProps = {
      ref: setEditorRef,
    ...
    const editorNode = propertyEditor.reactNode;
    let clonedNode = null;
  ...
  const onPressEnter = (e) => {
    ...
    if (propertyEditor && propertyEditor.containerHandlesEnter) {
      if (editorRef && ((_a3 = editorRef.current) == null ? void 0 : _a3.hasFocus))
        e.stopPropagation();
  ...
  const handleEditorBlur = () => {
    if (ignoreEditorBlur && propertyEditor && propertyEditor.containerHandlesBlur)
      void onPressEscape();
  };
  ...
  const displayOutputMessage = (errorMessage) => {
    ...
    if (errorMessage && editorRef) {
      const htmlElement = editorRef && ((_a3 = editorRef.current) == null ? void 0 : _a3.htmlElement);
      if (htmlElement)
        UiAdmin.messagePresenter.displayInputFieldMessage(
          htmlElement,
