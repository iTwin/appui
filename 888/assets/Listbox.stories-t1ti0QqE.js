...
import { G as Guid, c as classnames, K as Key_enum } from "./Key.enum-BpJjJDFT.js";
...
try {
  ...
  Listbox.__docgenInfo = { "description": "Single select `Listbox` component", "displayName": "Listbox", "props": { "id": { "defaultValue": null, "description": "", "name": "id", "required": false, "type": { "name": "string" } }, "selectedValue": { "defaultValue": null, "description": "", "name": "selectedValue", "required": false, "type": { "name": "string" } }, "ariaLabel": { "defaultValue": null, "description": "", "name": "ariaLabel", "required": false, "type": { "name": "any" } }, "ariaLabelledBy": { "defaultValue": null, "description": "", "name": "ariaLabelledBy", "required": false, "type": { "name": "any" } }, "onListboxValueChange": { "defaultValue": null, "description": "", "name": "onListboxValueChange", "required": false, "type": { "name": "((newValue: string, isControlOrCommandPressed?: boolean) => void)" } } } };
} catch (__react_docgen_typescript_loader_error) {
}
try {
  ListboxItem.displayName = "ListboxItem";
  ListboxItem.__docgenInfo = { "description": "`ListboxItem` component.", "displayName": "ListboxItem", "props": { "value": { "defaultValue": null, "description": "The unique item's value.", "name": "value", "required": true, "type": { "name": "string" } }, "disabled": { "defaultValue": null, "description": "set if item is disabled.", "name": "disabled", "required": false, "type": { "name": "boolean" } } } };
} catch (__react_docgen_typescript_loader_error) {
}
try {
  ListboxContext.displayName = "ListboxContext";
  ListboxContext.__docgenInfo = { "description": "Context set up by listbox for use by `ListboxItems` .", "displayName": "ListboxContext", "props": {} };
} catch (__react_docgen_typescript_loader_error) {
}
const meta = {
...
const Basic = {
  args: {
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
      children: [/* @__PURE__ */ jsxRuntimeExports.jsx(ListboxItem, {
        value: "1",
        children: "Item 1"
      }), /* @__PURE__ */ jsxRuntimeExports.jsx(ListboxItem, {
        value: "2",
        children: "Item 2"
      }), /* @__PURE__ */ jsxRuntimeExports.jsx(ListboxItem, {
        value: "3",
