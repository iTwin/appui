...
import { aD as Icon, aH as TitleBar, ax as useTranslation, b3 as useReduxFrameworkState, b4 as SnapMode, aG as StatusBarPopover, U as UiFramework, b5 as StatusBarComposer, S as StatusBarItemUtilities, f as StatusBarSection, b6 as SvgAdd } from "./DefaultToolSettingsProvider-DIShliKp.js";
import { c as classnames, B as Button } from "./Key.enum-BpJjJDFT.js";
...
import { M as MessageCenterField } from "./MessageCenterField-ChAfZIV9.js";
...
function SelectionCountField(props) {
  const className = classnames("uifw-statusFields-selectionCount", props.className);
  return reactExports.createElement(
    "div",
...
function SnapModeField(props) {
  ...
  return reactExports.createElement(
    ...
    }, isActive: (snapMode & item.value) === item.value, icon: reactExports.createElement(Icon, { className: `icon`, iconSpec: getIconFromIconName(item.iconName) }) }, item.label))) },
    reactExports.createElement(
      Button,
      { styleType: "borderless", title, endIcon: reactExports.createElement(Icon, { iconSpec: getIconFromIconName(iconName) }) },
      title,
