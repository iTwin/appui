const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-DJNdvbBJ.js","./iframe-BxVIzreG.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, e, r as reactExports } from "./iframe-BxVIzreG.js";
import { renderElement, unmountElement } from "./react-18-wPVXE_gL.js";
import { H as HeadersMdx, A as AnchorMdx, C as CodeOrSourceMdx, D as Docs } from "./blocks-mHkI2uPk.js";
  ...
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        __vitePreload(async () => {
          const { MDXProvider } = await import("./index-DJNdvbBJ.js");
          return { MDXProvider };
