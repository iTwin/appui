...
export const Full: Story = {
  ...
  argTypes: {
    title: {
      ...
      control: { type: 'text' },
      table: { category: 'WidgetContentLayout.Header', type: { summary: 'string' }, defaultValue: { summary: 'undefined' } },
    },
    menu: {
      description: 'Optional dropdown menu configuration. Provide { title, items } where items is an array of { label, onClick }.',
      control: { type: 'object' },
      table: { category: 'WidgetContentLayout.Header', type: { summary: 'object' }, defaultValue: { summary: 'undefined' } },
    },
    icons: {
      description: 'Array of icon definitions displayed in the header (label, icon, onClick).',
      control: { type: 'object' },
      table: { category: 'WidgetContentLayout.Header', type: { summary: 'Array' }, defaultValue: { summary: '[]' } },
    },
    buttons: {
      description: 'Array of JSX Buttons to render in the header actions area.',
      control: { type: 'object' },
      table: { category: 'WidgetContentLayout.Header', type: { summary: 'Array<JSX.Element>' }, defaultValue: { summary: '[]' } },
    },
    onSearch: {
      description: 'Optional search callback function called with the search input value when the user submits a search.',
      table: { category: 'WidgetContentLayout.Header', type: { summary: '(value: string) => void' }, defaultValue: { summary: 'undefined' } },
    },
    iconSize: {
      control: { type: "inline-radio" },
      options: ["small", undefined, "large"],
      table: { category: 'WidgetContentLayout.Header', type: { summary: `'small' | undefined | 'large'` }, defaultValue: { summary: 'undefined' } },
    }
  },
};
