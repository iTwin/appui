...
export default function transformer(file: FileInfo, api: API, options: Options) {
  ...
  const groupItems = root.findObjectExpressions("ToolbarActionItem")
    ...
    .concat(root.findCallExpressions("ToolbarItemUtilities.createActionItem").getArguments(5, (arg) => isObjectExpression(arg)))
    .concat(root.findCallExpressions("ToolbarItemUtilities.createGroupItem").getArguments(5, (arg) => isObjectExpression(arg)));
  ...
  const items = root.findObjectExpressions("CommonToolbarItem")
    ...
    .concat(root.findCallExpressions("ToolbarItemUtilities.createCustomItem").getArguments(5, (arg) => isObjectExpression(arg)));
