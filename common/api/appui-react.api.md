...
export const ConfigurableUiActions: {
    ...
    setTheme: (theme: ThemeValues) => ActionWithPayload<ConfigurableUiActionId.SetTheme, "SYSTEM_PREFERRED" | "light" | "dark" | "inherit" | "high-contrast-light" | "high-contrast-dark" | DeepReadonlyObject<string & {}>>;
