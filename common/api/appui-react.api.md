...
import type { DialogProps as DialogProps_2 } from '@itwin/appui-abstract';
...
import type { PanelSide } from '@itwin/appui-layout-react';
...
export const ConfigurableUiActions: {
    ...
    setTheme: (theme: ThemeId) => ActionWithPayload<ConfigurableUiActionId.SetTheme, "inherit" | "SYSTEM_PREFERRED" | "light" | "dark" | "high-contrast-light" | "high-contrast-dark" | DeepReadonlyObject<string & {}>>;
