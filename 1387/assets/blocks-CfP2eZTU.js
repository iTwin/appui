const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Color-AVL7NMMY-BQTx4zyl.js","./iframe-D3FK7mSC.js"])))=>i.map(i=>d[i]);
import { r as reactExports, e, j as jsxRuntimeExports, R as ReactDOM, s as Ve$2, k as reactDomExports, t as ha$1, _ as __vitePreload, v as Tn$2 } from "./iframe-D3FK7mSC.js";
...
function Im(e4) {
  ...
  return r4 ? e4.ref : (t4 = (_b = Object.getOwnPropertyDescriptor(e4, "ref")) == null ? void 0 : _b.get, r4 = t4 && "isReactWarning" in t4 && t4.isReactWarning, r4 ? e4.props.ref : e4.props.ref || e4.ref);
}
var qa, Ua, Mm, t5 = C$1(() => {
  Un();
...
var nn, Ga = C$1(() => {
  nn = (globalThis == null ? void 0 : globalThis.document) ? reactExports.useLayoutEffect : () => {
  };
});
function Pm(e4, t4) {
...
function km(e4) {
  ...
  return reactExports.useEffect(() => {
    ...
    if (f2 !== e4) {
      ...
      e4 ? s2("MOUNT") : v3 === "none" || (u2 == null ? void 0 : u2.display) === "none" ? s2("UNMOUNT") : s2(f2 && m4 !== v3 ? "ANIMATION_OUT" : "UNMOUNT"), a4.current = e4;
    }
  }, [e4, s2]), nn(() => {
    if (t4) {
...
function c5(e4, t4 = []) {
  ...
  function n4(i4, c2) {
    ...
    r4 = [...r4, c2];
    function u2(d4) {
      let { scope: m4, children: v3, ...R3 } = d4, p4 = (m4 == null ? void 0 : m4[e4][s2]) || l2, h4 = reactExports.useMemo(() => R3, Object.values(R3));
      return /* @__PURE__ */ jsxRuntimeExports.jsx(p4.Provider, { value: h4, children: v3 });
    }
    o$1(u2, "Provider");
    function f2(d4, m4) {
      let v3 = (m4 == null ? void 0 : m4[e4][s2]) || l2, R3 = reactExports.useContext(v3);
      if (R3) return R3;
  ...
  let a4 = /* @__PURE__ */ o$1(() => {
    ...
    return /* @__PURE__ */ o$1(function(l2) {
      let s2 = (l2 == null ? void 0 : l2[e4]) || i4;
  ...
  jm = reactExports.forwardRef((e4, t4) => {
    ...
    return o$1(L2, "handleDragScroll"), reactExports.useEffect(() => {
      let M2 = /* @__PURE__ */ o$1((A3) => {
        let P2 = A3.target;
        (R3 == null ? void 0 : R3.contains(P2)) && E4(A3, x4);
      }, "handleWheel");
...
function Ja() {
  var _a2, _b;
  if ((_b = (_a2 = Ka.top) == null ? void 0 : _a2.navigator) == null ? void 0 : _b.clipboard) {
  ...
  if (y4) {
    if (i4) {
      var F2, K2 = x4 === "y" ? te$1 : ne$1, T2 = x4 === "y" ? le$1 : ae$1, z2 = x4 === "y" ? "height" : "width", k2 = y4[x4], V2 = k2 + h4[K2], D2 = k2 - h4[T2], j2 = v3 ? -L2[z2] / 2 : 0, O2 = w3 === ut ? S4[z2] : L2[z2], G2 = w3 === ut ? -L2[z2] : -S4[z2], Ee2 = t4.elements.arrow, pe2 = v3 && Ee2 ? Qt(Ee2) : {
        ...
        S4[z2],
        pe2[z2]
      ), Ot2 = b3 ? S4[z2] / 2 - j2 - Se2 - ue2 - A3.mainAxis : O2 - Se2 - ue2 - A3.mainAxis, qr2 = b3 ? -S4[z2] / 2 + j2 + Se2 + ve2 + A3.mainAxis : G2 + Se2 + ve2 + A3.mainAxis, Vo = t4.elements.arrow && et(t4.elements.arrow), fp = Vo ? x4 === "y" ? Vo.clientTop || 0 : Vo.clientLeft || 0 : 0, xl = (F2 = P2 == null ? void 0 : P2[x4]) != null ? F2 : 0, dp = k2 + Ot2 - xl - fp, pp = k2 + qr2 - xl, El = tr(v3 ? Jt(V2, dp) : V2, k2, v3 ? Qe$1(D2, pp) : D2);
      y4[x4] = El, _2[x4] = El - k2;
    }
    if (l2) {
      var Sl, mp = x4 === "x" ? te$1 : ne$1, hp = x4 === "x" ? le$1 : ae$1, Bt2 = y4[E4], Ln2 = E4 === "y" ? "height" : "width", Cl = Bt2 + h4[mp], Ml = Bt2 - h4[hp], jo = [te$1, ne$1].indexOf(g4) !== -1, Ll = (Sl = P2 == null ? void 0 : P2[E4]) != null ? Sl : 0, Al = jo ? Cl : Bt2 - S4[Ln2] - L2[Ln2] - Ll + A3.altAxis, Il = jo ? Bt2 + S4[Ln2] + L2[Ln2] - Ll - A3.altAxis : Ml, zl = v3 && jo ? jf(Al, Bt2, Il) : tr(v3 ? Al : Cl, Bt2, v3 ? Il : Ml);
...
function _d(e4, t4) {
  ...
  reactExports.useEffect(function() {
    ...
    function T2(z2) {
      ...
      Bd.getBoundingClientRect = Fd(k2, V2), y4 == null ? void 0 : y4();
    }
...
var wh = /[\n\r]/g, bh = xr$1.code(
  ...
  return a4.filter(j5).some((c2) => c2.match(wh)) ? /* @__PURE__ */ e.createElement(
    Rh,
    {
      bordered: true,
      copyable: true,
      language: (n4 == null ? void 0 : n4[1]) ?? "text",
      format: false,
      ...r4
    },
    t4
...
function lu(e4, t4 = []) {
  ...
  function n4(i4, c2) {
    ...
    let u2 = /* @__PURE__ */ o$1((d4) => {
      var _a2;
      let { scope: m4, children: v3, ...R3 } = d4, p4 = ((_a2 = m4 == null ? void 0 : m4[e4]) == null ? void 0 : _a2[s2]) || l2, h4 = reactExports.useMemo(() => R3, Object.values(R3));
      return /* @__PURE__ */ jsxRuntimeExports.jsx(p4.Provider, { value: h4, children: v3 });
    }, "Provider");
    u2.displayName = i4 + "Provider";
    function f2(d4, m4) {
      var _a2;
      let v3 = ((_a2 = m4 == null ? void 0 : m4[e4]) == null ? void 0 : _a2[s2]) || l2, R3 = reactExports.useContext(v3);
      if (R3) return R3;
      if (c2 !== void 0) return c2;
      throw new Error(`\`${d4}\` must be used within \`${i4}\``);
    }
  ...
  let u2 = reactExports.useCallback(
    (f2) => {
      ...
      if (l2) {
        ...
        d4 !== e4 && ((_a2 = c2.current) == null ? void 0 : _a2.call(c2, d4));
      } else
        i4(f2);
    },
    [l2, e4, i4, c2]
...
function gu(e4, t4 = globalThis == null ? void 0 : globalThis.document) {
  let r4 = St(e4);
  reactExports.useEffect(() => {
...
var gg = "DismissableLayer", Si = "dismissableLayer.update", vg = "dismissableLayer.pointerDownOutside", wg = "dismissableLayer.focusOutside", vu, Ru = reactExports.createContext({
  ...
  (e4, t4) => {
    let {
      ...
      onDismiss: l2,
      ...s2
    } = e4, u2 = reactExports.useContext(Ru), [f2, d4] = reactExports.useState(null), m4 = (f2 == null ? void 0 : f2.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, v3] = reactExports.useState({}), R3 = Ye(t4, (S4) => d4(
      S4
      ...
      !x4 || M2 || (a4 == null ? void 0 : a4(S4), c2 == null ? void 0 : c2(S4), S4.defaultPrevented || (l2 == null ? void 0 : l2()));
    }, m4), y4 = xg((S4) => {
      let L2 = S4.target;
      [...u2.branches].some((A3) => A3.contains(L2)) || (i4 == null ? void 0 : i4(S4), c2 == null ? void 0 : c2(S4), S4.defaultPrevented || (l2 == null ? void 0 : l2()));
    }, m4);
    return gu((S4) => {
      w3 === u2.layers.size - 1 && (n4 == null ? void 0 : n4(S4), !S4.defaultPrevented && l2 && (S4.preventDefault(), l2()));
...
Rg.displayName = bg;
function yg(e4, t4 = globalThis == null ? void 0 : globalThis.document) {
...
function xg(e4, t4 = globalThis == null ? void 0 : globalThis.document) {
...
function Ig() {
  ...
  return {
    add(t4) {
      let r4 = e4[0];
      t4 !== r4 && (r4 == null ? void 0 : r4.pause()), e4 = Cu(e4, t4), e4.unshift(t4);
    },
    remove(t4) {
      var _a2;
      e4 = Cu(e4, t4), (_a2 = e4[0]) == null ? void 0 : _a2.resume();
    }
  };
}
...
var Pg = "Portal", Ii = reactExports.forwardRef((e4, t4) => {
  ...
  ct(() => i4(true), []);
  let c2 = r4 || a4 && ((_a2 = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a2.body);
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      rf,
      {
        ...
        onCloseAutoFocus: /* @__PURE__ */ o$1((i4) => {
          var _a2, _b;
          (_a2 = e4.onCloseAutoFocus) == null ? void 0 : _a2.call(e4, i4), i4.defaultPrevented || (n4.current || ((_b = r4.triggerRef.current) == null ? void 0 : _b.focus()), i4.preventDefault()), n4.current = false, a4.current = false;
        }, "onCloseAutoFocus"),
        onInteractOutside: /* @__PURE__ */ o$1((i4) => {
          var _a2, _b;
          (_a2 = e4.onInteractOutside) == null ? void 0 : _a2.call(e4, i4), i4.defaultPrevented || (n4.current = true, i4.detail.originalEvent.type === "pointerdown" && (a4.current = true));
          let c2 = i4.target;
          ((_b = r4.triggerRef.current) == null ? void 0 : _b.contains(c2)) && i4.preventDefault(), i4.detail.originalEvent.type === "focusin" && a4.current && i4.preventDefault();
        }, "onInteractOutside")
      }
    );
  }
...
${t4}`);
  ...
  return /* @__PURE__ */ e.createElement(reactExports.Fragment, null, /* @__PURE__ */ e.createElement("span", null, n4), ": ", /* @__PURE__ */ e.createElement(
    ...
    (l2, s2) => (l2 == null ? void 0 : l2.name) ? /* @__PURE__ */ e.createElement(reactExports.Fragment, { key: s2 }, "  ", "at ", /* @__PURE__ */ e.createElement(s7, null, l2.name), " (", /* @__PURE__ */ e.createElement(wf, null, l2.location), ")", /* @__PURE__ */ e.createElement("br", null)) : /* @__PURE__ */ e.createElement(
      reactExports.Fragment,
      { key: s2 },
      "  ",
      "at ",
      /* @__PURE__ */ e.createElement(wf, null, l2 == null ? void 0 : l2.location),
...
var o6 = xr$1.div(
  ...
  let { active: n4, disabled: a4, title: i4, href: c2 } = r4, l2 = reactExports.useCallback(
    (s2) => t4 == null ? void 0 : t4(s2, { id: e$1, active: n4, disabled: a4, title: i4, href: c2 }),
    [t4, e$1, n4, a4, i4, c2]
  );
...
function rp(e$1) {
  let t4 = reactExports.useRef(), r4 = reactExports.useRef(), n4 = reactExports.useRef(/* @__PURE__ */ new Map()), { width: a4 = 1 } = bo({
    ...
    let { x: m4, width: v3 } = t4.current.getBoundingClientRect(), { width: R3 } = r4.current.getBoundingClientRect(), p4 = l2.length ? m4 + v3 - R3 : m4 + v3, h4 = [], g4 = 0, w3 = e$1.filter((b3) => {
      let { id: x4 } = b3, E4 = n4.current.get(x4), { width: y4 = 0 } = (E4 == null ? void 0 : E4.getBoundingClientRect()) || {}, S4 = m4 + g4 + y4 > p4;
...
var PositionedToolbar = xr$1(Toolbar)({ position: "absolute", top: 0, left: 0, right: 0, height: 40 }), Relative = xr$1.div({ overflow: "hidden", position: "relative" }), Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", inline = false, ...props }) => {
  let [expanded, setExpanded] = reactExports.useState(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = reactExports.useState(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = reactExports.useState(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = reactExports.useCallback(async (text) => {
    ...
    selection && selection.type === "Range" || (e23.preventDefault(), additionalActionItems.filter((item) => item.title === "Copied").length === 0 && copyToClipboard((source == null ? void 0 : source.props.code) ?? "").then(() => {
...
function build_html_default(options) {
  ...
  function updateToc(headingsArray, event) {
    ...
    let headings = headingsArray, clickedHref = ((_a2 = event == null ? void 0 : event.target) == null ? void 0 : _a2.getAttribute) ? (_b = event == null ? void 0 : event.target) == null ? void 0 : _b.getAttribute("href") : null, isBottomMode = clickedHref && clickedHref.charAt(0) === "#" ? getIsHeaderBottomMode(clickedHref.replace("#", "")) : false, shouldUpdate = currentlyHighlighting || isBottomMode;
...
function init(customOptions) {
  ...
  _scrollListener = ((fn2, delay) => getScrollHandler(fn2, delay, _options.scrollHandlerType))((e23) => {
    ...
    let isTop = ((_b = (_a2 = e23 == null ? void 0 : e23.target) == null ? void 0 : _a2.scrollingElement) == null ? void 0 : _b.scrollTop) === 0;
    (e23 && (e23.eventPhase === 0 || e23.currentTarget === null) || isTop) && (_buildHtml.updateToc(_headingsArray), (_c = _options.scrollEndCallback) == null ? void 0 : _c.call(_options, e23));
...
function Xe(n22 = "", i22 = {}) {
  function u2(e23, n32, ...r22) {
    ...
    }(e23, i22.overrides), t({}, n32, l2, { className: Qe(n32 == null ? void 0 : n32.className, l2.className) || void 0 }), ...r22);
  }
  function Z2(e23) {
    e23 = e23.replace(w, "");
    let t22 = false;
...
var Wrapper5 = xr$1.div(({ isInline }) => isInline ? { display: "flex", flexWrap: "wrap", alignItems: "flex-start", label: { display: "inline-flex", marginRight: 15 } } : { label: { display: "flex" } }, (props) => {
  ...
  let initial = selectedKeys(value2 || [], options), [selected, setSelected] = reactExports.useState(initial), readonly = !!((_a2 = argType == null ? void 0 : argType.table) == null ? void 0 : _a2.readonly), handleChange = (e23) => {
...
var JsonTree = class extends reactExports.Component {
  ...
  onUpdate(key, data) {
    var _a2, _b;
    this.setState({ data }), (_b = (_a2 = this.props).onFullyUpdate) == null ? void 0 : _b.call(_a2, data);
  }
  removeRoot() {
...
var { window: globalWindow2 } = globalThis, Wrapper7 = xr$1.div(({ theme }) => ({ position: "relative", display: "flex", '&[aria-readonly="true"]': { opacity: 0.5 }, ".rejt-tree": { marginLeft: "1rem", fontSize: "13px" }, ".rejt-value-node, .rejt-object-node > .rejt-collapsed, .rejt-array-node > .rejt-collapsed, .rejt-object-node > .rejt-not-collapsed, .rejt-array-node > .rejt-not-collapsed": { "& > svg": { opacity: 0, transition: "opacity 0.2s" } }, ".rejt-value-node:hover, .rejt-object-node:hover > .rejt-collapsed, .rejt-array-node:hover > .rejt-collapsed, .rejt-object-node:hover > .rejt-not-collapsed, .rejt-array-node:hover > .rejt-not-collapsed": { "& > svg": { opacity: 1 } }, ".rejt-edit-form button": { display: "none" }, ".rejt-add-form": { marginLeft: 10 }, ".rejt-add-value-node": { display: "inline-flex", alignItems: "center" }, ".rejt-name": { lineHeight: "22px" }, ".rejt-not-collapsed-delimiter": { lineHeight: "22px" }, ".rejt-plus-menu": { marginLeft: 5 }, ".rejt-object-node > span > *, .rejt-array-node > span > *": { position: "relative", zIndex: 2 }, ".rejt-object-node, .rejt-array-node": { position: "relative" }, ".rejt-object-node > span:first-of-type::after, .rejt-array-node > span:first-of-type::after, .rejt-collapsed::before, .rejt-not-collapsed::before": { content: '""', position: "absolute", top: 0, display: "block", width: "100%", marginLeft: "-1rem", padding: "0 4px 0 1rem", height: 22 }, ".rejt-collapsed::before, .rejt-not-collapsed::before": { zIndex: 1, background: "transparent", borderRadius: 4, transition: "background 0.2s", pointerEvents: "none", opacity: 0.1 }, ".rejt-object-node:hover, .rejt-array-node:hover": { "& > .rejt-collapsed::before, & > .rejt-not-collapsed::before": { background: theme.color.secondary } }, ".rejt-collapsed::after, .rejt-not-collapsed::after": { content: '""', position: "absolute", display: "inline-block", pointerEvents: "none", width: 0, height: 0 }, ".rejt-collapsed::after": { left: -8, top: 8, borderTop: "3px solid transparent", borderBottom: "3px solid transparent", borderLeft: "3px solid rgba(153,153,153,0.6)" }, ".rejt-not-collapsed::after": { left: -10, top: 10, borderTop: "3px solid rgba(153,153,153,0.6)", borderLeft: "3px solid transparent", borderRight: "3px solid transparent" }, ".rejt-value": { display: "inline-block", border: "1px solid transparent", borderRadius: 4, margin: "1px 0", padding: "0 4px", cursor: "text", color: theme.color.defaultText }, ".rejt-value-node:hover > .rejt-value": { background: theme.color.lighter, borderColor: theme.appBorderColor } })), ButtonInline = xr$1.button(({ theme, primary }) => ({ border: 0, height: 20, margin: 1, borderRadius: 4, background: primary ? theme.color.secondary : "transparent", color: primary ? theme.color.lightest : theme.color.dark, fontWeight: primary ? "bold" : "normal", cursor: "pointer", order: primary ? "initial" : 9 })), ActionAddIcon = xr$1(AddIcon)(({ theme, disabled }) => ({ display: "inline-block", verticalAlign: "middle", width: 15, height: 15, padding: 3, marginLeft: 5, cursor: disabled ? "not-allowed" : "pointer", color: theme.textMutedColor, "&:hover": disabled ? {} : { color: theme.color.ancillary }, "svg + &": { marginLeft: 0 } })), ActionSubstractIcon = xr$1(SubtractIcon)(({ theme, disabled }) => ({ display: "inline-block", verticalAlign: "middle", width: 15, height: 15, padding: 3, marginLeft: 5, cursor: disabled ? "not-allowed" : "pointer", color: theme.textMutedColor, "&:hover": disabled ? {} : { color: theme.color.negative }, "svg + &": { marginLeft: 0 } })), Input = xr$1.input(({ theme, placeholder }) => ({ outline: 0, margin: placeholder ? 1 : "1px 0", padding: "3px 4px", color: theme.color.defaultText, background: theme.background.app, border: `1px solid ${theme.appBorderColor}`, borderRadius: 4, lineHeight: "14px", width: placeholder === "Key" ? 80 : 120, "&:focus": { border: `1px solid ${theme.color.secondary}` } })), RawButton = xr$1(wo)(({ theme }) => ({ position: "absolute", zIndex: 2, top: 2, right: 2, height: 21, padding: "0 3px", background: theme.background.bar, border: `1px solid ${theme.appBorderColor}`, borderRadius: 3, color: theme.textMutedColor, fontSize: "9px", fontWeight: "bold", textDecoration: "none", span: { marginLeft: 3, marginTop: 1 } })), RawInput = xr$1(N7.Textarea)(({ theme }) => ({ flex: 1, padding: "7px 6px", fontFamily: theme.typography.fonts.mono, fontSize: "12px", lineHeight: "18px", "&::placeholder": { fontFamily: theme.typography.fonts.base, fontSize: "13px" }, "&:placeholder-shown": { padding: "7px 10px" } })), ENTER_EVENT = { bubbles: true, cancelable: true, key: "Enter", code: "Enter", keyCode: 13 }, dispatchEnterKey = (event) => {
  ...
  var _a2;
  let theme = St$1(), data = reactExports.useMemo(() => value2 && cloneDeep(value2), [value2]), hasData = data != null, [showRaw, setShowRaw] = reactExports.useState(!hasData), [parseError, setParseError] = reactExports.useState(null), readonly = !!((_a2 = argType == null ? void 0 : argType.table) == null ? void 0 : _a2.readonly), updateRaw = reactExports.useCallback((raw) => {
    try {
...
var Wrapper8 = xr$1.label({ display: "flex" }), MaxLength = xr$1.div(({ isMaxed }) => ({ marginLeft: "0.75rem", paddingTop: "0.35rem", color: isMaxed ? "red" : void 0 })), TextControl = ({ name, value: value2, onChange, onFocus, onBlur, maxLength, argType }) => {
  ...
  return e.createElement(Wrapper8, null, e.createElement(N7.Textarea, { id: getControlId(name), maxLength, onChange: handleChange, disabled: readonly, size: "flex", placeholder: "Edit string...", autoFocus: forceVisible, valid: isValid ? void 0 : "error", name, value: isValid ? value2 : "", onFocus, onBlur }), maxLength && e.createElement(MaxLength, { isMaxed: (value2 == null ? void 0 : value2.length) === maxLength }, (value2 == null ? void 0 : value2.length) ?? 0, " / ", maxLength));
};
...
var LazyColorControl = reactExports.lazy(() => __vitePreload(() => import("./Color-AVL7NMMY-BQTx4zyl.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url)), ColorControl = (props) => e.createElement(reactExports.Suspense, { fallback: e.createElement("div", null) }, e.createElement(LazyColorControl, { ...props }));
...
var sortFns = { alpha: (a22, b22) => (a22.name ?? "").localeCompare(b22.name ?? ""), requiredFirst: (a22, b22) => {
  var _a2, _b;
  return +!!((_a2 = b22.type) == null ? void 0 : _a2.required) - +!!((_b = a22.type) == null ? void 0 : _b.required) || (a22.name ?? "").localeCompare(b22.name ?? "");
...
var getStorySource = (storyId, args, sourceContext) => {
  ...
  let sourceParameters = ((_b = (_a2 = story == null ? void 0 : story.parameters) == null ? void 0 : _a2.docs) == null ? void 0 : _b.source) || {}, format3 = props.format, language = props.language ?? sourceParameters.language ?? "jsx", dark = props.dark ?? sourceParameters.dark ?? false;
...
var Canvas = (props) => {
  var _a2, _b, _c, _d2, _e2, _f2, _g2, _h2, _i2, _j, _k, _l2, _m, _n2;
  ...
  if ("of" in props && of2 === void 0) throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  let { story } = useOf(of2 || "story", ["story"]), sourceProps = useSourceProps({ ...source, ...of2 && { of: of2 } }, docsContext, sourceContext), layout = props.layout ?? story.parameters.layout ?? ((_b = (_a2 = story.parameters.docs) == null ? void 0 : _a2.canvas) == null ? void 0 : _b.layout) ?? "padded", withToolbar = props.withToolbar ?? ((_d2 = (_c = story.parameters.docs) == null ? void 0 : _c.canvas) == null ? void 0 : _d2.withToolbar) ?? false, additionalActions = props.additionalActions ?? ((_f2 = (_e2 = story.parameters.docs) == null ? void 0 : _e2.canvas) == null ? void 0 : _f2.additionalActions), sourceState = props.sourceState ?? ((_h2 = (_g2 = story.parameters.docs) == null ? void 0 : _g2.canvas) == null ? void 0 : _h2.sourceState) ?? "hidden", className = props.className ?? ((_j = (_i2 = story.parameters.docs) == null ? void 0 : _i2.canvas) == null ? void 0 : _j.className), inline = ((_k = props.story) == null ? void 0 : _k.inline) ?? ((_n2 = (_m = (_l2 = story.parameters) == null ? void 0 : _l2.docs) == null ? void 0 : _m.story) == null ? void 0 : _n2.inline) ?? false;
...
var DescriptionType = ((DescriptionType2) => (DescriptionType2.INFO = "info", DescriptionType2.NOTES = "notes", DescriptionType2.DOCGEN = "docgen", DescriptionType2.AUTO = "auto", DescriptionType2))(DescriptionType || {}), getDescriptionFromResolvedOf = (resolvedOf) => {
  var _a2, _b, _c, _d2, _e2, _f2, _g2, _h2;
  switch (resolvedOf.type) {
    case "story":
      return ((_b = (_a2 = resolvedOf.story.parameters.docs) == null ? void 0 : _a2.description) == null ? void 0 : _b.story) || null;
    case "meta": {
      let { parameters, component } = resolvedOf.preparedMeta, metaDescription = (_d2 = (_c = parameters.docs) == null ? void 0 : _c.description) == null ? void 0 : _d2.component;
...
var { document: document3, window: globalWindow3 } = globalThis, DocsContainer = ({ context, theme, children }) => {
  ...
  let toc;
  try {
    toc = (_b = (_a2 = context.resolveOf("meta", ["meta"]).preparedMeta.parameters) == null ? void 0 : _a2.docs) == null ? void 0 : _b.toc;
  } catch {
    toc = (_e2 = (_d2 = (_c = context == null ? void 0 : context.projectAnnotations) == null ? void 0 : _c.parameters) == null ? void 0 : _d2.docs) == null ? void 0 : _e2.toc;
  }
  return reactExports.useEffect(() => {
    let url;
    try {
...
var DocsStory = ({ of: of2, expanded = true, withToolbar: withToolbarProp = false, __forceInitialArgs = false, __primary = false }) => {
  var _a2, _b;
  let { story } = useOf(of2 || "story", ["story"]), withToolbar = ((_b = (_a2 = story.parameters.docs) == null ? void 0 : _a2.canvas) == null ? void 0 : _b.withToolbar) ?? withToolbarProp;
