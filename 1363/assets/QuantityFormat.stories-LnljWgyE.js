...
var _a, _b, _c;
import { cG as useTranslation, am as Select, cH as parseFormatType, a2 as Label, cI as FormatType, _ as Input, Q as Icon, cJ as RatioType, cK as FractionalPrecision, cL as DecimalPrecision, cM as ScientificType, cN as Format, cO as getTraitString, cP as FormatTraits, aB as Checkbox, cQ as ShowSignOption, cR as SvgHelpCircularHollow, cS as parseRatioType, cT as parseShowSignOption, cU as parseScientificType, cV as FormatterSpec, I as IModelApp, cW as getQuantityTypeKey, cX as isCustomQuantityTypeDefinition, L as useTranslation$1, U as UiFramework, cY as useSaveBeforeActivatingNewSettingsTab, cZ as useSaveBeforeClosingSettingsContainer, c_ as Listbox, c$ as ListboxItem, d0 as QuantityType } from "./appui-react-BowZ5tTD.js";
import { K as Key_enumExports, B as Button, c as Dialog$1 } from "./Key.enum-BBhL30hZ.js";
import { A as AppUiDecorator, I as InitializerDecorator } from "./Decorators-C55Zshtl.js";
import { e as enumArgType } from "./Utils-CqtNvucg.js";
import { r as reactExports, c as classnames, e, I as IconButton, j as jsxRuntimeExports } from "./iframe-of9jHZvl.js";
...
function MiscFormatOptions(props) {
  ...
  const scientficTypeSelectorId = reactExports.useId();
  ...
  return reactExports.createElement(
    ...
    (!enableMinimumProperties || showOptions) && reactExports.createElement(
      ...
      reactExports.createElement(Label, { className: classnames("uicore-label", formatType !== FormatType.Scientific && "uicore-disabled"), as: "div", displayStyle: "inline", id: scientficTypeSelectorId }, translate("QuantityFormat.labels.scientificTypeLabel")),
      reactExports.createElement(ScientificTypeSelector, { type: formatProps.scientificType && formatProps.scientificType.length > 0 ? parseScientificType(formatProps.scientificType, "custom") : ScientificType.Normalized, "aria-labelledby": scientficTypeSelectorId, disabled: formatType !== FormatType.Scientific, onChange: handleScientificTypeChange }),
      reactExports.createElement(
        Label,
