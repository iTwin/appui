const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-CTQcfEoJ.js","./iframe-CxthnN3M.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, e, r as reactExports } from "./iframe-CxthnN3M.js";
import { renderElement, unmountElement } from "./react-18-DrStuvRE.js";
import { H as HeadersMdx, A as AnchorMdx, C as CodeOrSourceMdx, D as Docs } from "./blocks-C_Wwc0G-.js";
  ...
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        __vitePreload(async () => {
          const { MDXProvider } = await import("./index-CTQcfEoJ.js");
          return { MDXProvider };
