...
import { r as reactExports, j as jsxRuntimeExports, c as classnames, I as IconButton } from "./iframe-CxthnN3M.js";
import { Z as Input, aC as Slider, bp as toDateString, bq as toTimeString, br as UiAdmin, ac as DropdownMenu, bs as SvgMoreVertical, b as MenuItem, bt as SvgCheckmark, bu as MenuDivider } from "./appui-react-ARYPQBMf.js";
import { K as Key_enumExports } from "./Key.enum-DoKni0Tv.js";
import { P as PlayButton } from "./PlayButton-CpHGTC2d.js";
import { u as useTranslation } from "./useTranslation-BNnw2rqX.js";
import { I as InitializerDecorator, A as AppUiDecorator } from "./Decorators-B5hwbz68.js";
...
function useFocusedThumb(sliderContainer) {
  ...
  reactExports.useEffect(() => {
    ...
    thumbElement == null ? void 0 : thumbElement.addEventListener("focus", listener);
    return () => {
      thumbElement == null ? void 0 : thumbElement.removeEventListener("focus", listener);
    };
  }, [thumbElement]);
  reactExports.useEffect(() => {
    const listener = () => {
    ...
    thumbElement == null ? void 0 : thumbElement.addEventListener("blur", listener);
    return () => {
      thumbElement == null ? void 0 : thumbElement.removeEventListener("blur", listener);
    };
  }, [thumbElement]);
