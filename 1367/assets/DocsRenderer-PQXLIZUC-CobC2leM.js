const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-98XlNAIy.js","./iframe-CPf_22bH.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, e, r as reactExports } from "./iframe-CPf_22bH.js";
import { renderElement, unmountElement } from "./react-18-DhUr-3tj.js";
import { H as HeadersMdx, A as AnchorMdx, C as CodeOrSourceMdx, D as Docs } from "./blocks-CklCPdjl.js";
  ...
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        __vitePreload(async () => {
          const { MDXProvider } = await import("./index-98XlNAIy.js");
          return { MDXProvider };
