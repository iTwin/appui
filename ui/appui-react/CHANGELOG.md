...
- 0b30952: Widget tabs now respond immediately to clicks. Double-clicking an active floating widget tab minimizes or restores it.
...
- Updated dependencies [419f96c]
  ...
  - @itwin/imodel-components-react@5.35.1
...
- Updated dependencies [af6103d]
- Updated dependencies [fc74775]
  - @itwin/components-react@5.34.0
  - @itwin/imodel-components-react@5.34.0
...
- Updated dependencies [68423de]
  - @itwin/components-react@5.33.3
  - @itwin/imodel-components-react@5.33.3
...
- Updated dependencies [e95016c]
  ...
  - @itwin/imodel-components-react@5.33.2
...
- Updated dependencies [b98b9c3]
  - @itwin/imodel-components-react@5.33.1
...
- 33fb824: Added `iconElement` property to `ToolAssistanceInstruction` interface of `@itwin/core-frontend` package (using TypeScript declaration merging) to allow using custom SVG icons in tool assistance instructions.
...
- Updated dependencies [c3baa56]
  ...
  - @itwin/imodel-components-react@5.13.1
