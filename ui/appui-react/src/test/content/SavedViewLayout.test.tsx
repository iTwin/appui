...
import { ConfigurableUiManager, ContentGroup, ContentLayoutDef, ContentLayoutManager, FrontstageManager, FrontstageProvider, StageContentLayout, ViewportContentControl,
} from "../../appui-react";
