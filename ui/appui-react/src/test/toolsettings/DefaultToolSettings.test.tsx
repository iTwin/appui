...
class MockSelectTool {
  private _selectionOptionValue: DialogItemValue = {
    value: SelectOptions.Method_Pick,
  };
  ...
  public set selectionOption(option: SelectOptions) {
    ...
    const syncItem: DialogPropertySyncItem = {
      value: this._selectionOptionValue,
      propertyName: selectionOptionDescription.name,
    };
  ...
  public supplyToolSettingsProperties(): DialogItem[] | undefined {
    ...
    toolSettings.push({
      value: this._selectionOptionValue,
      property: selectionOptionDescription,
  ...
  public applyToolSettingPropertyChange(
  ...
  public set toolSettingPropertyChangeHandler(
    changeFunc: (propertyValues: DialogPropertySyncItem[]) => void
  ) {
  ...
  public syncToolSettingsProperties(propertyValues: DialogPropertySyncItem[]) {
    if (this._changeFunc) this._changeFunc(propertyValues);
  }
}
...
class MockPlaceLineTool {
  ...
  public set length(length: number) {
    ...
    this.syncToolSettingsProperties([
      { value: this._lengthValue, propertyName: lengthDescription.name },
    ]);
  }
  ...
  public set angle(angle: number) {
    ...
    this.syncToolSettingsProperties([
      { value: this._angleValue, propertyName: angleDescription.name },
    ]);
  }
  ...
  public supplyToolSettingsProperties(): DialogItem[] | undefined {
    ...
    toolSettings.push({
      value: this._useAngleValue,
      property: useAngleDescription,
      editorPosition: { rowPriority: 1, columnIndex: 0 },
    });
    toolSettings.push({
      value: this._angleValue,
      property: angleDescription,
...
describe("Default ToolSettings", () => {
  it("mock SelectTool", () => {
    ...
    if (selectToolSettings) {
      ...
      const changeHandler = (syncItems: DialogPropertySyncItem[]): void => {
        ...
        selectToolSettings[0] = {
          value: syncValue,
          property: selectToolSettings[0].property,
          editorPosition: selectToolSettings[0].editorPosition,
          isDisabled: selectToolSettings[0].isDisabled,
          lockProperty: selectToolSettings[0].lockProperty,
        };
      };
      ...
      const updatedSelectPropertyValue: DialogItemValue = {
        value: SelectOptions.Method_Box,
      };
      const syncItem: DialogPropertySyncItem = {
        value: updatedSelectPropertyValue,
        propertyName: selectToolSettings[0].property.name,
      };
  ...
  it("mock PlaceLineTool", () => {
    ...
    if (lineToolSettings) {
        ...
        syncItems.forEach((item) => {
          switch (item.propertyName) {
            case useLengthDescription.name:
              lineToolSettings[0] = {
                value: item.value,
                property: lineToolSettings[0].property,
                editorPosition: lineToolSettings[0].editorPosition,
                isDisabled: lineToolSettings[0].isDisabled,
                lockProperty: lineToolSettings[0].lockProperty,
              };
              break;
            case lengthDescription.name:
              lineToolSettings[1] = {
                value: item.value,
                property: lineToolSettings[1].property,
                editorPosition: lineToolSettings[1].editorPosition,
                isDisabled: lineToolSettings[1].isDisabled,
                lockProperty: lineToolSettings[1].lockProperty,
              };
              break;
            case useAngleDescription.name:
              lineToolSettings[2] = {
                value: item.value,
                property: lineToolSettings[2].property,
                editorPosition: lineToolSettings[2].editorPosition,
                isDisabled: lineToolSettings[2].isDisabled,
                lockProperty: lineToolSettings[2].lockProperty,
              };
              break;
            case angleDescription.name:
              lineToolSettings[3] = {
                value: item.value,
                property: lineToolSettings[3].property,
                editorPosition: lineToolSettings[3].editorPosition,
                isDisabled: lineToolSettings[3].isDisabled,
                lockProperty: lineToolSettings[3].lockProperty,
              };
              break;
          }
        });
      ...
      mockPlaceLineTool.applyToolSettingPropertyChange({
