...
function Icon() {
  ...
  const svgDockRight = modules?.["@stratakit/icons/dock-right.svg"];
  const svgDockTop = modules?.["@stratakit/icons/dock-top.svg"];
  const svgDockBottom = modules?.["@stratakit/icons/dock-bottom.svg"];
