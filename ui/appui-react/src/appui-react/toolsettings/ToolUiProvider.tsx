...
export class ToolUiProvider extends ConfigurableUiControl {
  ...
  public override get uniqueId(): string {
    return `${this.constructor.name}[${super.uniqueId}]`;
  }
  ...
  public get toolSettingsNode(): React.ReactNode {
    return this._toolSettingsNode;
  }
  public set toolSettingsNode(r: React.ReactNode) {
    this._toolSettingsNode = r;
  }

  /** An array of entries to load into the horizontal tool settings
   * @public
   */
  public get horizontalToolSettingNodes(): ToolSettingsEntry[] | undefined {
    return this._horizontalToolSettingNodes;
  }
  public set horizontalToolSettingNodes(r: ToolSettingsEntry[] | undefined) {
    this._horizontalToolSettingNodes = r;
  }

  /** The UiDataProvider class */
  public get dataProvider(): UiDataProvider | undefined {
    return this._dataProvider;
  }
  public set dataProvider(d: UiDataProvider | undefined) {
  ...
  public getType(): ConfigurableUiControlType {
    return ConfigurableUiControlType.ToolUiProvider;
  }
