...
export class ToolbarButtonHelper {
  public static searchToolbarsByTitle(
    title: string,
    horizontal: boolean
  ): HTMLButtonElement | null {
    // first look for simple tool buttons
    const nodeList = document.documentElement.querySelectorAll(
      `div.nz-toolbar-items.nz-${
  ...
  public static searchHorizontalToolbarsByTitle(
    title: string
  ): HTMLButtonElement | null {
  ...
  public static searchVerticalToolbarsByTitle(
    title: string
  ): HTMLButtonElement | null {
  ...
  public static getToolbarButtonByTitle(
    title: string
  ): HTMLButtonElement | null {
