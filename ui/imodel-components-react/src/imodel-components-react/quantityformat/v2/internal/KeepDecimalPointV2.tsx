...
export function KeepDecimalPointV2(props: KeepDecimalPointV2Props) {
	...
	return (
		<div className="format-inline-row">
			...
			<Checkbox aria-labelledby={keepDecimalPointId} checked={Format.isFormatTraitSetInProps(formatProps, FormatTraits.KeepDecimalPoint)} onChange={handleKeepDecimalPointChange} disabled={disabled} />
		</div>
	);
}
