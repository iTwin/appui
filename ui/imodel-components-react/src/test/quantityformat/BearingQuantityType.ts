...
export class BearingQuantityType implements CustomQuantityTypeDefinition {
  ...
  public static async registerQuantityType(initialProps?: FormatProps) {
    ...
    quantityTypeDefinition._persistenceUnit =
      await IModelApp.quantityFormatter.findUnitByName(
        quantityTypeDefinition._persistenceUnitName
      );
    const wasRegistered =
      await IModelApp.quantityFormatter.registerQuantityType(
