...
describe("PropertyEditorManager", () => {
  ...
  it("createEditor should throw an Error when unregistered dataController passed", () => {
    expect(() =>
      PropertyEditorManager.createEditor("mine4", "myEditor", "invalid")
    ).to.throw(Error);
  });
  ...
  class PropertyEditorWithEditorParams extends PropertyEditorBase {
    ...
    public override applyEditorParams(
  ...
  it("applyEditorParams", () => {
    ...
    PropertyEditorManager.registerEditor(
      "withEditorParams",
      PropertyEditorWithEditorParams
    );
    const propertyEditor =
      PropertyEditorManager.createEditor("withEditorParams");
