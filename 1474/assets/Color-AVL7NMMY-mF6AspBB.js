import { d as debounce2, x as xr, O as O3, g as getControlId, G as G3, N as N7, a as MarkupIcon, _ as __toESM, b as __commonJS } from "./blocks-w2bBkgKV.js";
import { r as reactExports, i as e } from "./iframe-MZ9GDAUV.js";
...
var Wrapper = xr.div({ position: "relative", maxWidth: 250, '&[aria-readonly="true"]': { opacity: 0.5 } }), PickerTooltip = xr(O3)({ position: "absolute", zIndex: 1, top: 4, left: 4, "[aria-readonly=true] &": { cursor: "not-allowed" } }), TooltipContent = xr.div({ width: 200, margin: 5, ".react-colorful__saturation": { borderRadius: "4px 4px 0 0" }, ".react-colorful__hue": { boxShadow: "inset 0 0 0 1px rgb(0 0 0 / 5%)" }, ".react-colorful__last-control": { borderRadius: "0 0 4px 4px" } }), Note = xr(G3)(({ theme }) => ({ fontFamily: theme.typography.fonts.base })), Swatches = xr.div({ display: "grid", gridTemplateColumns: "repeat(9, 16px)", gap: 6, padding: 3, marginTop: 5, width: 200 }), SwatchColor = xr.div(({ theme, active }) => ({ width: 16, height: 16, boxShadow: active ? `${theme.appBorderColor} 0 0 0 1px inset, ${theme.textMutedColor}50 0 0 0 4px` : `${theme.appBorderColor} 0 0 0 1px inset`, borderRadius: theme.appBorderRadius })), swatchBackground = `url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity=".05"><path d="M8 0h8v8H8zM0 8h8v8H0z"/></svg>')`, Swatch = ({ value, style, ...props }) => {
  ...
  return e.createElement(Wrapper, { "aria-readonly": readonly }, e.createElement(PickerTooltip, { startOpen, trigger: readonly ? null : void 0, closeOnOutsideClick: true, onVisibleChange: () => color && addPreset(color), tooltip: e.createElement(TooltipContent, null, e.createElement(Picker, { color: realValue === "transparent" ? "#000000" : realValue, onChange: updateValue, onFocus, onBlur }), presets.length > 0 && e.createElement(Swatches, null, presets.map((preset, index) => e.createElement(O3, { key: `${preset?.value || index}-${index}`, hasChrome: false, tooltip: e.createElement(Note, { note: preset?.keyword || preset?.value || "" }) }, e.createElement(Swatch, { value: preset?.[colorSpace] || "", active: !!(color && preset && preset[colorSpace] && id(preset[colorSpace] || "") === id(color[colorSpace])), onClick: () => preset && updateValue(preset.value || "") }))))) }, e.createElement(Swatch, { value: realValue, style: { margin: 4 } })), e.createElement(Input, { id: getControlId(name), value, onChange: (e2) => updateValue(e2.target.value), onFocus: (e2) => e2.target.select(), readOnly: readonly, placeholder: "Choose color..." }), value ? e.createElement(ToggleIcon, { onClick: cycleColorSpace }) : null);
