...
import { B as Button, g as PropertyValueFormat, S as StandardTypeNames } from "./Key.enum-Cpx2vBj7.js";
import { aa as PropertyFilterBuilderRuleRenderingContext, ab as PropertyFilterBuilderContext, ac as PropertyFilterBuilderRuleGroupRenderer, I as IModelApp, U as UiFramework, ad as usePropertyFilterBuilder, ae as PropertyFilterBuilderRuleValue, af as PropertyFilterRuleGroupOperator } from "./appui-react-w3-SwpAO.js";
...
WithNewEditorSystem.parameters = {
  ...WithNewEditorSystem.parameters,
  docs: {
    ...(_g = WithNewEditorSystem.parameters) == null ? void 0 : _g.docs,
    source: {
      originalSource: '{\n  args: {\n    initialFilter: createInitialFilter(),\n    properties: createProperties(),\n    editorSystem: "new"\n  }\n}',
      ...(_i = (_h = WithNewEditorSystem.parameters) == null ? void 0 : _h.docs) == null ? void 0 : _i.source
    }
  }
};
