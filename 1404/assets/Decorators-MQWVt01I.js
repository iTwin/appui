...
import { I as IModelApp, aG as EmptyLocalization, ai as UiComponents, aH as StateManager, aI as Provider_default, aJ as ThemeManager, U as UiFramework } from "./appui-react-DH8at8DD.js";
import { L as Logger } from "./Key.enum-oRjsNWTu.js";
const _UiIModelComponents = class _UiIModelComponents {
  ...
  static translate(key) {
    ...
    return IModelApp.localization.getLocalizedString(
      `${_UiIModelComponents.localizationNamespace}:${String(key)}`
    );
  }
  /** @internal */
