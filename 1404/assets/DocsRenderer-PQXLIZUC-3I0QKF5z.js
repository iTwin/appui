const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-B_uYetjy.js","./iframe-D_KNlAkp.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, e, r as reactExports } from "./iframe-D_KNlAkp.js";
import { renderElement, unmountElement } from "./react-18-BfO-7GLC.js";
import { H as HeadersMdx, A as AnchorMdx, C as CodeOrSourceMdx, D as Docs } from "./blocks-DGEolTTc.js";
  ...
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        __vitePreload(async () => {
          const { MDXProvider } = await import("./index-B_uYetjy.js");
          return { MDXProvider };
