...
import { AnalysisAnimationToolSettingsProvider } from "../ui/providers/AnalysisAnimationToolSettings";
...
export class AnalysisAnimationTool extends PrimitiveTool {
  ...
  public static getActionButtonDef(
    ...
    const iconSpec = "icon-camera-animation";

    return ToolbarItemUtilities.createActionItem(
      AnalysisAnimationTool.toolId,
      itemPriority,
      iconSpec,
      AnalysisAnimationTool.flyover,
      async () => {
        await IModelApp.tools.run(AnalysisAnimationTool.toolId);
      },
      overrides
    );
  }
