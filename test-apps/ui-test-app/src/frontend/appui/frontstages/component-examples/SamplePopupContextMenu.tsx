...
export function SamplePopupContextMenu({
  ...
  return (
    <div>
      ...
      <PopupContextMenu
        isOpen={isMenuOpen}
        position={position ?? RelativePosition.BottomLeft}
        target={target}
        offset={1}
        onClose={onCloseMenu}
...
export function ButtonWithContextMenu({
  label,
  direction,
}: {
  label?: string;
...
export function ButtonWithDropdownMenu({}: // label,
// placement,
{
  label?: string;
  ...
  const createMenuItemNodes = React.useCallback(
    (close: () => void): JSX.Element[] => {
      const itemNodes = ["Item 1", "Item 2", "Item 3", "Item 4", "Item 5"].map(
        (listItem, index) => {
          return (
            <MenuItem
              key={index}
  ...
  return (
    <div>
      ...
      <Popup
        ...
        showArrow={true}
        showShadow={true}
        closeOnNestedPopupOutsideClick={false}
      >
        <div
          style={{
            width: "150px",
        ...
        >
          <div style={{ display: "flex" }}>
            ...
            <ButtonWithContextMenu
              label="TL"
              direction={ContextMenuDirection.TopLeft}
            />
          </div>
          <div style={{ display: "flex" }}>
            <ButtonWithContextMenu
