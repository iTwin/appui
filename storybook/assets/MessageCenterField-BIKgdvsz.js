...
import { a_ as MessageRenderer, ao as Text, M as MessageManager, aG as useTranslation, O as OutputMessagePriority, a$ as StatusBarPopover, b0 as TitleBar, b1 as Tabs, au as Icon, b2 as SvgInfo, aO as SvgStatusWarning, aM as SvgStatusError, aN as SvgStatusSuccess } from "./appui-react-DXa87bBS.js";
import { g as Box, c as classnames, B as Button } from "./Dialog-CEvMa41g.js";
const NotificationMarker = reactExports.forwardRef((props, ref) => {
  ...
  return reactExports.createElement(Box, { as: "span", ref, className: classnames({ "iui-notification-marker": enabled }, className), "data-iui-variant": enabled ? status : null, "data-iui-urgent": enabled ? pulsing : null, ...rest }, children);
});
const SvgChat = (props) => {
