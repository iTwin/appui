...
import { S as StandardContentLayouts } from "./Key.enum-Nky5yUvk.js";
import { U as UiFramework, ac as ToolbarItemUtilities, a7 as ConditionalIconItem, aK as SyncUiEventId, a8 as ConditionalStringValue, a9 as ConditionalBooleanValue, b as IModelViewportControl } from "./DefaultToolSettingsProvider-BeaL6ll4.js";
...
import { A as AppUiStory, P as Page, r as removeProperty, c as createFrontstage } from "./AppUiStory-4-AayLg_.js";
...
try {
  ...
  SplitViewportStory.__docgenInfo = { "description": "This story shows two separate views. Depending on which view is active, the tools in the toolbars will change", "displayName": "SplitViewportStory", "props": { "itemProviders": { "defaultValue": null, "description": "", "name": "itemProviders", "required": false, "type": { "name": "UiItemsProvider[]" } }, "frontstages": { "defaultValue": null, "description": "", "name": "frontstages", "required": false, "type": { "name": "FrontstageConfig[] | (() => FrontstageConfig[])" } } } };
