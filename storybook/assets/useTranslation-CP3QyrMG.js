...
import { n as init_UiCore$1, t as UiCore } from "./UiCore-DsSHAIdm.js";
...
function init_UiCore() {
	return (init_UiCore = __esmMin((() => {
		form = {
...
function init_LocalizationProvider() {
	return (init_LocalizationProvider = __esmMin((() => {
...
var import_react$1;
function init_usePackageTranslation() {
	return (init_usePackageTranslation = __esmMin((() => {
