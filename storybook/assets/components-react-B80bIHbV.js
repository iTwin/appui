...
function TextEditor$1({ metadata, value, onChange, size: size2, disabled, id }) {
  ...
  return reactExports.createElement(Input$1, { id, value: currentValue.value, onChange: handleChange, onFocus: handleFocus, maxLength, minLength, size: size2, disabled });
}
    ...
    switch (propertyRecord.property.typename) {
      ...
      case "string":
        return {
          ...
          value: {
            value: primitiveValue.value !== void 0 ? primitiveValue.value : primitiveValue.displayValue === "--" ? primitiveValue.displayValue : ""
          }
        };
      case "dateTime":
      case "shortdate":
...
export {
  ...
  useRefs as bB,
  Popup as bC,
  applyNumericConstraints as bD,
  castDraft as bE,
  SearchBox as bF,
  SvgChevronLeft as bG,
  SvgChevronRight as bH,
  GroupTool as bI,
  require_MapCache as bJ,
  require_Symbol as bK,
  require_Uint8Array as bL,
  requireEq as bM,
  require_getAllKeys as bN,
  require_Stack as bO,
  require_getTag as bP,
  requireIsBuffer as bQ,
  requireIsTypedArray as bR,
  requireIsArray as bS,
  requireIsObjectLike as bT,
  _inheritsLoose as bU,
  _objectWithoutPropertiesLoose as bV,
  _extends as bW,
  HorizontalAlignment as bX,
  PopupContext as bY,
  InputWithDecorations as bZ,
  isBoolean as b_,
  ...
  CustomNumberEditor$1 as c0,
  requireDebounce as c1,
  ToolbarPopupAutoHideContext as c2,
  MenuExtraContent as c3,
  useWidgetOpacityContext as c4,
  Direction as c5,
  ToolbarPanelAlignment as c6,
  DivWithOutsideClick as c7,
  FocusTrap as c8,
  ToolbarOpacitySetting as c9,
  focusIntoContainer as ca,
  IconInput as cb,
  WidgetOpacityContext as cc,
  PopupItem as cd,
  SvgChevronDown as ce,
  CustomNumberEditor as cf,
  CustomNumberPropertyEditor$1 as cg,
  TextEditor as ch,
  BasicPropertyEditor as ci,
  NumericInputEditor as cj,
  NumericInputPropertyEditor$1 as ck,
  registerDefaultPropertyEditor as cl,
  isText as d,
  Slider as e,
  Textarea as f,
  ToggleSwitch as g,
