...
import { Ca as SvgInfo, Ci as SvgSaveSettings, Mr as init_esm, Ti as SvgSaveAs, Yi as SvgPasteHollow, il as init_Text, lo as SvgCut, rl as Text, xi as SvgSaveUpdate, yi as SvgSave } from "./components-react-CHXB-2a9.js";
import { r as init_AppUiStory, t as AppUiStory } from "./AppUiStory-DVMw3I-C.js";
import { i as ToolbarItemUtilities, lt as UiFramework, t as init_appui_react } from "./appui-react-B4bFXMth.js";
...
function init_CardPopup() {
	return (init_CardPopup = __esmMin((() => {
		init_appui_react();
		init_Text();
		init_AppUiStory();
...
function init_CardPopup_stories() {
	return (init_CardPopup_stories = __esmMin((() => {
		init_CardPopup();
		init_appui_react();
		init_esm();
