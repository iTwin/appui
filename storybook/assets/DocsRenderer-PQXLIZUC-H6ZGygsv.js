const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-i8KegIy7.js","./iframe-C6dO4R-p.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, e, r as reactExports } from "./iframe-C6dO4R-p.js";
import { renderElement, unmountElement } from "./react-18-BlwO7DbS.js";
import { H as HeadersMdx, A as AnchorMdx, C as CodeOrSourceMdx, D as Docs } from "./blocks-CGNPuRNT.js";
  ...
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        __vitePreload(async () => {
          const { MDXProvider } = await import("./index-i8KegIy7.js");
          return { MDXProvider };
