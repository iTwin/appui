const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-wxFpDL2F.js","./iframe-CyhagKHJ.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, i as e, r as reactExports } from "./iframe-CyhagKHJ.js";
import { renderElement, unmountElement } from "./react-18-DnJfZYri.js";
import { H as HeadersMdx, A as AnchorMdx, C as CodeOrSourceMdx, D as Docs } from "./blocks-D_rIBRpe.js";
  ...
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        __vitePreload(async () => {
          const { MDXProvider } = await import("./index-wxFpDL2F.js");
          return { MDXProvider };
