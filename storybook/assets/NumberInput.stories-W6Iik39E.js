...
import { Fo as SvgCaretUp, Go as SvgCaretDown, Lo as SvgCaretUpSmall, Mr as init_esm, Uc as Input, Wc as init_Input, qo as SvgCaretDownSmall } from "./components-react-CHXB-2a9.js";
...
function init_NumberInput$1() {
	return (init_NumberInput$1 = __esmMin((() => {
...
function init_NumberInput_stories() {
	return (init_NumberInput_stories = __esmMin((() => {
		init_NumberInput$1();
		init_Decorators();
		meta = {
