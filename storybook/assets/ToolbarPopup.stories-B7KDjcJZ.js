...
import { Ca as SvgInfo, Ci as SvgSaveSettings, Mr as init_esm, Ti as SvgSaveAs, lo as SvgCut, xi as SvgSaveUpdate, yi as SvgSave } from "./components-react-CHXB-2a9.js";
...
function init_ToolbarPopup() {
	return (init_ToolbarPopup = __esmMin((() => {
		init_appui_react();
		init_AppUiStory();
...
function init_ToolbarPopup_stories() {
	return (init_ToolbarPopup_stories = __esmMin((() => {
		init_ToolbarPopup();
		init_appui_react();
		init_esm();
