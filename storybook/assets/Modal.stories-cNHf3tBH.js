...
import { $t as ToolbarUsage, Et as ModalFrontstage, Ot as ModalFrontstageButton, Qt as ToolbarOrientation, i as ToolbarItemUtilities, lt as UiFramework, t as init_appui_react } from "./appui-react-B4bFXMth.js";
...
function init_Modal_stories() {
	return (init_Modal_stories = __esmMin((() => {
		init_Decorators();
		init_AppUiStory();
		init_Modal();
		init_appui_react();
