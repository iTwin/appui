import { L as Logger } from "./DefaultToolSettingsProvider-Do4qbEAN.js";
const getObjectClassName = (obj) => {
  var _a;
  return (obj == null ? void 0 : obj.name) ? obj.name : ((_a = obj == null ? void 0 : obj.constructor) == null ? void 0 : _a.name) ? obj.constructor.name : "";
};
