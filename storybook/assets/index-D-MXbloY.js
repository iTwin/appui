function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["./syntaxhighlighter-B5GMVT5T-BZm8CtY0.js","./iframe-kR_u1aqe.js","./index-DlkhCVTf.js","./_commonjsHelpers-LQfde5yM.js","./getPrototypeOf-BmmMfuHC.js","./index-Cm_5MPU1.js","./index-Cp4dr_sK.js","./index-ex9_VrIg.js","./index-BdOSk9or.js","./formatter-SWP5E3XI-BhKdE4as.js","./WithTooltip-V3YHNWJZ-CJcE845l.js","./Color-6VNJS4EI-CJkYQ0z7.js"]
  }
  return indexes.map((i) => __vite__mapDeps.viteFileDeps[i])
}
import { _ as __vitePreload } from "./iframe-kR_u1aqe.js";
import { r as reactExports, a as React, R as React$1 } from "./index-DlkhCVTf.js";
import { g as getDefaultExportFromCjs, c as commonjsGlobal } from "./_commonjsHelpers-LQfde5yM.js";
import { c as commonjsRequire, _ as _setPrototypeOf$2, a as _getPrototypeOf$2, b as _inheritsLoose$2, d as _assertThisInitialized$2, e as _extends$5 } from "./getPrototypeOf-BmmMfuHC.js";
import { r as reactDomExports, R as ReactDOM } from "./index-Cm_5MPU1.js";
import { L as L$1, O as O$1 } from "./index-Cp4dr_sK.js";
import { q as _baseAssignValue, r as eq_1, s as _castPath, t as _isIndex, i as isObject_1, v as _toKey, w as _baseGet, x as _arrayPush, c as _getPrototype, y as _getSymbols, z as stubArray_1, A as _isPrototype, B as _arrayLikeKeys, C as isArrayLike_1, D as _baseGetAllKeys, E as _arrayMap, F as _baseIteratee, G as _Set, H as _setToArray, I as _SetCache, J as _cacheHas, K as keys_1, _ as _root, L as _Uint8Array, M as _Symbol, N as _getTag, d as isObjectLike_1, O as _nodeUtilExports, P as _baseUnary, Q as _Stack, R as isBufferExports, U as _getAllKeys, e as isArray_1, S as SNIPPET_RENDERED, V as str, k as SourceType } from "./index-ex9_VrIg.js";
import { d as dedent$1 } from "./index-BdOSk9or.js";
var getControlId = (value2) => `control-${value2.replace(/\s+/g, "-")}`, getControlSetterButtonId = (value2) => `set-${value2.replace(/\s+/g, "-")}`;
const { global: global$5 } = __STORYBOOK_MODULE_GLOBAL__;
...
function _wrapNativeSuper$2(Class) {
  ...
  return _wrapNativeSuper$2 = function(Class2) {
    ...
    return Wrapper8.prototype = Object.create(Class2.prototype, { constructor: { value: Wrapper8, enumerable: false, writable: true, configurable: true } }), _setPrototypeOf$1(Wrapper8, Class2);
...
function darken$2(amount, color2) {
  ...
  return toColorString$2(_extends$4({}, hslColor, { lightness: guard$2(0, 1, hslColor.lightness - parseFloat(amount)) }));
}
...
function opacify$1(amount, color2) {
  if (color2 === "transparent")
    return color2;
  var parsedColor = parseToRgb$2(color2), alpha = typeof parsedColor.alpha == "number" ? parsedColor.alpha : 1, colorWithAlpha = _extends$4({}, parsedColor, { alpha: guard$2(0, 1, (alpha * 100 + parseFloat(amount) * 100) / 100) });
...
function transparentize$2(amount, color2) {
  if (color2 === "transparent")
    return color2;
  var parsedColor = parseToRgb$2(color2), alpha = typeof parsedColor.alpha == "number" ? parsedColor.alpha : 1, colorWithAlpha = _extends$4({}, parsedColor, { alpha: guard$2(0, 1, +(alpha * 100 - parseFloat(amount) * 100).toFixed(2) / 100) });
  return rgba$2(colorWithAlpha);
}
var curriedTransparentize$3 = curry$2(transparentize$2), curriedTransparentize$1$2 = curriedTransparentize$3;
var color = { primary: "#FF4785", secondary: "#029CFD", tertiary: "#FAFBFC", ancillary: "#22a699", orange: "#FC521F", gold: "#FFAE00", green: "#66BF3C", seafoam: "#37D5D3", purple: "#6F2CAC", ultraviolet: "#2A0481", lightest: "#FFFFFF", lighter: "#F7FAFC", light: "#EEF3F6", mediumlight: "#ECF4F9", medium: "#D9E8F2", mediumdark: "#73828C", dark: "#5C6870", darker: "#454E54", darkest: "#2E3438", border: "hsla(203, 50%, 30%, 0.15)", positive: "#66BF3C", negative: "#FF4400", warning: "#E69D00", critical: "#FFFFFF", defaultText: "#2E3438", inverseText: "#FFFFFF", positiveText: "#448028", negativeText: "#D43900", warningText: "#A15C20" }, background = { app: "#F6F9FC", bar: color.lightest, content: color.lightest, preview: color.lightest, gridCellSize: 10, hoverable: curriedTransparentize$1$2(0.9, color.secondary), positive: "#E1FFD4", negative: "#FEDED2", warning: "#FFF5CF", critical: "#FF4400" }, typography = { fonts: { base: ['"Nunito Sans"', "-apple-system", '".SFNSText-Regular"', '"San Francisco"', "BlinkMacSystemFont", '"Segoe UI"', '"Helvetica Neue"', "Helvetica", "Arial", "sans-serif"].join(", "), mono: ["ui-monospace", "Menlo", "Monaco", '"Roboto Mono"', '"Oxygen Mono"', '"Ubuntu Monospace"', '"Source Code Pro"', '"Droid Sans Mono"', '"Courier New"', "monospace"].join(", ") }, weight: { regular: 400, bold: 700 }, size: { s1: 12, s2: 14, s3: 16, m1: 20, m2: 24, m3: 28, l1: 32, l2: 40, l3: 48, code: 90 } };
...
var useTheme = function() {
  ...
  return _extends2$2({}, outerTheme, theme3);
...
You may have forgotten to import it.`);
  ...
  return function() {
    ...
    return Styled.displayName = identifierName !== void 0 ? identifierName : "Styled(" + (typeof baseTag == "string" ? baseTag : baseTag.displayName || baseTag.name || "Component") + ")", Styled.defaultProps = tag.defaultProps, Styled.__emotion_real = Styled, Styled.__emotion_base = baseTag, Styled.__emotion_styles = styles2, Styled.__emotion_forwardProp = shouldForwardProp, Object.defineProperty(Styled, "toString", { value: function() {
      ...
      return createStyled2(nextTag, _extends$3({}, options, nextOptions, { shouldForwardProp: composeShouldForwardProps(Styled, nextOptions, true) })).apply(void 0, styles2);
    }, Styled;
  };
};
...
function createElement(_ref) {
  ...
  if (TagName) {
    ...
    return React$1.createElement(TagName, _extends$2({ key }, props), children);
  }
}
...
var Wrapper$3 = newStyled.div(({ theme: theme3 }) => ({ position: "relative", overflow: "hidden", color: theme3.color.defaultText }), ({ theme: theme3, bordered }) => bordered ? { border: `1px solid ${theme3.appBorderColor}`, borderRadius: theme3.borderRadius, background: theme3.background.content } : {}, ({ showLineNumbers }) => showLineNumbers ? { ".react-syntax-highlighter-line-number::before": { content: "attr(data-line-number)" } } : {}), UnstyledScroller = ({ children, className }) => React$1.createElement(ScrollArea, { horizontal: true, vertical: true, className }, children), Scroller = newStyled(UnstyledScroller)({ position: "relative" }, ({ theme: theme3 }) => themedSyntax(theme3)), Pre$1 = newStyled.pre(({ theme: theme3, padded }) => ({ display: "flex", justifyContent: "flex-start", margin: 0, padding: padded ? theme3.layoutMargin : 0 })), Code$1 = newStyled.div(({ theme: theme3 }) => ({ flex: 1, paddingLeft: 2, paddingRight: theme3.layoutMargin, opacity: 1 })), processLineNumber = (row) => {
  ...
  if (typeof children != "string" || !children.trim())
    return null;
  let highlightableCode = formatter ? formatter(format2, children) : children.trim(), [copied, setCopied] = reactExports.useState(false), onClick = reactExports.useCallback((e) => {
...
function usePopperTooltip(config, popperOptions) {
  ...
  var finalConfig = Object.keys(defaultConfig).reduce(function(config2, key) {
    var _extends22;
    return _extends$1({}, config2, (_extends22 = {}, _extends22[key] = config2[key] !== void 0 ? config2[key] : defaultConfig[key], _extends22));
...
`, WithTooltipPure$1 = ({ svg, trigger, closeOnOutsideClick, placement, hasChrome, withArrows, offset: offset2, tooltip, children, closeOnTriggerHidden, mutationObserverOptions, closeOnClick, tooltipShown, onVisibilityChange, defaultVisible, delayHide, visible, interactive, delayShow, modifiers, strategy, followCursor, onVisibleChange, ...props }) => {
  ...
  return React$1.createElement(React$1.Fragment, null, React$1.createElement(Container2, { trigger, ref: setTriggerRef, ...props }, children), isVisible && ReactDOM.createPortal(tooltipComponent, document2$2.body));
};
...
var A$2 = newStyled(Link)(withReset, ({ theme: theme3 }) => ({ fontSize: "inherit", lineHeight: "24px", color: theme3.color.secondary, textDecoration: "none", "&.absent": { color: "#cc0000" }, "&.anchor": { display: "block", paddingLeft: 30, marginLeft: -30, cursor: "pointer", position: "absolute", top: 0, left: 0, bottom: 0 } }));
var Blockquote = newStyled.blockquote(withReset, withMargin, ({ theme: theme3 }) => ({ borderLeft: `4px solid ${theme3.color.medium}`, padding: "0 15px", color: theme3.color.dark, "& > :first-of-type": { marginTop: 0 }, "& > :last-child": { marginBottom: 0 } }));
var isReactChildString = (child) => typeof child == "string";
var isInlineCodeRegex = /[\n\r]/g, DefaultCodeBlock = newStyled.code(({ theme: theme3 }) => ({ fontFamily: theme3.typography.fonts.mono, WebkitFontSmoothing: "antialiased", MozOsxFontSmoothing: "grayscale", display: "inline-block", paddingLeft: 2, paddingRight: 2, verticalAlign: "baseline", color: "inherit" }), codeCommon), StyledSyntaxHighlighter$1 = newStyled(SyntaxHighlighter2$1)(({ theme: theme3 }) => ({ fontFamily: theme3.typography.fonts.mono, fontSize: `${theme3.typography.size.s2 - 1}px`, lineHeight: "19px", margin: "25px 0 40px", borderRadius: theme3.appBorderRadius, boxShadow: theme3.base === "light" ? "rgba(0, 0, 0, 0.10) 0 1px 3px 0" : "rgba(0, 0, 0, 0.20) 0 2px 5px 0", "pre.prismjs": { padding: 20, background: "inherit" } })), Code = ({ className, children, ...props }) => {
...
var H1 = newStyled.h1(withReset, headerCommon, ({ theme: theme3 }) => ({ fontSize: `${theme3.typography.size.l1}px`, fontWeight: theme3.typography.weight.bold }));
var H2 = newStyled.h2(withReset, headerCommon, ({ theme: theme3 }) => ({ fontSize: `${theme3.typography.size.m2}px`, paddingBottom: 4, borderBottom: `1px solid ${theme3.appBorderColor}` }));
var H3 = newStyled.h3(withReset, headerCommon, ({ theme: theme3 }) => ({ fontSize: `${theme3.typography.size.m1}px` }));
var H4 = newStyled.h4(withReset, headerCommon, ({ theme: theme3 }) => ({ fontSize: `${theme3.typography.size.s3}px` }));
var H5 = newStyled.h5(withReset, headerCommon, ({ theme: theme3 }) => ({ fontSize: `${theme3.typography.size.s2}px` }));
var H6 = newStyled.h6(withReset, headerCommon, ({ theme: theme3 }) => ({ fontSize: `${theme3.typography.size.s2}px`, color: theme3.color.dark }));
var HR = newStyled.hr(({ theme: theme3 }) => ({ border: "0 none", borderTop: `1px solid ${theme3.appBorderColor}`, height: 4, padding: 0 }));
var Img = newStyled.img({ maxWidth: "100%" });
var LI = newStyled.li(withReset, ({ theme: theme3 }) => ({ fontSize: theme3.typography.size.s2, color: theme3.color.defaultText, lineHeight: "24px", "& + li": { marginTop: ".25em" }, "& ul, & ol": { marginTop: ".25em", marginBottom: 0 }, "& code": codeCommon({ theme: theme3 }) }));
...
var BadgeWrapper = newStyled.div(({ theme: theme3 }) => ({ display: "inline-block", fontSize: 11, lineHeight: "12px", alignSelf: "center", padding: "4px 12px", borderRadius: "3em", fontWeight: theme3.typography.weight.bold }), { svg: { height: 12, width: 12, marginRight: 4, marginTop: -2, path: { fill: "currentColor" } } }, ({ theme: theme3, status }) => {
  switch (status) {
    case "critical":
...
var languages = [], Comp = null, LazySyntaxHighlighter = reactExports.lazy(async () => {
  ...
  let [{ SyntaxHighlighter: SyntaxHighlighter3 }, { formatter }] = await Promise.all([__vitePreload(() => import("./syntaxhighlighter-B5GMVT5T-BZm8CtY0.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0, import.meta.url), __vitePreload(() => import("./formatter-SWP5E3XI-BhKdE4as.js"), true ? __vite__mapDeps([9,1,2,3,4,5,6,7,8]) : void 0, import.meta.url)]);
  return languages.length > 0 && (languages.forEach((args) => {
    SyntaxHighlighter3.registerLanguage(...args);
...
var toNumber = (input) => typeof input == "number" ? input : Number(input), Container = newStyled.div(({ theme: theme3, col, row = 1 }) => col ? { display: "inline-block", verticalAlign: "inherit", "& > *": { marginLeft: col * theme3.layoutMargin, verticalAlign: "inherit" }, [`& > *:first-child${ignoreSsrWarning}`]: { marginLeft: 0 } } : { "& > *": { marginTop: row * theme3.layoutMargin }, [`& > *:first-child${ignoreSsrWarning}`]: { marginTop: 0 } }, ({ theme: theme3, outer, col, row }) => {
  switch (true) {
    case !!(outer && col):
...
var Title$1 = newStyled.div(({ theme: theme3 }) => ({ fontWeight: theme3.typography.weight.bold })), Desc = newStyled.div(), Message = newStyled.div(({ theme: theme3 }) => ({ padding: 30, textAlign: "center", color: theme3.color.defaultText, fontSize: theme3.typography.size.s2 - 1 })), Placeholder = ({ children, ...props }) => {
...
var { document: document2$1 } = global$2, ErrorName = newStyled.strong(({ theme: theme3 }) => ({ color: theme3.color.orange })), ErrorImportant = newStyled.strong(({ theme: theme3 }) => ({ color: theme3.color.ancillary, textDecoration: "underline" })), ErrorDetail = newStyled.em(({ theme: theme3 }) => ({ color: theme3.textMutedColor })), firstLineRegex = /(Error): (.*)\n/, linesRegexChromium = /at (?:(.*) )?\(?(.+)\)?/, linesRegexFirefox = /([^@]+)?(?:\/<)?@(.+)?/, linesRegexSafari = /([^@]+)?@(.+)?/, ErrorFormatter = ({ error }) => {
  if (!error)
...
var Wrapper$1 = newStyled.label(({ theme: theme3 }) => ({ display: "flex", borderBottom: `1px solid ${theme3.appBorderColor}`, margin: "0 15px", padding: "8px 0", "&:last-child": { marginBottom: "3rem" } })), Label$1 = newStyled.span(({ theme: theme3 }) => ({ minWidth: 100, fontWeight: theme3.typography.weight.bold, marginRight: 15, display: "flex", justifyContent: "flex-start", alignItems: "center", lineHeight: "16px" })), Field = ({ label, children, ...props }) => React$1.createElement(Wrapper$1, { ...props }, label ? React$1.createElement(Label$1, null, React$1.createElement("span", null, label)) : null, children);
...
var LazyWithTooltip = reactExports.lazy(() => __vitePreload(() => import("./WithTooltip-V3YHNWJZ-CJcE845l.js"), true ? __vite__mapDeps([10,1,2,3,4,5,6,7,8]) : void 0, import.meta.url).then((mod) => ({ default: mod.WithTooltip }))), WithTooltip = (props) => React$1.createElement(reactExports.Suspense, { fallback: React$1.createElement("div", null) }, React$1.createElement(LazyWithTooltip, { ...props })), LazyWithTooltipPure = reactExports.lazy(() => __vitePreload(() => import("./WithTooltip-V3YHNWJZ-CJcE845l.js"), true ? __vite__mapDeps([10,1,2,3,4,5,6,7,8]) : void 0, import.meta.url).then((mod) => ({ default: mod.WithTooltipPure }))), WithTooltipPure = (props) => React$1.createElement(reactExports.Suspense, { fallback: React$1.createElement("div", null) }, React$1.createElement(LazyWithTooltipPure, { ...props }));
var Title2$1 = newStyled.div(({ theme: theme3 }) => ({ fontWeight: theme3.typography.weight.bold })), Desc2 = newStyled.span(), Links$1 = newStyled.div(({ theme: theme3 }) => ({ marginTop: 8, textAlign: "center", "> *": { margin: "0 8px", fontWeight: theme3.typography.weight.bold } })), Message2 = newStyled.div(({ theme: theme3 }) => ({ color: theme3.color.defaultText, lineHeight: "18px" })), MessageWrapper = newStyled.div({ padding: 15, width: 280, boxSizing: "border-box" }), TooltipMessage = ({ title, desc, links }) => React$1.createElement(MessageWrapper, null, React$1.createElement(Message2, null, title && React$1.createElement(Title2$1, null, title), desc && React$1.createElement(Desc2, null, desc)), links && React$1.createElement(Links$1, null, links.map(({ title: linkTitle, ...other }) => React$1.createElement(Link2, { ...other, key: linkTitle }, linkTitle))));
TooltipMessage.defaultProps = { title: null, desc: null, links: null };
var Note = newStyled.div(({ theme: theme3 }) => ({ padding: "2px 6px", lineHeight: "16px", fontSize: 10, fontWeight: theme3.typography.weight.bold, color: theme3.color.lightest, boxShadow: "0 0 5px 0 rgba(0, 0, 0, 0.3)", borderRadius: 4, whiteSpace: "nowrap", pointerEvents: "none", zIndex: -1, background: theme3.base === "light" ? "rgba(60, 60, 60, 0.9)" : "rgba(0, 0, 0, 0.95)", margin: 6 })), TooltipNote = ({ note, ...props }) => React$1.createElement(Note, { ...props }, note);
var Title3$1 = newStyled(({ active, loading, disabled, ...rest }) => React$1.createElement("span", { ...rest }))(({ theme: theme3 }) => ({ color: theme3.color.defaultText, fontWeight: theme3.typography.weight.regular }), ({ active, theme: theme3 }) => active ? { color: theme3.color.secondary, fontWeight: theme3.typography.weight.bold } : {}, ({ loading, theme: theme3 }) => loading ? { display: "inline-block", flex: "none", ...theme3.animation.inlineGlow } : {}, ({ disabled, theme: theme3 }) => disabled ? { color: curriedTransparentize$1$1(0.7, theme3.color.defaultText) } : {}), Right = newStyled.span({ display: "flex", "& svg": { height: 12, width: 12, margin: "3px 0", verticalAlign: "top" }, "& path": { fill: "inherit" } }), Center = newStyled.span({ flex: 1, textAlign: "left", display: "flex", flexDirection: "column" }, ({ isIndented }) => isIndented ? { marginLeft: 24 } : {}), CenterText = newStyled.span(({ theme: theme3 }) => ({ fontSize: "11px", lineHeight: "14px" }), ({ active, theme: theme3 }) => active ? { color: theme3.color.secondary } : {}, ({ theme: theme3, disabled }) => disabled ? { color: theme3.textMutedColor } : {}), Left = newStyled.span(({ active, theme: theme3 }) => active ? { "& svg": { opacity: 1 }, "& svg path:not([fill])": { fill: theme3.color.secondary } } : {}, () => ({ display: "flex", maxWidth: 14 })), Item = newStyled.a(({ theme: theme3 }) => ({ fontSize: theme3.typography.size.s1, transition: "all 150ms ease-out", color: theme3.color.dark, textDecoration: "none", cursor: "pointer", justifyContent: "space-between", lineHeight: "18px", padding: "7px 10px", display: "flex", alignItems: "center", "& > * + *": { paddingLeft: 10 }, "&:hover": { background: theme3.background.hoverable }, "&:hover svg": { opacity: 1 } }), ({ disabled }) => disabled ? { cursor: "not-allowed" } : {}), getItemProps = memoize$2(100)((onClick, href, LinkWrapper) => {
  let result = {};
...
var List = newStyled.div({ minWidth: 180, overflow: "hidden", overflowY: "auto", maxHeight: 15.5 * 32 }, ({ theme: theme3 }) => ({ borderRadius: theme3.appBorderRadius })), Item2 = (props) => {
...
var IconButton = newStyled(ButtonOrLink, { shouldForwardProp: isPropValid })(() => ({ alignItems: "center", background: "transparent", border: "none", borderRadius: 4, color: "inherit", cursor: "pointer", display: "inline-flex", fontSize: 13, fontWeight: "bold", height: 28, justifyContent: "center", marginTop: 6, padding: "8px 7px", "& > svg": { width: 14 } }), ({ active, theme: theme3 }) => active ? { backgroundColor: theme3.background.hoverable, color: theme3.barSelectedColor } : {}, ({ disabled, theme: theme3 }) => disabled ? { opacity: 0.5, cursor: "not-allowed" } : { "&:hover, &:focus-visible": { background: curriedTransparentize$1$1(0.88, theme3.color.secondary), color: theme3.barHoverColor }, "&:focus-visible": { outline: auto }, "&:focus:not(:focus-visible)": { outline: "none" } });
IconButton.displayName = "IconButton";
var IconPlaceholder = newStyled.div(({ theme: theme3 }) => ({ width: 14, height: 14, backgroundColor: theme3.appBorderColor, animation: `${theme3.animation.glow} 1.5s ease-in-out infinite` })), IconButtonSkeletonWrapper = newStyled.div(() => ({ marginTop: 6, padding: 7, height: 28 })), IconButtonSkeleton = () => React$1.createElement(IconButtonSkeletonWrapper, null, React$1.createElement(IconPlaceholder, null));
...
var UnstyledBar = ({ children, className, scrollable }) => scrollable ? React$1.createElement(ScrollArea, { vertical: false, className }, children) : React$1.createElement("div", { className }, children), Bar$1 = newStyled(UnstyledBar)(({ theme: theme3, scrollable = true }) => ({ color: theme3.barTextColor, width: "100%", height: 40, flexShrink: 0, overflow: scrollable ? "auto" : "hidden", overflowY: "hidden" }), ({ theme: theme3, border = false }) => border ? { boxShadow: `${theme3.appBorderColor}  0 -1px 0 0 inset`, background: theme3.barBg } : {});
...
var CollapseIcon = newStyled.span(({ theme: theme3, isActive }) => ({ display: "inline-block", width: 0, height: 0, marginLeft: 8, color: isActive ? theme3.color.secondary : theme3.color.mediumdark, borderRight: "3px solid transparent", borderLeft: "3px solid transparent", borderTop: "3px solid", transition: "transform .1s ease-out" })), AddonButton = newStyled(TabButton)(({ active, theme: theme3, preActive }) => `
...
var Separator = newStyled.span(({ theme: theme3 }) => ({ width: 1, height: 20, background: theme3.appBorderColor, marginTop: 10, marginLeft: 6, marginRight: 2 }), ({ force }) => force ? {} : { "& + &": { display: "none" } });
...
`;
var LoaderWrapper = newStyled.div(({ size = 32 }) => ({ borderRadius: "50%", cursor: "progress", display: "inline-block", overflow: "hidden", position: "absolute", transition: "all 200ms ease-out", verticalAlign: "top", top: "50%", left: "50%", marginTop: -(size / 2), marginLeft: -(size / 2), height: size, width: size, zIndex: 4, borderWidth: 2, borderStyle: "solid", borderColor: "rgba(97, 97, 97, 0.29)", borderTopColor: "rgb(100,100,100)", animation: `${rotate360} 0.7s linear infinite`, mixBlendMode: "difference" })), ProgressWrapper = newStyled.div({ position: "absolute", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", width: "100%", height: "100%" }), ProgressTrack = newStyled.div(({ theme: theme3 }) => ({ position: "relative", width: "80%", marginBottom: "0.75rem", maxWidth: 300, height: 5, borderRadius: 5, background: curriedTransparentize$1$1(0.8, theme3.color.secondary), overflow: "hidden", cursor: "progress" })), ProgressBar = newStyled.div(({ theme: theme3 }) => ({ position: "absolute", top: 0, left: 0, height: "100%", background: theme3.color.secondary })), ProgressMessage = newStyled.div(({ theme: theme3 }) => ({ minHeight: "2em", fontSize: `${theme3.typography.size.s1}px`, color: theme3.barTextColor })), ErrorIcon = newStyled(Icons)(({ theme: theme3 }) => ({ width: 20, height: 20, marginBottom: "0.5rem", color: theme3.textMutedColor })), ellipsis = keyframes`
  from { content: "..." }
  33% { content: "." }
  66% { content: ".." }
  to { content: "..." }
...
function _wrapNativeSuper(Class) {
  ...
  _wrapNativeSuper = function _wrapNativeSuper2(Class2) {
    ...
    return _setPrototypeOf$2(Wrapper8, Class2);
  };
...
`, { inline: t3 }));
  ...
  }(X2), le2 = (oe2 = /* @__PURE__ */ function(e, n2) {
...
var Wrapper = newStyled.div(withReset, ({ theme: theme3 }) => ({ backgroundColor: theme3.base === "light" ? "rgba(0,0,0,.01)" : "rgba(255,255,255,.01)", borderRadius: theme3.appBorderRadius, border: `1px dashed ${theme3.appBorderColor}`, display: "flex", alignItems: "center", justifyContent: "center", padding: 20, margin: "25px 0 40px", color: curriedTransparentize$1(0.3, theme3.color.defaultText), fontSize: theme3.typography.size.s2 })), EmptyBlock = (props) => React$1.createElement(Wrapper, { ...props, className: "docblock-emptyblock sb-unstyled" });
var StyledSyntaxHighlighter = newStyled(SyntaxHighlighter2)(({ theme: theme3 }) => ({ fontSize: `${theme3.typography.size.s2 - 1}px`, lineHeight: "19px", margin: "25px 0 40px", borderRadius: theme3.appBorderRadius, boxShadow: theme3.base === "light" ? "rgba(0, 0, 0, 0.10) 0 1px 3px 0" : "rgba(0, 0, 0, 0.20) 0 2px 5px 0", "pre.prismjs": { padding: 20, background: "inherit" } }));
var SourceSkeletonWrapper = newStyled.div(({ theme: theme3 }) => ({ background: theme3.background.content, borderRadius: theme3.appBorderRadius, border: `1px solid ${theme3.appBorderColor}`, boxShadow: theme3.base === "light" ? "rgba(0, 0, 0, 0.10) 0 1px 3px 0" : "rgba(0, 0, 0, 0.20) 0 2px 5px 0", margin: "25px 0 40px", padding: "20px 20px 20px 22px" })), SourceSkeletonPlaceholder = newStyled.div(({ theme: theme3 }) => ({ animation: `${theme3.animation.glow} 1.5s ease-in-out infinite`, background: theme3.appBorderColor, height: 17, marginTop: 1, width: "60%", [`&:first-child${ignoreSsrWarning}`]: { margin: 0 } })), SourceSkeleton = () => React$1.createElement(SourceSkeletonWrapper, null, React$1.createElement(SourceSkeletonPlaceholder, null), React$1.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }), React$1.createElement(SourceSkeletonPlaceholder, { style: { width: "30%" } }), React$1.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } })), Source = ({ isLoading, error, language, code, dark, format: format2, ...rest }) => {
  if (isLoading)
...
var Table = newStyled.table(({ theme: theme3 }) => ({ "&&": { borderCollapse: "collapse", borderSpacing: 0, border: "none", tr: { border: "none !important", background: "none" }, "td, th": { padding: 0, border: "none", width: "auto!important" }, marginTop: 0, marginBottom: 0, "th:first-of-type, td:first-of-type": { paddingLeft: 0 }, "th:last-of-type, td:last-of-type": { paddingRight: 0 }, td: { paddingTop: 0, paddingBottom: 4, "&:not(:first-of-type)": { paddingLeft: 10, paddingRight: 0 } }, tbody: { boxShadow: "none", border: "none" }, code: codeCommon({ theme: theme3 }), div: { span: { fontWeight: "bold" } }, "& code": { margin: 0, display: "inline-block", fontSize: theme3.typography.size.s1 } } })), ArgJsDoc = ({ tags: tags2 }) => {
...
var ITEMS_BEFORE_EXPANSION = 8, Summary = newStyled.div(({ isExpanded }) => ({ display: "flex", flexDirection: isExpanded ? "column" : "row", flexWrap: "wrap", alignItems: "flex-start", marginBottom: "-4px", minWidth: 100 })), Text = newStyled.span(codeCommon, ({ theme: theme3, simple = false }) => ({ flex: "0 0 auto", fontFamily: theme3.typography.fonts.mono, fontSize: theme3.typography.size.s1, wordBreak: "break-word", whiteSpace: "normal", maxWidth: "100%", margin: 0, marginRight: "4px", marginBottom: "4px", paddingTop: "2px", paddingBottom: "2px", lineHeight: "13px", ...simple && { background: "transparent", border: "0 none", paddingLeft: 0 } })), ExpandButton = newStyled.button(({ theme: theme3 }) => ({ fontFamily: theme3.typography.fonts.mono, color: theme3.color.secondary, marginBottom: "4px", background: "none", border: "none" })), Expandable = newStyled.div(codeCommon, ({ theme: theme3 }) => ({ fontFamily: theme3.typography.fonts.mono, color: theme3.color.secondary, fontSize: theme3.typography.size.s1, margin: 0, whiteSpace: "nowrap", display: "flex", alignItems: "center" })), Detail = newStyled.div(({ theme: theme3, width }) => ({ width, minWidth: 200, maxWidth: 800, padding: 15, fontFamily: theme3.typography.fonts.mono, fontSize: theme3.typography.size.s1, boxSizing: "content-box", "& code": { padding: "0 !important" } })), ArrowIcon = newStyled(Icons)({ height: 10, width: 10, minWidth: 10, marginLeft: 4 }), EmptyArg = () => React$1.createElement("span", null, "-"), ArgText = ({ text, simple }) => React$1.createElement(Text, { simple }, text), calculateDetailWidth = memoize$2(1e3)((detail) => {
...
}, FlexSpaced = newStyled.div(({ theme: theme3 }) => ({ flex: 1, display: "flex", input: { marginLeft: 10, flex: 1, height: 32, "&::-webkit-calendar-picker-indicator": { opacity: 0.5, height: 12, filter: theme3.base === "light" ? void 0 : "invert(1)" } }, "input:first-of-type": { marginLeft: 0, flexGrow: 4 }, "input:last-of-type": { flexGrow: 3 } })), DateControl = ({ name, value: value2, onChange, onFocus, onBlur }) => {
...
var styleResets = { appearance: "none", border: "0 none", boxSizing: "inherit", display: " block", margin: " 0", background: "transparent", padding: 0, fontSize: "inherit", position: "relative" }, OptionsSelect = newStyled.select(styleResets, ({ theme: theme3 }) => ({ boxSizing: "border-box", position: "relative", padding: "6px 10px", width: "100%", color: theme3.input.color || "inherit", background: theme3.input.background, borderRadius: theme3.input.borderRadius, boxShadow: `${theme3.input.border} 0 0 0 1px inset`, fontSize: theme3.typography.size.s2 - 1, lineHeight: "20px", "&:focus": { boxShadow: `${theme3.color.secondary} 0 0 0 1px inset`, outline: "none" }, "&[disabled]": { cursor: "not-allowed", opacity: 0.5 }, "::placeholder": { color: theme3.textMutedColor }, "&[multiple]": { overflow: "auto", padding: 0, option: { display: "block", padding: "6px 10px", marginLeft: 1, marginRight: 1 } } })), SelectWrapper = newStyled.span(({ theme: theme3 }) => ({ display: "inline-block", lineHeight: "normal", overflow: "hidden", position: "relative", verticalAlign: "top", width: "100%", svg: { position: "absolute", zIndex: 1, pointerEvents: "none", height: "12px", marginTop: "-6px", right: "12px", top: "50%", fill: theme3.textMutedColor, path: { fill: theme3.textMutedColor } } })), NO_SELECTION = "Choose option...", SingleSelect = ({ name, value: value2, options, onChange }) => {
  let handleChange = (e) => {
...
var RangeInput = newStyled.input(({ theme: theme3, min: min2, max: max2, value: value2 }) => ({ "&": { width: "100%", backgroundColor: "transparent", appearance: "none" }, "&::-webkit-slider-runnable-track": { background: theme3.base === "light" ? `linear-gradient(to right, 
...
var LazyColorControl = reactExports.lazy(() => __vitePreload(() => import("./Color-6VNJS4EI-CJkYQ0z7.js"), true ? __vite__mapDeps([11,2,3,7,1,4,5,6,8]) : void 0, import.meta.url)), ColorControl = (props) => React$1.createElement(reactExports.Suspense, { fallback: React$1.createElement("div", null) }, React$1.createElement(LazyColorControl, { ...props }));
...
var Name = newStyled.span({ fontWeight: "bold" }), Required = newStyled.span(({ theme: theme3 }) => ({ color: theme3.color.negative, fontFamily: theme3.typography.fonts.mono, cursor: "help" })), Description = newStyled.div(({ theme: theme3 }) => ({ "&&": { p: { margin: "0 0 10px 0" }, a: { color: theme3.color.secondary } }, code: { ...codeCommon({ theme: theme3 }), fontSize: 12, fontFamily: theme3.typography.fonts.mono }, "& code": { margin: 0, display: "inline-block" }, "& pre > code": { whiteSpace: "pre-wrap" } })), Type = newStyled.div(({ theme: theme3, hasDescription }) => ({ color: theme3.base === "light" ? curriedTransparentize$1(0.1, theme3.color.defaultText) : curriedTransparentize$1(0.2, theme3.color.defaultText), marginTop: hasDescription ? 4 : 0 })), TypeWithJsDoc = newStyled.div(({ theme: theme3, hasDescription }) => ({ color: theme3.base === "light" ? curriedTransparentize$1(0.1, theme3.color.defaultText) : curriedTransparentize$1(0.2, theme3.color.defaultText), marginTop: hasDescription ? 12 : 0, marginBottom: 12 })), StyledTd = newStyled.td(({ theme: theme3, expandable }) => ({ paddingLeft: expandable ? "40px !important" : "20px !important" })), ArgRow = (props) => {
  var _a;
...
var ExpanderIcon = newStyled(Icons)(({ theme: theme3 }) => ({ marginRight: 8, marginLeft: -10, marginTop: -2, height: 12, width: 12, color: theme3.base === "light" ? curriedTransparentize$1(0.25, theme3.color.defaultText) : curriedTransparentize$1(0.3, theme3.color.defaultText), border: "none", display: "inline-block" })), FlexWrapper = newStyled.span(({ theme: theme3 }) => ({ display: "flex", lineHeight: "20px", alignItems: "center" })), Section = newStyled.td(({ theme: theme3 }) => ({ position: "relative", letterSpacing: "0.35em", textTransform: "uppercase", fontWeight: theme3.typography.weight.bold, fontSize: theme3.typography.size.s1 - 1, color: theme3.base === "light" ? curriedTransparentize$1(0.4, theme3.color.defaultText) : curriedTransparentize$1(0.6, theme3.color.defaultText), background: `${theme3.background.app} !important`, "& ~ td": { background: `${theme3.background.app} !important` } })), Subsection = newStyled.td(({ theme: theme3 }) => ({ position: "relative", fontWeight: theme3.typography.weight.bold, fontSize: theme3.typography.size.s2 - 1, background: theme3.background.app })), StyledTd2 = newStyled.td(() => ({ position: "relative" })), StyledTr = newStyled.tr(({ theme: theme3 }) => ({ "&:hover > td": { backgroundColor: `${curriedLighten$1(5e-3, theme3.background.app)} !important`, boxShadow: `${theme3.color.mediumlight} 0 - 1px 0 0 inset`, cursor: "row-resize" } })), ClickIntercept = newStyled.button(() => ({ background: "none", border: "none", padding: "0", font: "inherit", position: "absolute", top: 0, bottom: 0, left: 0, right: 0, height: "100%", width: "100%", color: "transparent", cursor: "row-resize !important" })), SectionRow = ({ level = "section", label, children, initialExpanded = true, colSpan = 3 }) => {
...
var Row = newStyled.div(({ theme: theme3 }) => ({ display: "flex", gap: 16, borderBottom: `1px solid ${theme3.appBorderColor}`, "&:last-child": { borderBottom: 0 } })), Column = newStyled.div(({ numColumn }) => ({ display: "flex", flexDirection: "column", flex: numColumn || 1, gap: 5, padding: "12px 20px" })), SkeletonText = newStyled.div(({ theme: theme3, width, height }) => ({ animation: `${theme3.animation.glow} 1.5s ease-in-out infinite`, background: theme3.appBorderColor, width: width || "100%", height: height || 16, borderRadius: 3 })), columnWidth = [2, 4, 2, 2], Skeleton = () => React$1.createElement(React$1.Fragment, null, React$1.createElement(Row, null, React$1.createElement(Column, { numColumn: columnWidth[0] }, React$1.createElement(SkeletonText, { width: "60%" })), React$1.createElement(Column, { numColumn: columnWidth[1] }, React$1.createElement(SkeletonText, { width: "30%" })), React$1.createElement(Column, { numColumn: columnWidth[2] }, React$1.createElement(SkeletonText, { width: "60%" })), React$1.createElement(Column, { numColumn: columnWidth[3] }, React$1.createElement(SkeletonText, { width: "60%" }))), React$1.createElement(Row, null, React$1.createElement(Column, { numColumn: columnWidth[0] }, React$1.createElement(SkeletonText, { width: "60%" })), React$1.createElement(Column, { numColumn: columnWidth[1] }, React$1.createElement(SkeletonText, { width: "80%" }), React$1.createElement(SkeletonText, { width: "30%" })), React$1.createElement(Column, { numColumn: columnWidth[2] }, React$1.createElement(SkeletonText, { width: "60%" })), React$1.createElement(Column, { numColumn: columnWidth[3] }, React$1.createElement(SkeletonText, { width: "60%" }))), React$1.createElement(Row, null, React$1.createElement(Column, { numColumn: columnWidth[0] }, React$1.createElement(SkeletonText, { width: "60%" })), React$1.createElement(Column, { numColumn: columnWidth[1] }, React$1.createElement(SkeletonText, { width: "80%" }), React$1.createElement(SkeletonText, { width: "30%" })), React$1.createElement(Column, { numColumn: columnWidth[2] }, React$1.createElement(SkeletonText, { width: "60%" })), React$1.createElement(Column, { numColumn: columnWidth[3] }, React$1.createElement(SkeletonText, { width: "60%" }))), React$1.createElement(Row, null, React$1.createElement(Column, { numColumn: columnWidth[0] }, React$1.createElement(SkeletonText, { width: "60%" })), React$1.createElement(Column, { numColumn: columnWidth[1] }, React$1.createElement(SkeletonText, { width: "80%" }), React$1.createElement(SkeletonText, { width: "30%" })), React$1.createElement(Column, { numColumn: columnWidth[2] }, React$1.createElement(SkeletonText, { width: "60%" })), React$1.createElement(Column, { numColumn: columnWidth[3] }, React$1.createElement(SkeletonText, { width: "60%" }))));
var Wrapper7 = newStyled.div(({ inAddonPanel, theme: theme3 }) => ({ height: inAddonPanel ? "100%" : "auto", display: "flex", border: inAddonPanel ? "none" : `1px solid ${theme3.appBorderColor}`, borderRadius: inAddonPanel ? 0 : theme3.appBorderRadius, padding: inAddonPanel ? 0 : 40, alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 15, background: theme3.background.content, boxShadow: "rgba(0, 0, 0, 0.10) 0 1px 3px 0" })), Content = newStyled.div({ display: "flex", flexDirection: "column", gap: 4, maxWidth: 415 }), Title2 = newStyled.div(({ theme: theme3 }) => ({ fontWeight: theme3.typography.weight.bold, fontSize: theme3.typography.size.s2 - 1, textAlign: "center", color: theme3.textColor })), Description2 = newStyled.div(({ theme: theme3 }) => ({ fontWeight: theme3.typography.weight.regular, fontSize: theme3.typography.size.s2 - 1, textAlign: "center", color: theme3.textMutedColor })), Links = newStyled.div(({ theme: theme3 }) => ({ display: "flex", fontSize: theme3.typography.size.s2 - 1, gap: 25 })), Divider = newStyled.div(({ theme: theme3 }) => ({ width: 1, height: 16, backgroundColor: theme3.appBorderColor })), Empty = ({ inAddonPanel }) => {
...
newStyled.div(({ theme: theme3 }) => ({ marginRight: 30, fontSize: `${theme3.typography.size.s1}px`, color: theme3.base === "light" ? curriedTransparentize$1(0.4, theme3.color.defaultText) : curriedTransparentize$1(0.6, theme3.color.defaultText) }));
...
newStyled.div(withReset, ({ theme: theme3 }) => ({ ...getBlockBackgroundStyle(theme3), margin: "25px 0 40px", padding: "30px 20px" }));
newStyled.div(({ theme: theme3 }) => ({ fontWeight: theme3.typography.weight.bold, color: theme3.color.defaultText }));
newStyled.div(({ theme: theme3 }) => ({ color: theme3.base === "light" ? curriedTransparentize$1(0.2, theme3.color.defaultText) : curriedTransparentize$1(0.6, theme3.color.defaultText) }));
newStyled.div({ flex: "0 0 30%", lineHeight: "20px", marginTop: 5 });
newStyled.div(({ theme: theme3 }) => ({ flex: 1, textAlign: "center", fontFamily: theme3.typography.fonts.mono, fontSize: theme3.typography.size.s1, lineHeight: 1, overflow: "hidden", color: theme3.base === "light" ? curriedTransparentize$1(0.4, theme3.color.defaultText) : curriedTransparentize$1(0.6, theme3.color.defaultText), "> div": { display: "inline-block", overflow: "hidden", maxWidth: "100%", textOverflow: "ellipsis" }, span: { display: "block", marginTop: 2 } }));
...
newStyled.div(({ theme: theme3 }) => ({ ...getBlockBackgroundStyle(theme3), display: "flex", flexDirection: "row", height: 50, marginBottom: 5, overflow: "hidden", backgroundColor: "white", backgroundImage: "repeating-linear-gradient(-45deg, #ccc, #ccc 1px, #fff 1px, #fff 16px)", backgroundClip: "padding-box" }));
...
newStyled.div(({ theme: theme3 }) => ({ display: "flex", flexDirection: "row", alignItems: "center", paddingBottom: 20, fontWeight: theme3.typography.weight.bold, color: theme3.base === "light" ? curriedTransparentize$1(0.4, theme3.color.defaultText) : curriedTransparentize$1(0.6, theme3.color.defaultText) }));
newStyled.div(({ theme: theme3 }) => ({ fontSize: theme3.typography.size.s2, lineHeight: "20px", display: "flex", flexDirection: "column" }));
newStyled.div(({ theme: theme3 }) => ({ fontFamily: theme3.typography.fonts.base, fontSize: theme3.typography.size.s2, color: theme3.color.defaultText, marginLeft: 10, lineHeight: 1.2 }));
newStyled.div(({ theme: theme3 }) => ({ ...getBlockBackgroundStyle(theme3), overflow: "hidden", height: 40, width: 40, display: "flex", alignItems: "center", justifyContent: "center", flex: "none", "> img, > svg": { width: 20, height: 20 } }));
...
var Wrapper9 = newStyled.div(({ theme: theme3 }) => ({ width: "10rem", "@media (max-width: 768px)": { display: "none" } })), Content2 = newStyled.div(({ theme: theme3 }) => ({ position: "fixed", bottom: 0, top: 0, width: "10rem", paddingTop: "4rem", paddingBottom: "2rem", overflowY: "auto", fontFamily: theme3.typography.fonts.base, fontSize: theme3.typography.size.s2, WebkitFontSmoothing: "antialiased", MozOsxFontSmoothing: "grayscale", WebkitTapHighlightColor: "rgba(0, 0, 0, 0)", WebkitOverflowScrolling: "touch", "& *": { boxSizing: "border-box" }, "& > .toc-wrapper > .toc-list": { paddingLeft: 0, borderLeft: `solid 2px ${theme3.color.mediumlight}`, ".toc-list": { paddingLeft: 0, borderLeft: `solid 2px ${theme3.color.mediumlight}`, ".toc-list": { paddingLeft: 0, borderLeft: `solid 2px ${theme3.color.mediumlight}` } } }, "& .toc-list-item": { position: "relative", listStyleType: "none", marginLeft: 20, paddingTop: 3, paddingBottom: 3 }, "& .toc-list-item::before": { content: '""', position: "absolute", height: "100%", top: 0, left: 0, transform: "translateX(calc(-2px - 20px))", borderLeft: `solid 2px ${theme3.color.mediumdark}`, opacity: 0, transition: "opacity 0.2s" }, "& .toc-list-item.is-active-li::before": { opacity: 1 }, "& .toc-list-item > a": { color: theme3.color.defaultText, textDecoration: "none" }, "& .toc-list-item.is-active-li > a": { fontWeight: 600, color: theme3.color.secondary, textDecoration: "none" } })), Heading = newStyled.p(({ theme: theme3 }) => ({ fontWeight: 600, fontSize: "0.875em", color: theme3.textColor, textTransform: "uppercase", marginBottom: 10 })), OptionalTitle = ({ title }) => title === null ? null : typeof title == "string" ? React$1.createElement(Heading, null, title) : title, TableOfContents = ({ title, disable, headingSelector, contentsSelector, ignoreSelector, unsafeTocbotOptions }) => (reactExports.useEffect(() => {
...
var { document: document3, window: globalWindow3 } = global$1, DocsContainer = ({ context, theme: theme3, children }) => {
  var _a, _b, _c, _d, _e2;
  let toc;
  try {
  ...
  }), React$1.createElement(DocsContext.Provider, { value: context }, React$1.createElement(SourceContainer, { channel: context.channel }, React$1.createElement(ThemeProvider, { theme: ensure(theme3) }, React$1.createElement(DocsPageWrapper, { toc: toc ? React$1.createElement(TableOfContents, { className: "sbdocs sbdocs-toc--custom", ...toc }) : null }, children))));
};
...
var StyledHeading = newStyled(Heading2)(({ theme: theme3 }) => ({ fontSize: `${theme3.typography.size.s2 - 1}px`, fontWeight: theme3.typography.weight.bold, lineHeight: "16px", letterSpacing: "0.35em", textTransform: "uppercase", color: theme3.textMutedColor, border: 0, marginBottom: "12px", "&:first-of-type": { marginTop: "56px" } })), Stories = ({ title = "Stories", includePrimary = true }) => {
