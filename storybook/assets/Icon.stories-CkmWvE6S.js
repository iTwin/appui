...
import { Ds as ConditionalIconItem, Mr as init_esm, Ts as Icon, Vi as SvgPlaceholder, er as WebFontIcon, hn as init_core_react } from "./components-react-CHXB-2a9.js";
import { o as UiError, r as init_appui_abstract } from "./Key.enum-1tPeVDEH.js";
import { _t as init_useConditionalProp, vt as useConditionalProp } from "./appui-react-B4bFXMth.js";
import { n as InitializerDecorator, r as init_Decorators, t as AppUiDecorator } from "./Decorators-DbQYdZs9.js";
import { n as init_UiComponents, t as UiComponents } from "./UiComponents-Cx7OcMTp.js";
...
//#region ../../ui/components-react/src/components-react/common/ImageRenderer.tsx
var import_jsx_runtime$1, ImageRenderer;
function init_ImageRenderer() {
	return (init_ImageRenderer = __esmMin((() => {
		require_react();
		init_core_react();
		init_UiComponents();
		init_appui_abstract();
		...
		ImageRenderer = class ImageRenderer {
			...
			renderBinary(data, format) {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("img", {
					src: `data:image/${format};base64,${dataAsBase64}`,
					alt: ""
				});
			}
			isSvg(input) {
			...
			*/
			renderWebfontIcon(iconName) {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(WebFontIcon, { ...iconInfo });
			}
...
function init_Icon_stories() {
	return (init_Icon_stories = __esmMin((() => {
		...
		DataURI = { render: () => {
			const img = new ImageRenderer().render({
				sourceType: "svg",
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: img });
		} };
		ConditionalCSSIcon = {
