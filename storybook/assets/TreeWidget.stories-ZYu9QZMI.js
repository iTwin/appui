var _a, _b, _c;
import { r as reactExports, j as jsxRuntimeExports, e } from "./iframe-DMCF11ZE.js";
import { j as BeUiEvent, d as ProgressRadial, k as PropertyRecord } from "./Key.enum-jv_2YNFv.js";
import { bC as __extends, bH as Subject, bU as dateTimestampProvider, bV as popScheduler, bW as from, bX as popNumber, bS as EMPTY, bG as innerFrom, bY as mergeAll, bK as operate, bN as createOperatorSubscriber, bP as mergeMap, bO as isFunction, bM as identity, bZ as MutableTreeModel, b_ as produce, b$ as concatAll, aN as UiError, ai as UiComponents, c0 as toRxjsObservable, c1 as map, c2 as isTreeModelNode, c3 as TreeEventHandler, c4 as hasSelectionModeFlag, c5 as SelectionModeFlags, c6 as SelectionMode, c7 as Rectangle, c8 as isNavigationKey, c9 as ItemKeyboardNavigator, ca as Orientation, cb as concat, bR as subscribeOn, cc as TreeNodeRenderer, cd as computeVisibleNodes, ce as TreeRenderer, cf as useTranslation, cg as FillCentered, I as IModelApp, U as UiFramework } from "./appui-react-Cn73l-Bp.js";
import { A as AppUiDecorator } from "./Decorators-CaBmzxJR.js";
import { s as share, S as SubscriptionScheduler, d as defer, a as scheduleSubscription, f as finalize, b as asapScheduler } from "./SubscriptionScheduler-DqQP7f7C.js";
...
class TreeModelSource {
  constructor(_model = new MutableTreeModel()) {
    this._model = _model;
    this.onModelChanged = new BeUiEvent();
  }
  /**
...
class AbstractTreeNodeLoader {
  constructor(modelSource) {
    this._loadScheduler = new SubscriptionScheduler();
...
class TreeNodeLoader extends AbstractTreeNodeLoaderWithProvider {
  ...
  loadNode(parent, _childIndex) {
    return defer(() => {
      ...
      const parentId = parentItem == null ? void 0 : parentItem.id;
...
class TreeSelectionManager {
  constructor(selectionMode, getVisibleNodes) {
    ...
    this._onKeyboardEvent = (e2, actions, isKeyDown) => {
      const processedNodeId = this._selectionHandler.processedItem;
      if (!isNavigationKey(e2.key) || !isIndividualSelection(processedNodeId)) {
        return;
      }
      ...
      const handleKeyboardSelectItem = (index) => {
        ...
        selectionFunc(e2.shiftKey, e2.ctrlKey);
      };
      ...
      isKeyDown ? itemKeyboardNavigator.handleKeyDownEvent(e2, processedNodeIndex) : itemKeyboardNavigator.handleKeyUpEvent(e2, processedNodeIndex);
    };
...
class ItemHandler {
  ...
  isSelected() {
    var _a2;
    return !!((_a2 = this._node) == null ? void 0 : _a2.isSelected);
  }
  item() {
    var _a2;
    return ((_a2 = this._node) == null ? void 0 : _a2.id) ?? "";
  }
}
...
function TreeWidgetComponent(props) {
  ...
  const [dataProvider] = e.useState(() => new SimpleTreeDataProvider(hierarchyTest));
  const modelSource = useTreeModelSource(dataProvider);
  const nodeLoader = useTreeNodeLoader(dataProvider, modelSource);
  const eventsHandler = useTreeEventsHandler(e.useMemo(() => ({
    modelSource,
    nodeLoader
