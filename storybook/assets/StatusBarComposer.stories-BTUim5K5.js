...
import { Mr as init_esm, Yo as SvgCamera, _s as Svg3D, ds as SvgAirplane, hs as SvgActivity, ls as SvgAndroid, ps as SvgAdd, rs as SvgBolt, ss as SvgAttach, ys as Svg2D } from "./components-react-CHXB-2a9.js";
import { Hn as SnapMode, Nn as init_core_frontend, Vt as StatusBarComposer, Xt as StatusBarSection, f as SelectionCountField, g as StatusBarItemUtilities, m as MessageCenterField, t as init_appui_react, u as SnapModeField } from "./appui-react-B4bFXMth.js";
...
function init_StatusBarComposer() {
	return (init_StatusBarComposer = __esmMin((() => {
		require_react();
		init_appui_react();
...
function init_StatusBarComposer_stories() {
	return (init_StatusBarComposer_stories = __esmMin((() => {
		init_Decorators();
		init_appui_react();
		init_esm();
		init_Resizer();
...
//#endregion
init_StatusBarComposer_stories();
