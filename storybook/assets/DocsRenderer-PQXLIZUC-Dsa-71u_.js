const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-BfS9xsn7.js","./iframe-DDsloJCs.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, e, r as reactExports } from "./iframe-DDsloJCs.js";
import { renderElement, unmountElement } from "./react-18-CNi8XZ8m.js";
import { H as HeadersMdx, A as AnchorMdx, C as CodeOrSourceMdx, D as Docs } from "./blocks-CQUVNWUC.js";
  ...
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        __vitePreload(async () => {
          const { MDXProvider } = await import("./index-BfS9xsn7.js");
          return { MDXProvider };
