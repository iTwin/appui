...
import { Ar as ContextSubMenu$1, Er as ContextMenuDivider, Mr as init_esm, Vi as SvgPlaceholder, Vo as SvgCaretRightSmall, _l as Icon, hn as init_core_react, vl as init_Icon, xs as ContextMenuItem$1 } from "./components-react-CHXB-2a9.js";
import { E as BadgeType$1, r as init_appui_abstract, t as require_Key_enum, w as ConditionalBooleanValue } from "./Key.enum-1tPeVDEH.js";
...
import { n as init_IconComponent, t as Icon$1 } from "./IconComponent-BoZHJngj.js";
//#endregion
//#region ../../ui/core-react/src/core-react/contextmenu/ContextMenuDirection.ts
var ContextMenuDirection;
function init_ContextMenuDirection() {
	return (init_ContextMenuDirection = __esmMin((() => {
...
function init_TildeFinder() {
	return (init_TildeFinder = __esmMin((() => {
...
function init_TechnicalPreviewBadge$1() {
	return (init_TechnicalPreviewBadge$1 = __esmMin((() => {
		require_react();
		init_Icon();
...
function init_NewBadge$1() {
	return (init_NewBadge$1 = __esmMin((() => {
		require_react();
		init_Icon();
...
function init_DeprecatedBadge$1() {
	return (init_DeprecatedBadge$1 = __esmMin((() => {
		require_react();
		init_Icon();
...
function init_ContextMenuItem() {
	return (init_ContextMenuItem = __esmMin((() => {
...
function init_ContextSubMenu() {
	return (init_ContextSubMenu = __esmMin((() => {
...
function init_ContextMenu$1() {
	return (init_ContextMenu$1 = __esmMin((() => {
			...
			static autoFlip = (dir, rect, windowWidth, windowHeight) => {
				if (rect.right > windowWidth) switch (dir) {
					...
					case ContextMenuDirection.Right:
						...
						break;
					case ContextMenuDirection.BottomRight: dir = ContextMenuDirection.BottomLeft;
				}
				if (rect.left < 0) switch (dir) {
					...
					case ContextMenuDirection.Left:
						...
						break;
					case ContextMenuDirection.BottomLeft: dir = ContextMenuDirection.BottomRight;
				}
				if (rect.bottom > windowHeight) switch (dir) {
					...
					case ContextMenuDirection.Bottom:
						...
						break;
					case ContextMenuDirection.BottomRight: dir = ContextMenuDirection.TopRight;
				}
				if (rect.top < 0) switch (dir) {
					...
					case ContextMenuDirection.Top:
						...
						break;
					case ContextMenuDirection.TopRight: dir = ContextMenuDirection.BottomRight;
				}
				return dir;
			};
			...
			static getCSSClassNameFromDirection = (direction) => {
				...
				switch (direction) {
					...
					case ContextMenuDirection.Bottom:
						...
						break;
					case ContextMenuDirection.BottomRight: className = "core-context-menu-bottom core-context-menu-right";
				}
				return className;
			};
			...
			_handleKeyUp = (event) => {
				...
				if (event.key === import_Key_enum.Key.ArrowUp.valueOf() || event.key === import_Key_enum.Key.ArrowDown.valueOf()) {
					...
					if (selectedIndex === -1) selectedIndex = 0;
						...
						if (event.key === import_Key_enum.Key.ArrowUp.valueOf()) {
							if (this.state.selectedIndex === 0) selectedIndex = this._length - 1;
							else selectedIndex--;
						}
						if (event.key === import_Key_enum.Key.ArrowDown.valueOf()) {
...
function init_ContextMenu_stories() {
	return (init_ContextMenu_stories = __esmMin((() => {
		init_core_react();
		init_ContextMenu$1();
		init_Decorators();
		init_esm();
