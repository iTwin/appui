...
import { e as SyncUiEventDispatcher, P as PreviewFeaturesProvider, aT as ToolbarComposer, j as ToolbarOrientation, k as ToolbarUsage, G as BadgeType, g as ConditionalIconItem, ax as ConditionalStringValue, aU as ConditionalBooleanValue, aV as SvgAdd, aW as SvgRemove, aX as ToolbarHelper, z as CommandItemDef, aY as ToolItemDef, aZ as IconHelper, T as ToolbarItemUtilities } from "./DefaultToolSettingsProvider-B6B80iEN.js";
...
import { A as AppUiDecorator, I as InitializerDecorator } from "./Decorators-CU-vvLY2.js";
import { w as withResizer } from "./Resizer-oL6qocnZ.js";
import { c as createBumpEvent } from "./createBumpEvent-DDjjL4e5.js";
...
function useConditionalValue(getValue, eventIds) {
  ...
  reactExports.useEffect(() => {
    return SyncUiEventDispatcher.onSyncUiEvent.addListener((args) => {
      if (!eventIdsRef.current.some((id) => args.eventIds.has(id)))
        return;
...
function createItems() {
  ...
  const custom1 = ToolbarItemUtilities.createCustomItem("custom1", 100, "", "Custom 1", /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
