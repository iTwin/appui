...
import { Z as Icon, aF as MessageRenderer, J as Text, M as MessageManager, ax as useTranslation, aG as StatusBarPopover, aH as TitleBar, aI as Tabs, aD as Icon$1, O as OutputMessagePriority } from "./DefaultToolSettingsProvider-BeaL6ll4.js";
import { f as Box, g as cx, B as Button } from "./Key.enum-Nky5yUvk.js";
    ...
    { visible: isOpen, onVisibleChange: (visible) => handleOpenChange(visible), className: "uifw-statusFields-messageCenter-messageCenterField_popover", content: reactExports.createElement(
      ...
      reactExports.createElement(
        ...
        tabs.map((tab) => {
          ...
          tabMessages = tab === "errors" ? tabMessages.filter(isProblemStatus) : tabMessages;
          return reactExports.createElement(Tabs.Panel, { value: tab, key: tab, className: "uifw-statusFields-messageCenter-messageCenterField_panel" }, tabMessages.length === 0 ? reactExports.createElement("span", { className: "uifw-message-prompt" }, translate("messageCenter.prompt")) : tabMessages.map((message, index) => {
            ...
            return reactExports.createElement(MessageCenterMessage, { key: index, message: message.briefMessage, details: message.detailedMessage, icon: reactExports.createElement(Icon$1, { iconSpec, className: iconClassName }) });
          }));
        })
      )
    ) },
