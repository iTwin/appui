...
import { Mr as init_esm, Vt as init_internal, pr as usePackageTranslation, qi as SvgPause, zi as SvgPlay } from "./components-react-CHXB-2a9.js";
import { a as init_UiIModelComponents$1, i as UiIModelComponents } from "./Decorators-DbQYdZs9.js";
...
function init_PlayButton() {
	return (init_PlayButton = __esmMin((() => {
		require_react();
		init_esm();
		init_IconButton();
		init_useTranslation();
