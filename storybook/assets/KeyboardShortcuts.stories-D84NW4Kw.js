...
import { Mr as init_esm, Uc as Input, Us as BadgeType, Vi as SvgPlaceholder, Wc as init_Input, hn as init_core_react } from "./components-react-CHXB-2a9.js";
import { n as Page, r as init_AppUiStory, t as AppUiStory } from "./AppUiStory-DVMw3I-C.js";
import { bn as CommandItemDef, lt as UiFramework, t as init_appui_react, zt as StagePanelState } from "./appui-react-B4bFXMth.js";
...
function init_KeyboardShortcuts() {
	return (init_KeyboardShortcuts = __esmMin((() => {
...
function init_KeyboardShortcuts_stories() {
	return (init_KeyboardShortcuts_stories = __esmMin((() => {
		init_appui_react();
		init_Decorators();
		init_AppUiStory();
...
//#endregion
init_KeyboardShortcuts_stories();
