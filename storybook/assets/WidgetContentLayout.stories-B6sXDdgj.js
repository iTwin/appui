...
function init_WidgetContentLayout() {
	return (init_WidgetContentLayout = __esmMin((() => {
		init_appui_react();
		init_AppUiStory();
		init_Utils();
...
function init_WidgetContentLayout_stories() {
	return (init_WidgetContentLayout_stories = __esmMin((() => {
		init_Decorators();
...
//#endregion
init_WidgetContentLayout_stories();
