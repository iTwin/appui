...
import { g as init_IconButton, h as IconButton, jt as require_classnames } from "./SvgCloseSmall-D4ZjyCAN.js";
import { $c as DropdownMenu, Gc as Slider, Kc as init_Slider, Mr as init_esm, Sc as init_MenuItem, Uc as Input, Wc as init_Input, el as init_DropdownMenu, jo as SvgCheckmark, ln as toDateString, sa as SvgMoreVertical, t as init_components_react, un as toTimeString, xc as MenuItem } from "./components-react-CHXB-2a9.js";
import { J as UiAdmin, r as init_appui_abstract, t as require_Key_enum } from "./Key.enum-1tPeVDEH.js";
import { Gr as init_MenuDivider, Wr as MenuDivider } from "./appui-react-B4bFXMth.js";
...
function init_InlineEdit$1() {
	return (init_InlineEdit$1 = __esmMin((() => {
			...
			_onKeyDown = (event) => {
				switch (event.key) {
					case import_Key_enum.Key.Escape.valueOf():
						...
						break;
					case import_Key_enum.Key.Enter.valueOf(): this._sendChange(this.state.value);
				}
			};
			_onChange = (event) => {
...
function init_interfaces() {
	return (init_interfaces = __esmMin((() => {
...
function init_Scrubber$1() {
	return (init_Scrubber$1 = __esmMin((() => {
		...
		return UiAdmin.onGenericUiEvent.addListener((args) => {
			...
			switch (timelineArgs.timelineAction) {
				...
				case TimelinePausePlayAction.Pause:
					pause();
					break;
				case TimelinePausePlayAction.Toggle: if (isPlaying) pause();
				else playOrReplay();
			}
		});
	}, [
		...
		menuItems: (close) => {
			return [...includeRepeat ? [/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(MenuItem, {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(MenuItem, {
					startIcon: checked ? /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(SvgCheckmark, {}) : /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(import_jsx_runtime$1.Fragment, {}),
					onClick: () => {
...
function init_TimelineComponent$1() {
	return (init_TimelineComponent$1 = __esmMin((() => {
		import_react = /* @__PURE__ */ __toESM(require_react(), 1);
		init_appui_abstract();
		init_components_react();
		init_esm();
		init_DropdownMenu(), init_IconButton(), init_MenuDivider(), init_MenuItem();
		init_InlineEdit$1();
		init_interfaces();
		init_PlayButton();
		init_Scrubber$1();
...
function init_Timeline_stories() {
	return (init_Timeline_stories = __esmMin((() => {
