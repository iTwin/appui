...
import { r as reactExports, e, j as jsxRuntimeExports, w as withResizer } from "./iframe-N2fj7JLS.js";
import "./Key.enum-B1r-IJYZ.js";
import { U as UiFramework, b1 as ToolbarComposer, y as ToolbarUsage, z as ToolbarOrientation, a0 as BadgeType, aL as ConditionalStringValue, b2 as ConditionalBooleanValue, aE as ConditionalIconItem, b3 as ToolbarHelper, x as ToolbarItemUtilities, b4 as SvgAdd, $ as CommandItemDef, b5 as ToolItemDef, S as SvgPlaceholder, b6 as useConditionalValue, b7 as SvgRemove, b8 as IconHelper } from "./appui-react-BMIkHgLG.js";
import { S as Svg2D } from "./2D--r3sAkL7.js";
import { S as Svg3D } from "./3D-BZeLEfOn.js";
import { S as SvgActivity } from "./Activity-C-cMP8AA.js";
import { S as SvgAirplane } from "./Airplane-CHhsfmS_.js";
import { S as SvgAndroid } from "./Android-Bz_K1JEn.js";
import { S as SvgClipboard } from "./Clipboard-DiKSlZw0.js";
import { A as AppUiDecorator, I as InitializerDecorator } from "./Decorators-CZorn3ec.js";
import { c as createBumpEvent } from "./createBumpEvent-MUQPOktQ.js";
...
ActiveItems.parameters = {
  ...ActiveItems.parameters,
  docs: {
    ...(_K = ActiveItems.parameters) == null ? void 0 : _K.docs,
    source: {
      originalSource: '{\n  args: {\n    activeToolId: "item3",\n    items: (() => {\n      const factory = createItemFactory();\n      return [factory.createActionItem(), factory.createGroupItem({\n        items: [factory.createActionItem(), factory.createGroupItem({\n          items: [factory.createActionItem(), factory.createGroupItem({\n            items: [factory.createActionItem()]\n          })]\n        }), factory.createActionItem()]\n      }), factory.createActionItem()];\n    })()\n  }\n}',
      ...(_M = (_L = ActiveItems.parameters) == null ? void 0 : _L.docs) == null ? void 0 : _M.source
    }
  }
};
const __namedExportsOrder = ["Empty", "ActionItem", "GroupItem", "CustomItem", "Badge", "Disabled", "Hidden", "Conditional", "ItemDef", "Icons", "GroupIcons", "Separators", "ActiveItems"];
export {
  ActionItem,
  ActiveItems,
  Badge,
