...
import { As as purify, ks as init_purify_es } from "./components-react-CHXB-2a9.js";
import { S as ConditionalStringValue, r as init_appui_abstract } from "./Key.enum-1tPeVDEH.js";
//#endregion
//#region ../../ui/core-react/src/core-react/icons/ConditionalIconItem.tsx
var ConditionalIconItem;
function init_ConditionalIconItem() {
	return (init_ConditionalIconItem = __esmMin((() => {
...
function Icon(props) {
	...
	if (typeof iconSpecValue === "string") {
		...
		if (iconString.startsWith("data:") || iconString.endsWith(".svg") || webComponentString) {
			...
			const webComponentNode = /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { dangerouslySetInnerHTML: { __html: sanitizedIconString } });
...
function init_IconComponent$1() {
	return (init_IconComponent$1 = __esmMin((() => {
		require_react();
...
//#endregion
export { init_ConditionalIconItem as i, init_IconComponent$1 as n, ConditionalIconItem as r, Icon as t };
