...
import { an as SyncUiEventDispatcher, t as init_appui_react } from "./appui-react-B4bFXMth.js";
...
function init_createBumpEvent() {
	return (init_createBumpEvent = __esmMin((() => {
		init_appui_react();
	})))();
}
//#endregion
