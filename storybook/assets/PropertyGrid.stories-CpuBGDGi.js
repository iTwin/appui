...
import { bR as libExports, L as Logger, bS as T, bT as UiCore, ac as getObjectClassName, a6 as usePackageTranslation, bU as LinkifyIt, bV as Highlighter, b4 as Rectangle, bW as isPromiseLike, bk as from, ba as mergeMap, bb as observeOn, bc as subscribeOn, j as PropertyValueFormat, k as StandardTypeNames, bX as AlternateDateFormats, bY as TimeDisplay, c as classnames, I as Input, bZ as TimeFormat, b_ as Id64, K as Key_enum, aR as Icon, b$ as SvgChevronLeft, c0 as SvgChevronRight, c1 as Popup, c2 as RelativePosition, Y as Text, c3 as PropertyEditorParamTypes, c4 as IconInput, c5 as Checkbox, c6 as StandardEditorNames, aI as UiAdmin, c7 as MessageSeverity, c8 as SvgChevronDown, c9 as Div, B as Button, aL as SvgCheckmark, ca as SvgRemove, cb as svgPlaceholder, N as Select, cc as ImageCheckBox, cd as NumberInput, a1 as Slider, ce as Textarea, cf as ToggleSwitch, aq as Orientation, cg as ElementSeparator, bw as PropertyRecord, ch as UnderlinedButton, ci as BentleyError, cj as BentleyStatus, ck as assert, cl as ResizableContainerObserver, aD as SvgSearch, aE as SvgClose, aK as MenuItem, cm as ComboBox, G as Flex, O as IconButton, cn as SvgAdd, co as SvgDelete, m as SvgStatusError, cp as Guid, bo as fn, cq as Anchor, aU as BeEvent, bp as UiError, cr as L, cs as UiGeometry, E as ExpandableBlock, ct as areEqual, cu as VariableSizeList, bq as ProgressRadial, cv as useTargeted, aZ as useWidgetOpacityContext, cw as getToolbarBackgroundColor, cx as getToolbarBoxShadow, cy as getToolbarBackdropFilter, cz as TOOLBAR_BOX_SHADOW_OPACITY_DEFAULT, cA as TOOLBAR_BACKDROP_FILTER_BLUR_DEFAULT, cB as calculateToolbarOpacity, cC as calculateBoxShadowOpacity, cD as calculateBackdropFilterBlur, cE as useResizeObserver, cF as useRefState, cG as TOOLBAR_OPACITY_DEFAULT, cH as ToolbarItemUtilities, aS as BadgeUtilities, az as IconHelper, v as ConditionalStringValue, ak as ConditionalBooleanValue, cI as Point, cJ as Timer, ai as ConditionalIconItem, cK as SvgPlaceholder, bd as BeUiEvent, be as isNavigationKey, bf as ItemKeyboardNavigator, bD as Observable, bh as map, bi as concatAll, bj as concat, bl as mergeAll, cL as WebFontIcon, cM as TreeNodePlaceholder, cN as TreeNode, cO as Tree, cP as timer, bv as FillCentered } from "./DefaultToolSettingsProvider-Do4qbEAN.js";
...
import { S as Subject, t as tap, q as queueScheduler, a as asapScheduler, o as onErrorResumeNextWith, d as defer, c as connectable, i as iif, E as EMPTY, f as finalize, k as share, s as shareReplay, m as merge, b as of, e as distinctUntilChanged, g as filter, h as concatMap, j as toArray } from "./tap-DUlI38cL.js";
...
let UiComponents$1 = (_a = class {
  ...
  static async initialize(localization) {
    if (_a._initialized) {
      Logger.logInfo(
        _a.loggerCategory(_a),
        `UiComponents.initialize already called`
      );
      return;
    }
    T();
    _a._localization = localization;
    await _a._localization.registerNamespace(
      _a.localizationNamespace
    );
    await UiCore.initialize(_a._localization);
    _a._initialized = true;
  }
  /** Unregisters the UiComponents localization namespace */
  static terminate() {
    if (_a._localization)
      _a._localization.unregisterNamespace(
        _a.localizationNamespace
      );
    _a._localization = void 0;
    UiCore.terminate();
    _a._initialized = false;
  }
  /** Determines if UiComponents has been initialized */
  static get initialized() {
    return _a._initialized;
  }
  ...
  static translate(key) {
    if (!_a._localization) {
      Logger.logError(
        _a.loggerCategory(this),
        `translate: UiComponents.initialize has not been called. Returning blank string.`
      );
      return "";
    }
    return _a._localization.getLocalizedString(
      `${_a.localizationNamespace}:${key}`
    );
  }
  /** @internal */
  static loggerCategory(obj) {
    const className = getObjectClassName(obj);
    const category = _a.packageName + (className ? `.${className}` : "");
    return category;
  }
}, _a._initialized = false, _a);
const general = {
  "true": "true",
  "false": "false",
  loading: "loading",
...
Basic.parameters = {
  ...Basic.parameters,
  docs: {
    ...(_b = Basic.parameters) == null ? void 0 : _b.docs,
    source: {
      originalSource: '{\n  args: {\n    dataProvider: {\n      getData: async () => ({\n        label: PropertyRecord.fromString("Record 1"),\n        categories: [{\n          name: "Group_1",\n          label: "Group 1",\n          expand: true\n        }, {\n          name: "Group_2",\n          label: "Group 2",\n          expand: false\n        }],\n        records: {\n          Group_1: [PropertyRecord.fromString("Record 1_1"), PropertyRecord.fromString("Record 1_2")],\n          Group_2: [PropertyRecord.fromString("Record 2_1"), PropertyRecord.fromString("Record 2_2")]\n        }\n      }),\n      onDataChanged: new PropertyDataChangeEvent()\n    },\n    height: 400\n  }\n}',
      ...(_d = (_c = Basic.parameters) == null ? void 0 : _c.docs) == null ? void 0 : _d.source
    }
  }
};
StructRendering.parameters = {
  ...StructRendering.parameters,
  docs: {
    ...(_e = StructRendering.parameters) == null ? void 0 : _e.docs,
    source: {
      originalSource: '{\n  args: {\n    orientation: Orientation.Vertical,\n    propertyValueRendererManager: rendererManager,\n    dataProvider: {\n      getData: async () => ({\n        label: PropertyRecord.fromString("Record 1"),\n        categories: [{\n          name: "structPropertyRendering",\n          label: "Struct property rendering",\n          expand: true\n        }],\n        records: {\n          structPropertyRendering: [new PropertyRecord({\n            valueFormat: PropertyValueFormat.Primitive,\n            value: "string value"\n          }, {\n            name: "simpleProperty",\n            displayLabel: "Simple property",\n            typename: "string"\n          }), new PropertyRecord({\n            valueFormat: PropertyValueFormat.Primitive,\n            value: multilineString\n          }, {\n            name: "multilineProperty",\n            displayLabel: "Multiline property",\n            typename: "string",\n            renderer: {\n              name: "multiline"\n            }\n          }), new PropertyRecord({\n            valueFormat: PropertyValueFormat.Primitive,\n            value: undefined\n          }, {\n            name: "noValueStruct",\n            displayLabel: "Struct property with no value",\n            typename: "struct"\n          }), new PropertyRecord({\n            valueFormat: PropertyValueFormat.Struct,\n            members: structMembers\n          }, {\n            name: "noRendererStructProperty",\n            displayLabel: "Struct property (no renderer)",\n            typename: "struct"\n          }), new PropertyRecord({\n            valueFormat: PropertyValueFormat.Struct,\n            members: structMembers\n          }, {\n            name: "defaultRendererStructProperty",\n            displayLabel: "Struct property (default renderer)",\n            typename: "struct",\n            renderer: {\n              name: "defaultRendererPropertyRenderer"\n            }\n          }), new PropertyRecord({\n            valueFormat: PropertyValueFormat.Struct,\n            members: structMembers\n          }, {\n            name: "customRendererStructProperty",\n            displayLabel: "Struct property (custom renderer)",\n            typename: "struct",\n            renderer: {\n              name: "customRendererStructPropertyRenderer"\n            }\n          })]\n        }\n      }),\n      onDataChanged: new PropertyDataChangeEvent()\n    },\n    height: 400\n  }\n}',
      ...(_g = (_f = StructRendering.parameters) == null ? void 0 : _f.docs) == null ? void 0 : _g.source
    }
  }
};
ArrayRendering.parameters = {
  ...ArrayRendering.parameters,
  docs: {
    ...(_h = ArrayRendering.parameters) == null ? void 0 : _h.docs,
    source: {
      originalSource: '{\n  args: {\n    orientation: Orientation.Horizontal,\n    propertyValueRendererManager: rendererManager,\n    dataProvider: {\n      getData: async () => ({\n        label: PropertyRecord.fromString("Record 1"),\n        categories: [{\n          name: "arrayPropertyRendering",\n          label: "Array property rendering",\n          expand: true\n        }],\n        records: {\n          arrayPropertyRendering: [new PropertyRecord({\n            valueFormat: PropertyValueFormat.Primitive,\n            value: "string value"\n          }, {\n            name: "simpleProperty",\n            displayLabel: "Simple property",\n            typename: "string"\n          }), new PropertyRecord({\n            valueFormat: PropertyValueFormat.Primitive,\n            value: multilineString\n          }, {\n            name: "multilineProperty",\n            displayLabel: "Multiline property",\n            typename: "string",\n            renderer: {\n              name: "multiline"\n            }\n          }), new PropertyRecord({\n            valueFormat: PropertyValueFormat.Array,\n            items: [],\n            itemsTypeName: "array"\n          }, {\n            name: "emptyArray",\n            displayLabel: "Array property with no items",\n            typename: "array"\n          }), new PropertyRecord({\n            valueFormat: PropertyValueFormat.Array,\n            items: arrayMembers,\n            itemsTypeName: "array"\n          }, {\n            name: "noRendererStructProperty",\n            displayLabel: "Array property (no renderer)",\n            typename: "array"\n          }), new PropertyRecord({\n            valueFormat: PropertyValueFormat.Array,\n            items: arrayMembers,\n            itemsTypeName: "array"\n          }, {\n            name: "defaultRendererArrayProperty",\n            displayLabel: "Array property (default renderer)",\n            typename: "array",\n            renderer: {\n              name: "defaultRendererPropertyRenderer"\n            }\n          }), new PropertyRecord({\n            valueFormat: PropertyValueFormat.Array,\n            items: arrayMembers,\n            itemsTypeName: "array"\n          }, {\n            name: "customRendererArrayPropertyRenderer",\n            displayLabel: "Array property (custom renderer)",\n            typename: "struct",\n            renderer: {\n              name: "customRendererArrayPropertyRenderer"\n            }\n          })]\n        }\n      }),\n      onDataChanged: new PropertyDataChangeEvent()\n    },\n    height: 400\n  }\n}',
      ...(_j = (_i = ArrayRendering.parameters) == null ? void 0 : _i.docs) == null ? void 0 : _j.source
    }
  }
};
