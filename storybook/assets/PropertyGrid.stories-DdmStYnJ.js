...
import { A as init_ButtonGroup, g as init_IconButton, h as IconButton, jt as require_classnames, k as ButtonGroup } from "./SvgCloseSmall-D4ZjyCAN.js";
import { H as PropertyDataChangeEvent, I as VirtualizedPropertyGridWithDataProvider, Mr as init_esm, Q as PropertyValueRendererManager, Vt as init_internal, an as LinkifyIt, cr as Orientation$1, gt as PropertyEditorManager, hi as SvgSelection, hn as init_core_react, ho as SvgCopy, ht as PropertyEditorBase, nl as init_Anchor, nn as init_from, on as init_linkify_it, pr as usePackageTranslation, rn as Orientation$2, t as init_components_react, tl as Anchor, tn as from } from "./components-react-CHXB-2a9.js";
import { I as PropertyValueFormat, P as PropertyRecord, R as StandardTypeNames, Ut as BentleyError, Wt as BentleyStatus, X as init_core_bentley, cn as init_Button, r as init_appui_abstract, sn as Button } from "./Key.enum-1tPeVDEH.js";
import { r as init_Decorators, t as AppUiDecorator } from "./Decorators-DbQYdZs9.js";
import { n as init_UiComponents$1, t as UiComponents } from "./UiComponents-Cx7OcMTp.js";
...
var import_react$6;
function init_UseAsyncValue() {
	return (init_UseAsyncValue = __esmMin((() => {
...
var linkify, matchLinks;
function init_Links() {
	return (init_Links = __esmMin((() => {
		init_linkify_it();
...
function init_Orientation() {
	return (init_Orientation = __esmMin((() => {
		init_core_react();
...
function init_PropertyGridCommons() {
	return (init_PropertyGridCommons = __esmMin((() => {
		init_Links();
		init_Orientation();
...
function useTagHref(text) {
	...
	if (match.index !== 0 || match.lastIndex !== text.length) return void 0;
	if (!allowedSchemas.includes(match.schema)) return void 0;
	const url = match.url;
	if (match.schema === "pw:" && url.startsWith("pw:")) return url.replace(/pw:\/\/|pw:\\\\/g, "pw:");
	return url;
}
function Tag(props) {
	...
	if (!href) return /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)(import_jsx_runtime$4.Fragment, { children: highlighted });
	return /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)(Anchor, {
		href,
		target: "_blank",
		rel: "noreferrer",
		onClick: (e) => {
...
function renderText(text, links, highlight) {
	const { matcher } = links;
	if (!matcher) return /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)(Tag, {
		text,
		links,
		highlight
	});
	...
	for (const match of matches) {
		...
		parts.push(/* @__PURE__ */ (0, import_jsx_runtime$4.jsx)(Tag, {
			text: anchorText,
			links,
			highlight
		}));
...
var import_react$5, import_jsx_runtime$4, allowedSchemas, renderLinks, withLinks;
function init_LinkHandler() {
	return (init_LinkHandler = __esmMin((() => {
...
var TypeConverter;
function init_TypeConverter() {
	return (init_TypeConverter = __esmMin((() => {
		init_appui_abstract();
		TypeConverter = class {
...
function init_StringTypeConverter() {
	return (init_StringTypeConverter = __esmMin((() => {
		init_TypeConverter();
...
function init_TypeConverterManager() {
	return (init_TypeConverterManager = __esmMin((() => {
...
function useRenderedStringValue(record, stringValueCalculator, context, linksHandler) {
	const stringValue = useAsyncValue(import_react$4.useMemo(() => stringValueCalculator(record), [record, stringValueCalculator]));
	return {
		stringValue,
...
var import_react$4, import_jsx_runtime$3, DEFAULT_LINKS_HANDLER;
function init_PrimitivePropertyValueRenderer() {
	return (init_PrimitivePropertyValueRenderer = __esmMin((() => {
...
function init_UiComponents() {
	return (init_UiComponents = __esmMin((() => {
		general = {
			"true": "True",
			"false": "False",
			"loading": "loading",
...
//#endregion
//#region ../../ui/components-react/src/components-react/properties/renderers/value/MultilineTextPropertyValueRenderer.tsx
var import_react$2, import_classnames, import_jsx_runtime$2, MultilineTextPropertyValueRenderer, MultilineTextPropertyValueRendererImpl, MultilineTextRenderer;
function init_MultilineTextPropertyValueRenderer() {
	return (init_MultilineTextPropertyValueRenderer = __esmMin((() => {
		require_react();
...
function init_PropertyGrid() {
	return (init_PropertyGrid = __esmMin((() => {
		init_components_react();
		import_react = require_react();
...
function ArrayEditor({ propertyRecord, onCommit }) {
	const arrayValue = propertyRecord?.value;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
		...
		onClick: () => {
			...
			onCommit?.({
				...
				newValue: {
					...arrayValue,
					items: [...arrayValue.items, PropertyRecord.fromString(`Value ${itemCount}`, `Item ${itemCount}`)]
				}
			});
		},
		children: `Add item (${arrayValue?.items.length ?? 0})`
	});
}
...
var import_jsx_runtime, action, multilineString, PaddingDecorator, createStructRecord, createArrayRecord, rendererManager, customArrayEditorTypeName, meta, Basic, ComplexProperties, SimpleCategorization, StructRendering, ArrayRendering, NestedCategories, Links, PropertyActions, Editable, MergedProperties, AlwaysVisibleEditor, ArrayPropertyEditor, __namedExportsOrder;
function init_PropertyGrid_stories() {
	return (init_PropertyGrid_stories = __esmMin((() => {
		init_appui_abstract();
		init_components_react();
		init_MultilineTextPropertyValueRenderer();
		init_Decorators();
		init_PropertyGrid();
		init_Button(), init_ButtonGroup(), init_IconButton();
		init_esm();
		...
		customArrayEditorTypeName = "customEditorArray";
		meta = {
		...
		Links = { args: {
			data: {
				...
				records: { Group_1: [
					...
					PropertyRecord.fromString("https://itwinui.bentley.com,https://stratakit.bentley.com"),
		...
		Editable = { args: {
			...
			onPropertyUpdated: async ({ propertyRecord, newValue }) => {
				action("onPropertyUpdated")(`Property "${propertyRecord.property.name}" updated to: ${newValue.valueFormat === PropertyValueFormat.Array ? `${newValue.items.length} items` : newValue.value}`);
				return true;
			},
			data: {
				label: PropertyRecord.fromString("Record 1"),
		...
		rendererManager.registerRenderer("customRendererStructPropertyRenderer", {
			...
			render: (record) => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: entries.map((entry) => {
		...
		ArrayPropertyEditor = class extends PropertyEditorBase {
			get reactNode() {
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrayEditor, {});
			}
		};
		try {
			PropertyEditorManager.registerEditor(customArrayEditorTypeName, ArrayPropertyEditor);
		} catch {}
		Basic.parameters = {
			...Basic.parameters,
			docs: {
		...
		Links.parameters = {
			...
			docs: {
				...
				source: {
					originalSource: "{\n  args: {\n    data: {\n      label: PropertyRecord.fromString(\"Record 1\"),\n      categories: [{\n        name: \"Group_1\",\n        label: \"Group 1\",\n        expand: true\n      }],\n      records: {\n        Group_1: [PropertyRecord.fromString(\"https://www.bentley.com\"), PropertyRecord.fromString(\"www.bentley.com\"), PropertyRecord.fromString(\"pw://test\"), PropertyRecord.fromString(\"https://itwinui.bentley.com,https://stratakit.bentley.com\"), PropertyRecord.fromString(\"mailto:test@test.com\"), PropertyRecord.fromString(\"test@test.com\"), createPropertyRecord({\n          valueFormat: PropertyValueFormat.Primitive,\n          value: \"https://itwinui.bentley.com\"\n        }, {\n          name: \"urlProperty\",\n          displayLabel: \"URL Property\",\n          typename: StandardTypeNames.URL\n        })]\n      }\n    },\n    onPropertyContextMenu: undefined\n  }\n}",
		...
		Editable.parameters = {
			...
			docs: {
				...
				source: {
					originalSource: "{\n  args: {\n    isPropertyEditingEnabled: true,\n    onPropertyUpdated: async ({\n      propertyRecord,\n      newValue\n    }) => {\n      action(\"onPropertyUpdated\")(`Property \"${propertyRecord.property.name}\" updated to: ${newValue.valueFormat === PropertyValueFormat.Array ? `${newValue.items.length} items` : (newValue as PrimitiveValue).value}`);\n      return true;\n    },\n    data: {\n      label: PropertyRecord.fromString(\"Record 1\"),\n      categories: [{\n        name: \"Editable\",\n        label: \"Editable\",\n        expand: true\n      }, {\n        name: \"Readonly\",\n        label: \"Readonly\",\n        expand: true\n      }, {\n        name: \"Disabled\",\n        label: \"Disabled\",\n        expand: true\n      }, {\n        name: \"Arrays\",\n        label: \"Arrays\",\n        expand: true\n      }],\n      records: {\n        Editable: createPropertyRecords(\"editable_\"),\n        Readonly: createPropertyRecords(\"readonly_\", {\n          isReadonly: true\n        }),\n        Disabled: createPropertyRecords(\"disabled_\", {\n          isDisabled: true\n        }),\n        Arrays: createArrayPropertyRecords()\n      }\n    }\n  }\n}",
