const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Color-AVL7NMMY-BbOaAGV6.js","./iframe-C8gxtGVZ.js"])))=>i.map(i=>d[i]);
import { r as reactExports, e, j as jsxRuntimeExports, R as ReactDOM, s as Ve$2, k as reactDomExports, t as ha$1, _ as __vitePreload, v as Tn$2 } from "./iframe-C8gxtGVZ.js";
...
var LazyColorControl = reactExports.lazy(() => __vitePreload(() => import("./Color-AVL7NMMY-BbOaAGV6.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url)), ColorControl = (props) => e.createElement(reactExports.Suspense, { fallback: e.createElement("div", null) }, e.createElement(LazyColorControl, { ...props }));
