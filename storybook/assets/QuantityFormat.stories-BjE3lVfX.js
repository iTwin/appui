...
var _a, _b, _c;
import { cG as useTranslation, am as Select, cH as parseFormatType, cI as FormatType, _ as Input, Q as Icon, cJ as formatTypeToString, cK as FractionalPrecision, cL as DecimalPrecision, cM as scientificTypeToString, cN as ScientificType, cO as Format, cP as getTraitString, cQ as FormatTraits, aB as Checkbox, cR as ShowSignOption, cS as showSignOptionToString, cT as parseShowSignOption, cU as parseScientificType, cV as FormatterSpec, I as IModelApp, cW as getQuantityTypeKey, cX as isCustomQuantityTypeDefinition, L as useTranslation$1, U as UiFramework, cY as useSaveBeforeActivatingNewSettingsTab, cZ as useSaveBeforeClosingSettingsContainer, c_ as Listbox, c$ as ListboxItem, d0 as QuantityType } from "./appui-react-BMIkHgLG.js";
import { K as Key_enumExports, B as Button, c as Dialog$1 } from "./Key.enum-B1r-IJYZ.js";
import { A as AppUiDecorator, I as InitializerDecorator } from "./Decorators-CZorn3ec.js";
import { e as enumArgType } from "./Utils-SDm-TzWl.js";
import { r as reactExports, c as classnames, j as jsxRuntimeExports } from "./iframe-N2fj7JLS.js";
...
function FormatUnitLabel(props) {
  ...
  return reactExports.createElement(
    ...
    reactExports.createElement("span", { className: classnames("uicore-label", !isFormatTraitSet(FormatTraits.ShowUnitLabel) && "uicore-disabled") }, translate("QuantityFormat.labels.labelSeparator")),
...
function ThousandsSeparator(props) {
  ...
  return reactExports.createElement(
    ...
    reactExports.createElement("span", { className: classnames("uicore-label", !isFormatTraitSet(FormatTraits.Use1000Separator) && "uicore-disabled") }, translate("QuantityFormat.labels.thousandSeparatorLabel")),
...
function MiscFormatOptions(props) {
  ...
  return reactExports.createElement(
    ...
    (!enableMinimumProperties || showOptions) && reactExports.createElement(
      ...
      reactExports.createElement("span", { className: classnames("uicore-label", formatType !== FormatType.Station && "uicore-disabled") }, translate("QuantityFormat.labels.stationOffsetLabel")),
      ...
      reactExports.createElement("span", { className: classnames("uicore-label", formatType !== FormatType.Station && "uicore-disabled") }, translate("QuantityFormat.labels.stationSeparatorLabel")),
      ...
      reactExports.createElement("span", { className: classnames("uicore-label", formatType === FormatType.Fractional && "uicore-disabled") }, translate("QuantityFormat.labels.decimalSeparatorLabel")),
      ...
      reactExports.createElement("span", { className: classnames("uicore-label", formatType === FormatType.Fractional && "uicore-disabled") }, translate("QuantityFormat.labels.keepDecimalPointLabel")),
      ...
      reactExports.createElement("span", { className: classnames("uicore-label", formatType !== FormatType.Fractional && "uicore-disabled") }, translate("QuantityFormat.labels.fractionDashLabel")),
      ...
      reactExports.createElement("span", { className: classnames("uicore-label", formatType !== FormatType.Scientific && "uicore-disabled") }, translate("QuantityFormat.labels.scientificTypeLabel")),
