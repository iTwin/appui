...
import { b2 as hasSelectionModeFlag, b3 as SelectionModeFlags, b4 as Rectangle, b5 as SelectionMode, b6 as operate, b7 as innerFrom, b8 as createOperatorSubscriber, b9 as noop, ba as mergeMap, bb as observeOn, bc as subscribeOn, bd as BeUiEvent, be as isNavigationKey, bf as ItemKeyboardNavigator, aq as Orientation, bg as isTreeModelNode, bh as map, bi as concatAll, bj as concat, bk as from, bl as mergeAll, bm as toRxjsObservable, bn as MutableTreeModel, bo as fn, bp as UiError, A as UiComponents, bq as ProgressRadial, br as TreeNodeRenderer, bs as computeVisibleNodes, bt as TreeRenderer, bu as useTranslation, bv as FillCentered, i as IModelApp, U as UiFramework, bw as PropertyRecord } from "./DefaultToolSettingsProvider-Do4qbEAN.js";
import "./index-Cm_5MPU1.js";
import { S as Subject, d as defer, c as connectable, f as finalize, t as tap, a as asapScheduler, o as onErrorResumeNextWith, i as iif, q as queueScheduler, E as EMPTY, s as shareReplay, m as merge, b as of, e as distinctUntilChanged, g as filter, h as concatMap, j as toArray, k as share } from "./tap-DUlI38cL.js";
...
class TreeEventDispatcher {
  ...
  collectNodesBetween(nodeId1, nodeId2) {
    ...
    const loadedSelectedNodes = from(nodesToLoad.map((node) => {
      ...
      return parentNode ? toRxjsObservable(this._nodeLoader.loadNode(parentNode, node.childIndex)) : (
        /* istanbul ignore next */
        EMPTY
      );
    })).pipe(
...
class TreeModelSource {
  ...
  modifyModel(callback) {
    ...
    const newModel = fn(this._model, (draft) => callback(draft), (patches) => {
...
const Basic = {
  ...
  render: (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(TreeWidgetComponent, {
    ...props
  })
};
...
function TreeWidgetComponent(props) {
  ...
  if (!initialized)
    return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ControlledTree, {
    ...defaultProps
  });
}
Basic.parameters = {
