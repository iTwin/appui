const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-D6p6y-vV.js","./iframe-JYBMU7ZD.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, e, r as reactExports } from "./iframe-JYBMU7ZD.js";
import { renderElement, unmountElement } from "./react-18-DvYm7oz9.js";
import { H as HeadersMdx, A as AnchorMdx, C as CodeOrSourceMdx, D as Docs } from "./blocks-RORET1q_.js";
  ...
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        __vitePreload(async () => {
          const { MDXProvider } = await import("./index-D6p6y-vV.js");
          return { MDXProvider };
