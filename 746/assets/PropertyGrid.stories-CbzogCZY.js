...
import { bW as libExports, a9 as Logger, bX as T, bY as UiCore, aT as UiError, aa as getObjectClassName, bZ as LinkifyIt, b_ as Highlighter, ba as Rectangle, b$ as isPromiseLike, bq as from, bg as mergeMap, bh as observeOn, bi as subscribeOn, m as PropertyValueFormat, n as StandardTypeNames, c0 as AlternateDateFormats, c1 as TimeDisplay, c as classnames, d as Input, c2 as TimeFormat, c3 as Id64, K as Key_enum, aD as Icon, c4 as SvgChevronLeft, c5 as SvgChevronRight, c6 as Popup, c7 as RelativePosition, Y as Text, c8 as PropertyEditorParamTypes, c9 as IconInput, ca as Checkbox, cb as StandardEditorNames, aN as UiAdmin, cc as MessageSeverity, cd as SvgChevronDown, ce as Div, B as Button, aQ as SvgCheckmark, cf as SvgRemove, cg as svgPlaceholder, Q as Select, ch as ImageCheckBox, ci as NumberInput, a1 as Slider, cj as Textarea, ck as ToggleSwitch, ao as Orientation, cl as ElementSeparator, bB as PropertyRecord, cm as UnderlinedButton, cn as BentleyError, co as BentleyStatus, cp as assert, cq as ResizableContainerObserver, cr as SvgSearch, cs as SvgClose, aP as MenuItem, ct as ComboBox, L as Flex, I as IconButton, cu as SvgAdd, cv as SvgDelete, p as SvgStatusError, cw as Guid, bu as fn, cx as Anchor, a_ as BeEvent, cy as L, cz as UiGeometry, E as ExpandableBlock, cA as areEqual, cB as VariableSizeList, bv as ProgressRadial, cC as useTargeted, b3 as useWidgetOpacityContext, cD as getToolbarBackgroundColor, cE as getToolbarBoxShadow, cF as getToolbarBackdropFilter, cG as TOOLBAR_BOX_SHADOW_OPACITY_DEFAULT, cH as TOOLBAR_BACKDROP_FILTER_BLUR_DEFAULT, cI as calculateToolbarOpacity, cJ as calculateBoxShadowOpacity, cK as calculateBackdropFilterBlur, cL as useResizeObserver, cM as useRefState, cN as TOOLBAR_OPACITY_DEFAULT, cO as ToolbarItemUtilities, aY as BadgeUtilities, aG as IconHelper, y as ConditionalStringValue, ai as ConditionalBooleanValue, cP as Point, cQ as Timer, ag as ConditionalIconItem, cR as SvgPlaceholder, bj as BeUiEvent, bk as isNavigationKey, bl as ItemKeyboardNavigator, bI as Observable, bn as map, bo as concatAll, bp as concat, br as mergeAll, cS as WebFontIcon, cT as TreeNodePlaceholder, cU as TreeNode, cV as Tree, cW as timer, bz as FillCentered } from "./DefaultToolSettingsProvider-BMCl5D3j.js";
import { r as reactExports, R as React } from "./index-DlkhCVTf.js";
import "./index-Cm_5MPU1.js";
import { g as getDefaultExportFromCjs } from "./_commonjsHelpers-LQfde5yM.js";
import { S as Subject, t as tap, q as queueScheduler, a as asapScheduler, o as onErrorResumeNextWith, d as defer, c as connectable, i as iif, E as EMPTY, f as finalize, k as share, s as shareReplay, m as merge, b as of, e as distinctUntilChanged, g as filter, h as concatMap, j as toArray } from "./tap-BxS24wgy.js";
...
const _UiComponents = class _UiComponents {
  ...
  static async initialize(localization) {
    if (_UiComponents._initialized) {
      Logger.logInfo(
        _UiComponents.loggerCategory(_UiComponents),
  ...
  static translate(key) {
    ...
    return _UiComponents.localization.getLocalizedString(
  ...
  static loggerCategory(obj) {
    ...
    const category = _UiComponents.packageName + (className ? `.${className}` : "");
    return category;
  }
};
_UiComponents._initialized = false;
...
const _BooleanTypeConverter = class _BooleanTypeConverter extends TypeConverter {
  ...
  static getLocalizedTrueFalse() {
    if (!_BooleanTypeConverter.sl10nTrue)
      _BooleanTypeConverter.sl10nTrue = UiComponents.translate("general.true");
    if (!_BooleanTypeConverter.sl10nFalse)
      _BooleanTypeConverter.sl10nFalse = UiComponents.translate("general.false");
  }
  convertToString(value) {
    if (value === void 0)
      return "";
  ...
  const handleCalendarKeyDown = reactExports.useCallback(
    (event) => {
      if (event.key === Key_enum.Key.ArrowDown.valueOf()) {
        const focusedDayIndex = days.findIndex(
...
function TimeField({
  ...
  const { translate } = useTranslation();
  const initialDateRef = reactExports.useRef(time);
  const amLabel = translate("timepicker.day-period-am");
  const pmLabel = translate("timepicker.day-period-pm");
  const [timeSpec, setTimeSpec] = reactExports.useState(time);
...
const _PropertyEditorManager = class _PropertyEditorManager {
  static registerEditor(editType, editor, editorName) {
    ...
    _PropertyEditorManager._editors[fullEditorName] = editor;
  }
  ...
  static createEditor(editType, editorName, dataControllerName) {
    ...
    let editor;
    if (_PropertyEditorManager._editors.hasOwnProperty(fullEditorName))
      editor = new _PropertyEditorManager._editors[fullEditorName]();
    else if (_PropertyEditorManager._editors.hasOwnProperty(editType))
      editor = new _PropertyEditorManager._editors[editType]();
    else
    ...
    if (dataControllerName) {
      if (_PropertyEditorManager._dataControllers.hasOwnProperty(
        ...
        editor.customDataController = new _PropertyEditorManager._dataControllers[dataControllerName]();
      else
        throw Error(
  ...
  constructor() {
    ...
    this._onKeyPress = (e) => {
      if (e.key === Key_enum.Key.Escape.valueOf()) {
        const initialDisplayValue = (this._lastValidValue && this._lastValidValue.displayValue) ?? /* istanbul ignore next */
      ...
      if (!parseResults.parseError && void 0 !== parseResults.value) {
        ...
        if (this.htmlElement) {
          UiAdmin.messagePresenter.displayInputFieldMessage(
            ...
            parseResults.parseError ? parseResults.parseError : (
              /* istanbul ignore next */
        ...
        const displayValue = record.value.displayValue && record.value.displayValue.length > 0 ? record.value.displayValue : (
          /* istanbul ignore next */
  ...
  _getInitialDisplayValue() {
    ...
    if (record) {
      if (record.value.valueFormat === PropertyValueFormat.Primitive) {
        ...
        numberValue = void 0 !== primitiveValue.value ? primitiveValue.value : (
          /* istanbul ignore next */
          0
        );
...
class EditorContainer extends reactExports.PureComponent {
  constructor() {
    super(...arguments);
    this._handleEditorBlur = (_e2) => {
  ...
  createEditor() {
    ...
    const editorProps = {
      ...
      propertyRecord: this.props.propertyRecord,
      setFocus: this.props.setFocus !== void 0 ? this.props.setFocus : true,
    ...
    let clonedNode = null;
    if (reactExports.isValidElement(editorNode)) {
      clonedNode = reactExports.cloneElement(editorNode, editorProps);
    }
    return clonedNode;
  }
  onPressEscape(_e2) {
...
class EnumButtonGroupEditor extends reactExports.Component {
  ...
  getButton(choice, index) {
    const choiceValue = this.state.choices ? this.state.choices[index].value : (
      /* istanbul ignore next */
      0
    );
...
class EnumEditor extends reactExports.PureComponent {
  ...
  render() {
    ...
    const selectValue = this.state.selectValue !== void 0 ? this.state.selectValue.toString() : (
      /* istanbul ignore next */
      void 0
    );
    const minWidthStyle = {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "icon", children: [
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { iconSpec: /* @__PURE__ */ jsxRuntimeExports.jsx(SvgChevronDown, {}) }),
              " "
            ] })
          ]
        }
  ...
  async setStateFromProps() {
    ...
    if (record && record.property && record.property.editor && record.property.editor.params) {
      ...
      if (sliderParams) {
        ...
        minLabel = !sliderParams.showMinMax ? "" : sliderParams.minIconSpec ? /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { iconSpec: sliderParams.minIconSpec }) : void 0;
        maxLabel = !sliderParams.showMinMax ? "" : sliderParams.maxIconSpec ? /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { iconSpec: sliderParams.maxIconSpec }) : void 0;
...
class PropertyLabelRenderer extends reactExports.PureComponent {
  ...
  render() {
    const title = this.props.tooltip ?? (typeof this.props.children == "string" ? this.props.children : (
      /* istanbul ignore next */
      void 0
    ));
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "components-property-label-renderer", title, children: this.props.children }),
      this.props.renderColon ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "components-property-label-renderer-colon", children: ":" }) : void 0
    ] });
  }
}
try {
  PropertyLabelRenderer.displayName = "PropertyLabelRenderer";
  PropertyLabelRenderer.__docgenInfo = { "description": "", "displayName": "PropertyLabelRenderer", "props": { "children": { "defaultValue": null, "description": "Label to be rendered", "name": "children", "required": false, "type": { "name": "(string | ReactElement<any, string | JSXElementConstructor<any>>) & ReactNode" } }, "renderColon": { "defaultValue": null, "description": "Indicates whether to render a colon after the label", "name": "renderColon", "required": false, "type": { "name": "boolean" } }, "tooltip": { "defaultValue": null, "description": "Custom tooltip for the component.", "name": "tooltip", "required": false, "type": { "name": "string" } } } };
} catch (__react_docgen_typescript_loader_error) {
}
...
class PropertyGridColumnStyleProvider {
  ...
  getHorizontalStyle(needActionButtons, ratio, needElementSeparator) {
    const separatorColumn = needElementSeparator ? "1px" : void 0;
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          needElementSeparator ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            ElementSeparator,
            {
...
try {
  convertPrimitiveRecordToString.displayName = "convertPrimitiveRecordToString";
  convertPrimitiveRecordToString.__docgenInfo = { "description": "Function that converts primitive [[PropertyRecord]] to string", "displayName": "convertPrimitiveRecordToString", "props": { "value": { "defaultValue": null, "description": "Value for the property", "name": "value", "required": true, "type": { "name": "PropertyValue" } }, "property": { "defaultValue": null, "description": "The property description containing metadata for the property", "name": "property", "required": true, "type": { "name": "PropertyDescription" } }, "description": { "defaultValue": null, "description": "Description for the property", "name": "description", "required": false, "type": { "name": "string" } }, "isReadonly": { "defaultValue": null, "description": "Indicates if the property is read-only", "name": "isReadonly", "required": false, "type": { "name": "boolean" } }, "isDisabled": { "defaultValue": null, "description": "Indicates if the property is disabled", "name": "isDisabled", "required": false, "type": { "name": "boolean" } }, "isMerged": { "defaultValue": null, "description": "Indicates if the property record represents merged properties", "name": "isMerged", "required": false, "type": { "name": "boolean" } }, "autoExpand": { "defaultValue": null, "description": "Indicates if the property should be automatically expanded", "name": "autoExpand", "required": false, "type": { "name": "boolean" } }, "extendedData": { "defaultValue": null, "description": "Map containing any additional data", "name": "extendedData", "required": false, "type": { "name": "{ [key: string]: any; }" } }, "links": { "defaultValue": null, "description": "Properties for link logic", "name": "links", "required": false, "type": { "name": "LinkElementsInfo" } }, "copyWithNewValue": { "defaultValue": null, "description": "Creates a copy of this PropertyRecord with a new value and optionally a new PropertyDescription", "name": "copyWithNewValue", "required": true, "type": { "name": "(newValue: PropertyValue, newDescription?: PropertyDescription | undefined) => PropertyRecord" } }, "getChildrenRecords": { "defaultValue": null, "description": "Gets this property record value children records", "name": "getChildrenRecords", "required": true, "type": { "name": "() => PropertyRecord[]" } } } };
} catch (__react_docgen_typescript_loader_error) {
}
try {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { marginLeft: "5px", marginRight: "5px" }, children: UiComponents.translate("general.of") }),
              ...
              status === 0 ? (
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    ...
                    title: searchLabel,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { iconSpec: /* @__PURE__ */ jsxRuntimeExports.jsx(SvgSearch, {}) }),
                      " "
                    ]
                  }
                )
              ...
              status === 1 ? (
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { iconSpec: /* @__PURE__ */ jsxRuntimeExports.jsx(SvgClose, {}) }),
                      " "
                    ]
                  }
                )
...
function getPropertyFilterBuilderOperators(property) {
...
function PropertyFilterBuilderRuleProperty(props) {
  ...
  reactExports.useEffect(() => {
    const currentSelectedProperty = properties.find(
      (property) => property.name === (selectedProperty == null ? void 0 : selectedProperty.name)
    );
...
function PropertyFilterBuilderRuleRenderer(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fb-component-row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { className: "fb-row-container", gap: "s", alignItems: "flex-start", children: [
    ...
    property !== void 0 ? operatorRenderer(property) : null,
    property !== void 0 && operator !== void 0 && !isUnaryPropertyFilterBuilderOperator(operator) ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fb-property-value", children: [
    ...
    function getPropertyHeight(state) {
      ...
      if (dynamicHeight !== void 0) {
        if (node instanceof MutableCustomGridCategory) {
          return CATEGORY_HEADER_HEIGHT + (node.isExpanded ? dynamicHeight + bottomBorderPadding : 0);
        }
...
try {
  ...
  GroupToolExpander.__docgenInfo = { "description": "Expandable entry of tool group panel. Used in [[GroupColumn]] to select nested Groups.", "displayName": "GroupToolExpander", "props": { "isDisabled": { "defaultValue": null, "description": "Describes if the item is disabled.", "name": "isDisabled", "required": false, "type": { "name": "boolean" } }, "style": { "defaultValue": null, "description": "Custom CSS style properties", "name": "style", "required": false, "type": { "name": "CSSProperties" } }, "itemId": { "defaultValue": null, "description": "Optional unique identifier for item. If defined it will be added to DOM Element attribute as data-item-id", "name": "itemId", "required": false, "type": { "name": "string" } }, "className": { "defaultValue": null, "description": "Custom CSS class name", "name": "className", "required": false, "type": { "name": "string" } }, "onKeyDown": { "defaultValue": null, "description": "Optional function to call on any KeyDown events processed by toolbar", "name": "onKeyDown", "required": false, "type": { "name": "((e: KeyboardEvent<Element>) => void)" } }, "onClick": { "defaultValue": null, "description": "Function called when the item is clicked.", "name": "onClick", "required": false, "type": { "name": "((item: GroupButton | ActionButton) => void)" } }, "onPointerUp": { "defaultValue": null, "description": "Function called when pointer up event is received.", "name": "onPointerUp", "required": false, "type": { "name": "((item: GroupButton | ActionButton) => void)" } }, "label": { "defaultValue": null, "description": "Tool label.", "name": "label", "required": false, "type": { "name": "string" } }, "icon": { "defaultValue": null, "description": "Tool icon.", "name": "icon", "required": false, "type": { "name": "ReactNode" } }, "badge": { "defaultValue": null, "description": "A badge to draw.", "name": "badge", "required": false, "type": { "name": "ReactNode" } }, "isFocused": { "defaultValue": null, "description": "Describes if the item is focused.", "name": "isFocused", "required": false, "type": { "name": "boolean" } }, "item": { "defaultValue": null, "description": "GroupButton item", "name": "item", "required": true, "type": { "name": "GroupButton | ActionButton" } } } };
} catch (__react_docgen_typescript_loader_error) {
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ToolbarPopupContext.Provider,
    {
      value: {
        ...
        setSelectedItem: (
          /* istanbul ignore next */
          (buttonItem) => setActiveAction(buttonItem)
        )
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              props.badge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "components-badge", children: badge }),
...
function refreshItems(items, eventIds) {
  ...
  for (const item of items) {
    ...
    for (const [, entry] of Object.entries(updatedItem)) {
      if (entry instanceof ConditionalBooleanValue && ConditionalBooleanValue.refreshValue(entry, eventIds) || entry instanceof ConditionalStringValue && ConditionalStringValue.refreshValue(entry, eventIds) || ConditionalIconItem.isConditionalIconItem(entry) && ConditionalIconItem.refreshValue(entry, eventIds)) {
        itemsUpdated = true;
      }
    }
...
function CustomItem({
  ...
  const icon = reactExports.useMemo(
    () => item.icon && IconHelper.getIconReactNode(item.icon, item.internalData) || // istanbul ignore next
...
function ToolbarItemComponent({
  ...
  if (ToolbarItemUtilities.isGroupButton(item)) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(GroupPopupItem, { item, addGroupSeparator });
  } else if (isCustomToolbarItem(item)) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(CustomItem, { item, addGroupSeparator });
  } else {
    if (ToolbarItemUtilities.isActionButton(item)) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(ActionItem, { item, addGroupSeparator });
    }
  }
  return null;
}
...
try {
  ...
  ToolbarItemComponent.__docgenInfo = { "description": "", "displayName": "ToolbarItemComponent", "props": { "item": { "defaultValue": null, "description": "", "name": "item", "required": true, "type": { "name": "ToolbarItem" } }, "addGroupSeparator": { "defaultValue": null, "description": "", "name": "addGroupSeparator", "required": true, "type": { "name": "boolean" } } } };
} catch (__react_docgen_typescript_loader_error) {
}
try {
...
class TreeSelectionManager {
  ...
  getVisibleNodeAtIndex(nodes, index) {
    const foundNode = nodes !== void 0 ? nodes.getAtIndex(index) : (
      /* istanbul ignore next */
      void 0
    );
...
try {
  ...
  ImageRenderer.__docgenInfo = { "description": "A class that renders images from data provided by an image loader", "displayName": "ImageRenderer", "props": {} };
} catch (__react_docgen_typescript_loader_error) {
}
...
function TreeNodeContent(props) {
  ...
  if (props.node.editingInfo) {
    ...
    editor = props.nodeEditorRenderer ? props.nodeEditorRenderer(editorProps) : /* @__PURE__ */ jsxRuntimeExports.jsx(TreeNodeEditor, { ...editorProps });
  }
...
function getLabel(node, highlightProps) {
  ...
  const context = {
    ...
    textHighlighter: highlightCallback,
    defaultValue: /* @__PURE__ */ jsxRuntimeExports.jsx(TreeNodePlaceholder, { level: 0, "data-testid": "node-label-placeholder" })
  };
...
function Loader(props) {
  ...
  if (props.noData) {
    return props.noDataRenderer ? props.noDataRenderer() : /* @__PURE__ */ jsxRuntimeExports.jsx(FillCentered, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "components-controlledTree-errorMessage", children: translate("general.noData") }) });
  }
...
const __namedExportsOrder = ["Basic", "StructRendering", "ArrayRendering"];
export {
  ArrayRendering,
  Basic,
  StructRendering,
