...
function action(name, options = {}) {
  let actionOptions = { ...config, ...options }, handler = function(...args) {
    var _a, _b;
    if (options.implicit) {
      let storyRenderer = (_a = "__STORYBOOK_PREVIEW__" in global$1 ? global$1.__STORYBOOK_PREVIEW__ : void 0) == null ? void 0 : _a.storyRenders.find((render) => render.phase === "playing" || render.phase === "rendering");
      if (storyRenderer) {
...
var subscribed = false, logActionsWhenMockCalled = (context) => {
  ...
  if (!(actions2 == null ? void 0 : actions2.disable) && !subscribed && "__STORYBOOK_TEST_ON_MOCK_CALL__" in global && typeof global.__STORYBOOK_TEST_ON_MOCK_CALL__ == "function") {
