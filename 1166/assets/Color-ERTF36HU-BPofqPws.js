import { ak as Tr, a2 as bI, a0 as LI, x as xB, al as MarkupIcon, am as getControlId } from "./index-BNstr0aO.js";
import { g as getDefaultExportFromCjs, R as React, r as reactExports } from "./index-R26Bfrts.js";
import { d as debounce } from "./debounce-CTTNlY27.js";
...
var Wrapper = Tr.div({ position: "relative", maxWidth: 250, '&[aria-readonly="true"]': { opacity: 0.5 } }), PickerTooltip = Tr(bI)({ position: "absolute", zIndex: 1, top: 4, left: 4, "[aria-readonly=true] &": { cursor: "not-allowed" } }), TooltipContent = Tr.div({ width: 200, margin: 5, ".react-colorful__saturation": { borderRadius: "4px 4px 0 0" }, ".react-colorful__hue": { boxShadow: "inset 0 0 0 1px rgb(0 0 0 / 5%)" }, ".react-colorful__last-control": { borderRadius: "0 0 4px 4px" } }), Note = Tr(LI)(({ theme }) => ({ fontFamily: theme.typography.fonts.base })), Swatches = Tr.div({ display: "grid", gridTemplateColumns: "repeat(9, 16px)", gap: 6, padding: 3, marginTop: 5, width: 200 }), SwatchColor = Tr.div(({ theme, active }) => ({ width: 16, height: 16, boxShadow: active ? `${theme.appBorderColor} 0 0 0 1px inset, ${theme.textMutedColor}50 0 0 0 4px` : `${theme.appBorderColor} 0 0 0 1px inset`, borderRadius: theme.appBorderRadius })), swatchBackground = `url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity=".05"><path d="M8 0h8v8H8zM0 8h8v8H0z"/></svg>')`, Swatch = ({ value, style, ...props }) => {
  ...
  var _a;
  let debouncedOnChange = reactExports.useCallback(debounce(onChange, 200), [onChange]), { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(initialValue, debouncedOnChange), { presets, addPreset } = usePresets(presetColors, color, colorSpace), Picker = ColorPicker[colorSpace], readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly);
