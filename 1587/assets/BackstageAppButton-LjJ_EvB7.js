...
import { z as useTranslation, U as UiFramework, A as StrataKitIcon, E as Surface } from "./appui-react-BtU_mNFj.js";
import { r as reactExports, I as IconButton } from "./iframe-CpRh-TYa.js";
import { j as Icon } from "./components-react-Dj8XcCyt.js";
const SvgHome = (props) => {
...
const svgHome = async () => __vitePreload(() => import("./home-BGjS0lum.js"), true ? [] : void 0, import.meta.url);
function BackstageAppButton({
  ...
  const icon = iconNode ?? iconSpecElement ?? reactExports.createElement(StrataKitIcon, { href: svgHome, iconNode: reactExports.createElement(SvgHome, null) });
  return reactExports.createElement(
    Surface,
