...
import { r as reactExports, B as Box, c as classnames } from "./iframe-CpRh-TYa.js";
import { ax as MessageRenderer, M as MessageManager, z as useTranslation, O as OutputMessagePriority, ay as StatusBarPopover, az as TitleBar, aA as Tabs, A as StrataKitIcon, r as SvgInfo } from "./appui-react-BtU_mNFj.js";
import { T as Text, w as Icon, J as SvgStatusWarning, N as SvgStatusError, K as SvgStatusSuccess } from "./components-react-Dj8XcCyt.js";
...
const svgChat = async () => __vitePreload(() => import("./chat-BMCsKh0l.js"), true ? [] : void 0, import.meta.url);
const svgInfo = async () => __vitePreload(() => import("./info-BEODhDDd.js"), true ? [] : void 0, import.meta.url);
const svgStatusError = async () => __vitePreload(() => import("./status-error-BCl3AV0e.js"), true ? [] : void 0, import.meta.url);
const svgStatusSuccess = async () => __vitePreload(() => import("./status-success-CfNw0-Sf.js"), true ? [] : void 0, import.meta.url);
const svgStatusWarning = async () => __vitePreload(() => import("./status-warning-C4ssXn0U.js"), true ? [] : void 0, import.meta.url);
  ...
  return reactExports.createElement(
    ...
    reactExports.createElement(
      ...
      { ref: indicatorRef, styleType: "borderless", startIcon: reactExports.createElement(
        ...
        reactExports.createElement(StrataKitIcon, { href: svgChat, iconNode: reactExports.createElement(SvgChat, null) })
  ...
  switch (priority) {
    ...
    case OutputMessagePriority.Fatal:
      return reactExports.createElement(
        Icon,
        { fill: "negative" },
        reactExports.createElement(StrataKitIcon, { href: svgStatusError, iconNode: reactExports.createElement(SvgStatusError, null) })
      );
    case OutputMessagePriority.Warning:
      return reactExports.createElement(
        Icon,
        { fill: "warning" },
        reactExports.createElement(StrataKitIcon, { href: svgStatusWarning, iconNode: reactExports.createElement(SvgStatusWarning, null) })
      );
    case OutputMessagePriority.Info:
      return reactExports.createElement(
        Icon,
        { fill: "informational" },
        reactExports.createElement(StrataKitIcon, { href: svgInfo, iconNode: reactExports.createElement(SvgInfo, null) })
      );
  }
  return reactExports.createElement(
    Icon,
    { fill: "positive" },
    reactExports.createElement(StrataKitIcon, { href: svgStatusSuccess, iconNode: reactExports.createElement(SvgStatusSuccess, null) })
  );
}
export {
