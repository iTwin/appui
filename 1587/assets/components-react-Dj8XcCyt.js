import { r as reactExports, C as useResizeObserver, A as useMergedRefs, e as reactDomExports, R as React, B as Box, c as classnames, ax as StatusIconMap, I as IconButton, y as polymorphic, D as getWindow, V as VisuallyHidden, x as getBoundedValue, S as Svg, ay as useFloatingTree, az as useFloatingNodeId, aA as useFloatingParentNodeId, aB as useControlledState, aC as usePopover, aD as useInteractions, aE as useListNavigation, M as useSyncExternalStore, z as mergeEventHandlers, aF as cloneElementWithRef, aG as mergeRefs, G as Portal, N as PopoverOpenContext, aH as FloatingNode, aI as FloatingTree, O as ButtonBase, g as Tooltip, aJ as FloatingDelayGroup, aK as defaultTooltipDelay, aL as SvgCloseSmall, aM as OverflowContainer, aN as useSafeContext, L as useLatestRef, E as useIsomorphicLayoutEffect$1, F as ShadowRoot, aO as useId, aP as PopoverInitialFocusContext, aQ as isReact17or18, aR as CompositeItem, aS as Composite, aT as useFutureFlag, T as ThemeProvider, n as commonjsGlobal, o as getDefaultExportFromCjs, q as requireReact, P as Popover, K as ButtonGroup } from "./iframe-CpRh-TYa.js";
import { o as useFocusableElements, e as ProgressRadial, u as useEventListener, m as BentleyError, n as BentleyStatus, g as BeUiEvent, L as Logger, k as BadgeType$1, K as Key_enumExports, R as RelativePosition, G as Guid, f as PropertyValueFormat, A as AlternateDateFormats, T as TimeDisplay, p as Id64, S as StandardTypeNames, B as Button, c as PropertyEditorParamTypes, d as StandardEditorNames, M as MessageSeverity, l as PropertyRecord, h as assert, q as lowerBound } from "./Key.enum-DCghlnp9.js";
...
function NumericEditor$1({ metadata, value, onChange, size: size2, disabled, id }) {
  ...
  }, onFocus: handleFocus, size: size2, disabled });
}
function getNumericValue(value, isMerged) {
  return value ? value : { rawValue: void 0, displayValue: isMerged ? MERGED_VALUE : "" };
}
function TextEditor$1({ metadata, value, onChange, size: size2, disabled, id }) {
  ...
  const displayValue = value ? value.value : metadata.isMerged ? MERGED_VALUE : "";
  const handleChange = (e) => {
  ...
  return reactExports.createElement(Input$1, { id, value: displayValue, onChange: handleChange, onFocus: handleFocus, maxLength, minLength, size: size2, disabled });
}
...
function FallbackEditor({ value, size: size2, id, metadata }) {
  const textValue = getTextValue(value);
  const displayValue = textValue !== void 0 ? textValue : metadata.isMerged ? MERGED_VALUE : "";
  return reactExports.createElement(Input$1, { id, readOnly: true, value: displayValue, size: size2 });
}
    ...
    switch (propertyRecord.property.typename) {
      ...
      case "string":
        return {
          ...
          value: primitiveValue.value === void 0 && primitiveValue.displayValue === void 0 ? void 0 : {
            value: primitiveValue.value ?? primitiveValue.displayValue ?? ""
          }
        };
      case "dateTime":
      case "shortdate":
        return {
          ...
          value: primitiveValue.value !== void 0 ? {
      ...
      case "number":
        return {
          ...
          value: primitiveValue.value === void 0 && primitiveValue.displayValue === void 0 ? void 0 : {
            ...
            displayValue: primitiveValue.displayValue ?? `${primitiveValue.value ?? ""}`,
...
class TextEditor extends reactExports.PureComponent {
  ...
  async setStateFromProps() {
    ...
    if (this._isMounted)
      this.setState({
        inputValue: record?.isMerged && !this.hasFocus ? MERGED_VALUE : initialValue,
...
class MergedPropertyValueRenderer {
  ...
  render(record, context) {
    ...
    const text2 = displayValue?.startsWith(MERGED_VALUE) ? displayValue : MERGED_VALUE;
...
function useEditorKey({ propertyRecord }) {
  const [internalKey, setInternalKey] = reactExports.useState(1);
  const onCancel = () => {
    setInternalKey((prev) => prev + 1);
  };
  const key = reactExports.useMemo(() => {
    const serializedValue = propertyRecord.value.valueFormat === PropertyValueFormat.Primitive ? JSON.stringify(propertyRecord.value.value) : "";
...
export {
  ...
  ListItem as a6,
  Badge as a7,
  isPropertyRecordEditorMetadata as a8,
  Tag as a9,
  identity as aA,
  createOperatorSubscriber as aB,
  isFunction as aC,
  mergeMap as aD,
  observeOn as aE,
  subscribeOn as aF,
  dateTimestampProvider as aG,
  popScheduler as aH,
  from as aI,
  popNumber as aJ,
  mergeAll as aK,
  toRxjsObservable as aL,
  MutableTreeModel as aM,
  produce as aN,
  concatAll as aO,
  map as aP,
  isTreeModelNode as aQ,
  hasSelectionModeFlag as aR,
  SelectionModeFlags as aS,
  SelectionMode as aT,
  Rectangle as aU,
  concat as aV,
  TreeNodeRenderer as aW,
  computeVisibleNodes as aX,
  TreeRenderer as aY,
  useTranslation as aZ,
  Listbox as a_,
  PropertyEditorBase as aa,
  PropertyEditorManager as ab,
  toDateString as ac,
  toTimeString as ad,
  UiAdmin as ae,
  SvgCheckmark as af,
  SvgCaretRightSmall as ag,
  ContextSubMenu as ah,
  ContextMenuItem as ai,
  createErrorClass as aj,
  __extends as ak,
  EMPTY_SUBSCRIPTION as al,
  Subscription as am,
  arrRemove as an,
  Observable as ao,
  errorContext as ap,
  ...
  __read as as,
  AsyncAction as at,
  AsyncScheduler as au,
  innerFrom as av,
  OperatorSubscriber as aw,
  noop as ax,
  operate as ay,
  SafeSubscriber as az,
  StatusMessage as b,
  PopupContext as b$,
  MutableCategorizedProperty as b0,
  FlatGridItemType as b1,
  MutableCategorizedPrimitiveProperty as b2,
  MutableCustomGridCategory as b3,
  MutableGridCategory as b4,
  DRAFTABLE as b5,
  VirtualizedPropertyGrid as b6,
  LinkifyIt as b7,
  Orientation$1 as b8,
  UnderlinedButton as b9,
  UiStateStorageStatus as bA,
  useRefs as bB,
  Popup as bC,
  MERGED_VALUE as bD,
  applyNumericConstraints as bE,
  convertRecordToString as bF,
  PrimitivePropertyValueRendererImpl as bG,
  castDraft as bH,
  SearchBox as bI,
  SvgChevronLeft as bJ,
  SvgChevronRight as bK,
  GroupTool as bL,
  require_MapCache as bM,
  require_Symbol as bN,
  require_Uint8Array as bO,
  requireEq as bP,
  require_getAllKeys as bQ,
  require_Stack as bR,
  require_getTag as bS,
  requireIsBuffer as bT,
  requireIsTypedArray as bU,
  requireIsArray as bV,
  requireIsObjectLike as bW,
  _inheritsLoose as bX,
  _objectWithoutPropertiesLoose as bY,
  _extends as bZ,
  HorizontalAlignment as b_,
  PropertyValueRendererManager as ba,
  EditorContainer as bb,
  PropertyRecordEditor as bc,
  SvgCaretDownSmall$1 as bd,
  useColorPickerContext as be,
  ColorValue as bf,
  useContainerWidth as bg,
  InputFlexContainer as bh,
  InputFlexContainerButton as bi,
  InputFlexContainerIcon as bj,
  compareNumbers as bk,
  compareStrings$1 as bl,
  compareBooleans as bm,
  compareArrays as bn,
  comparePossiblyUndefined as bo,
  compareStringsOrUndefined as bp,
  compareBooleansOrUndefined as bq,
  compareNumbersOrUndefined as br,
  GenericUiEvent as bs,
  _setPrototypeOf as bt,
  _assertThisInitialized as bu,
  compareWithTolerance as bv,
  compareSimpleArrays as bw,
  compareSimpleTypes as bx,
  Div as by,
  ContextMenu as bz,
  createEditorSpec as c,
  InputWithDecorations as c0,
  isBoolean as c1,
  CustomNumberEditorSpec as c2,
  CustomNumberEditor$1 as c3,
  requireDebounce as c4,
  ToolbarPopupAutoHideContext as c5,
  MenuExtraContent as c6,
  useWidgetOpacityContext as c7,
  Direction as c8,
  ToolbarPanelAlignment as c9,
  DivWithOutsideClick as ca,
  FocusTrap as cb,
  ToolbarOpacitySetting as cc,
  focusIntoContainer as cd,
  IconInput as ce,
  WidgetOpacityContext as cf,
  PopupItem as cg,
  SvgChevronDown as ch,
  CustomNumberEditor as ci,
  CustomNumberPropertyEditor$1 as cj,
  TextEditor as ck,
  BasicPropertyEditor as cl,
  NumericInputEditor as cm,
  NumericInputPropertyEditor$1 as cn,
  registerDefaultPropertyEditor as co,
  isText as d,
  Slider as e,
  Textarea as f,
  ToggleSwitch as g,
