...
import { Ai as require_classnames, Bn as Divider, Dn as ITwinError, I as PropertyValueFormat, Jn as Table, P as PropertyRecord, Qn as ProgressLinear, Qr as DropdownMenu, R as StandardTypeNames, V as PropertyEditorParamTypes, X as init_core_bentley, br as Dialog, c as ToolbarItemUtilities, cr as MenuItem, ei as Button, er as Flex, hn as BeEvent, m as StandardEditorNames, mi as ThemeProvider, oi as Text, or as Select, r as init_appui_abstract, t as require_Key_enum, ui as IconButton, xn as Logger, zn as init_esm$3 } from "./Key.enum-C3db3aye.js";
import { n as init_react_redux, t as Provider_default } from "./react-redux-CPjRpfaw.js";
import { $ as AppNotificationManager, A as Icon, Ba as SvgDownload, Bs as Range3d, Cn as UiItemsManager, Cs as SnapshotIModelRpcInterface, Ds as IModelReadRpcInterface, Et as FloatingViewportContent, Fs as ColorByName, Ha as SvgDetails, Ia as SvgFeedback, Ji as SvgUpload, Jt as ThemeManager, Ka as SvgCopy, Ki as SvgWindowAdd, Ks as init_DemoIModel, Ls as init_core_geometry, M as init_appui_react, N as FrameworkToolAdmin, Nr as EditorContainer, Ns as ColorDef, Ot as ContentControl, Pt as FrameworkAccuDraw, Qn as ToolUtilities, Qo as ToolAssistanceImage, Rn as CursorInformation, Ro as init_core_frontend, Rt as UiFramework, S as init_download, St as StandardContentLayouts, Ts as IModelTileRpcInterface, Uo as CheckpointConnection, Vo as AngleDescription, Wi as SvgWindowPopout, Xt as ConfigurableUiContent, Yn as PreviewFeaturesProvider, Yo as IModelApp, Zn as init_imodel_components_react, Zo as ToolAssistance, Zr as init_internal$1, _ as init_panorama, _s as OutputMessagePriority, a as init_window_popout, as as QuantityType, at as BackstageAppButton, b as init_feedback, bn as ContentGroup, bs as init_core_common, bt as DefaultViewOverlay, c as window_add_default, d as init_search, en as useActiveIModelConnection, er as ViewportComponent, es as LengthDescription, f as search_default, fn as StageUsage, fs as BlankConnection, g as placeholder_default, gs as NotifyMessageDetails, h as init_placeholder, i as init_useStrataKit, ir as ViewportComponentEvents, jr as PropertyRecordEditor, js as Cartographic, k as init_dist, l as init_upload, ls as EventHandled, lt as ViewToolWidgetComposer, m as refresh_default, ma as SvgRefresh, n as init_ThemeBridge, na as SvgSearch, o as window_popout_default, or as init_components_react, p as init_refresh, pi as init_core_react, qs as useDemoIModel, r as enable, rs as SpatialViewState, s as init_window_add, sn as LocalStateStorage, ss as PrimitiveTool, st as FrontstageUtilities, t as ThemeBridgeContext, ts as SurveyLengthDescription, u as upload_default, us as Tool, v as panorama_default, va as SvgPlaceholder, vt as IModelViewportControl, w as init_details, wa as SvgPanorama, wt as StageContentLayout, x as download_default, xn as ContentGroupProvider, xs as BentleyCloudRpcManager, y as feedback_default, zi as init_esm$4, zo as ViewCreator3d } from "./iframe-CKDG0E56.js";
...
function ViewportContent({ contentId, imodel, viewState, renderViewOverlay }) {
	let [iModel] = import_react$51.useState(UiFramework.getIModelConnection());
	const [defaultViewState] = import_react$51.useState(UiFramework.getDefaultViewState());
	const [viewport, setViewport] = import_react$51.useState(void 0);
	const viewportRef = import_react$51.useRef(void 0);
	...
	return import_react$51.createElement(import_react$51.Fragment, null, import_react$51.createElement(ViewportComponent, {
		viewState,
		imodel: iModel,
		viewportRef: (v) => {
	...
	}), import_react$51.createElement(ViewOverlayRenderer, {
		viewport,
		renderViewOverlay
	}));
}
function ViewOverlayRenderer({ viewport, renderViewOverlay }) {
	...
	return import_react$51.createElement(DefaultViewOverlay, {
		viewport,
...
})), import_react$50, PreviewFeaturesContext;
var init_PreviewFeaturesToggleProvider = __esmMin((() => {
	import_react$50 = /* @__PURE__ */ __toESM(require_react(), 1);
	init_appui_react();
	init_esm$4();
	init_useStrataKit();
	PreviewFeaturesContext = import_react$50.createContext(void 0);
	enable();
}));
//#endregion
//#region ../../apps/test-providers/lib/ui/icons/StrataKitIcon.js
function StrataKitIcon(props) {
	if (useStrataKit()) return import_react$49.createElement(Icon, { href: props.href });
	return import_react$49.createElement(import_react$49.Fragment, null, props.iconNode);
}
function useStrataKit() {
	const [features] = import_react$49.useContext(PreviewFeaturesContext) ?? [];
...
var import_react$48, SaveContentLayoutToolBase, RestoreSavedContentLayoutToolBase;
var init_ContentLayoutTools = __esmMin((() => {
	...
	ToolUtilities.defineIcon(SaveContentLayoutToolBase, import_react$48.createElement(StrataKitIcon, {
		href: upload_default,
		iconNode: import_react$48.createElement(SvgUpload, null)
	}));
		...
		async run() {
			...
			const contentGroup = new ContentGroup({
				...
				contents: contentGroupProps.contents.map((content) => {
					return {
						...content,
						content: import_react$48.createElement(ViewportContent, null)
					};
				})
			});
	...
	ToolUtilities.defineIcon(RestoreSavedContentLayoutToolBase, import_react$48.createElement(StrataKitIcon, {
		href: download_default,
		iconNode: import_react$48.createElement(SvgDownload, null)
	}));
}));
//#endregion
//#region ../../apps/test-providers/lib/tools/InspectUiItemInfoTool.js
var import_react$47, InspectUiItemInfoToolBase, InspectUiItemInfoTool;
var init_InspectUiItemInfoTool = __esmMin((() => {
	...
	InspectUiItemInfoTool = ToolUtilities.defineIcon(InspectUiItemInfoToolBase, import_react$47.createElement(StrataKitIcon, {
		href: search_default,
		iconNode: import_react$47.createElement(SvgSearch, null)
	}));
}));
//#endregion
...
function useTranslation() {
	return { translate: import_react$46.useCallback((key) => {
...
function SampleModalDialog() {
	...
	const closeDialog = import_react$45.useCallback(() => {
		UiFramework.dialogs.modal.close();
	}, []);
	const handleOK = import_react$45.useCallback(() => {
		closeDialog();
	}, [closeDialog]);
	const handleCancel = import_react$45.useCallback(() => {
		closeDialog();
	}, [closeDialog]);
	return import_react$45.createElement(Dialog, {
		isOpen: true,
		onClose: handleCancel,
		closeOnEsc: true,
		closeOnExternalClick: true,
		preventDocumentScroll: true
	}, import_react$45.createElement(Dialog.Backdrop, null), import_react$45.createElement(Dialog.Main, { style: {
		width: 450,
		height: 300
	} }, import_react$45.createElement(Dialog.TitleBar, { titleText: translate("Dialogs.SampleModal.title") }), import_react$45.createElement(Dialog.Content, null, "Lorem ipsum dolor sit amet, posse imperdiet ius in, mundi cotidieque ei per. Vel scripta ornatus assentior cu. Duo nonumy equidem te, per ad malis deserunt consetetur. In per invidunt conceptam. Ea pri aeque corrumpit. Eum ea ipsum perfecto vulputate, an cum oblique ornatus."), import_react$45.createElement(Dialog.ButtonBar, null, import_react$45.createElement(Button, {
		styleType: "high-visibility",
		onClick: handleOK
	}, "OK"), import_react$45.createElement(Button, { onClick: handleCancel }, "Cancel"))));
}
var import_react$45;
var init_SampleModalDialog = __esmMin((() => {
	...
	init_useTranslation();
	init_esm$3();
})), import_react$44, OpenCustomDialogToolBase;
var init_OpenCustomDialogTool = __esmMin((() => {
	...
	OpenCustomDialogToolBase = class extends Tool {
		...
		async run() {
			UiFramework.dialogs.modal.open(import_react$44.createElement(SampleModalDialog, null));
			return true;
		}
		static get flyover() {
	...
	ToolUtilities.defineIcon(OpenCustomDialogToolBase, import_react$44.createElement(StrataKitIcon, {
		href: refresh_default,
		iconNode: import_react$44.createElement(SvgRefresh, null)
	}));
}));
//#endregion
...
function ViewDefinitionSelector(props) {
	const [selectOptions, setSelectOptions] = import_react$43.useState([]);
	...
	return import_react$43.createElement("div", null, import_react$43.createElement(Select, {
...
function ViewsTable() {
	...
	const [iModelViews, setIModelViews] = import_react$42.useState([]);
	import_react$42.useEffect(() => {
	...
	const viewData = import_react$42.useMemo(() => {
	...
	const columns = import_react$42.useMemo(() => [
		{
			Header: "View Id",
			accessor: "id"
		},
	...
	return import_react$42.createElement(Table, {
		columns,
		data: viewData,
...
function PopoutDialog() {
	return import_react$41.createElement("div", { className: "test-popout-dialog" }, import_react$41.createElement(ViewsTable, null));
}
var import_react$41;
...
var import_react$40, OpenPopoutDialogToolBase, OpenPopoutDialogTool;
var init_OpenPopoutDialogTool = __esmMin((() => {
	...
	OpenPopoutDialogToolBase = class extends Tool {
		...
		async run() {
			...
			UiFramework.childWindows.open("DialogPopout", "Dialog Popout", import_react$40.createElement(PopoutDialog, null), {
				width: 800,
				height: 600,
				left: 100,
				top: 100
	...
	OpenPopoutDialogTool = ToolUtilities.defineIcon(OpenPopoutDialogToolBase, import_react$40.createElement(StrataKitIcon, {
		href: window_add_default,
		iconNode: import_react$40.createElement(SvgWindowAdd, null)
	}));
}));
//#endregion
...
function PopupTestView({ contentId, showViewPicker }) {
	const menuItems = import_react$39.useMemo(() => {
		return [
			{
				id: "Item1",
				label: "Item ~1",
	...
	const activeIModelConnection = useActiveIModelConnection();
	const divRef = import_react$39.useRef(null);
	const [initialViewState, setInitialViewState] = import_react$39.useState(UiFramework.getDefaultViewState());
	const viewportRef = import_react$39.useRef(null);
	...
	const onViewDefinitionChanged = import_react$39.useCallback(async (viewId) => {
		if (activeIModelConnection && viewId) {
			const viewState = await activeIModelConnection.views.load(viewId);
			setInitialViewState(viewState);
		}
	}, [activeIModelConnection]);
	const handleContextMenu = import_react$39.useCallback((e) => {
		e.preventDefault();
	...
	return import_react$39.createElement("div", {
		ref: divRef,
		style: {
			display: "grid",
	...
	}, !!showViewPicker && initialViewState && import_react$39.createElement("div", null, import_react$39.createElement(ViewDefinitionSelector, {
		imodel: initialViewState.iModel,
		selectedViewDefinition: initialViewState.id,
		onViewDefinitionSelected: onViewDefinitionChanged
	})), initialViewState && import_react$39.createElement("div", null, import_react$39.createElement(FloatingViewportContent, {
		contentId,
		initialViewState,
		onContextMenu: handleContextMenu,
		viewportRef
	})), import_react$39.createElement(Button, { onClick: () => {
...
var import_react$38, OpenPopoutViewToolBase, OpenPopoutViewTool;
var init_OpenPopoutViewTool = __esmMin((() => {
	...
	OpenPopoutViewToolBase = class extends Tool {
		...
		async _run() {
			UiFramework.childWindows.open("ViewPopout", "View Popout", import_react$38.createElement(PopupTestView, {
	...
	OpenPopoutViewTool = ToolUtilities.defineIcon(OpenPopoutViewToolBase, import_react$38.createElement(StrataKitIcon, {
		href: window_popout_default,
		iconNode: import_react$38.createElement(SvgWindowPopout, null)
	}));
}));
//#endregion
...
function SynchronizedFloatingView({ contentId, viewport }) {
	const activeIModelConnection = useActiveIModelConnection();
	const divRef = import_react$37.useRef(null);
	const [floatingViewport, setFloatingViewport] = import_react$37.useState();
	const [initialViewState, setInitialViewState] = import_react$37.useState(void 0);
	const [twoDViewDefinitions, setTwoDViewDefinitions] = import_react$37.useState([]);
	const [threeDViewDefinitions, setThreeDViewDefinitions] = import_react$37.useState([]);
	const [noViewsMessage, setNoViewsMessage] = import_react$37.useState("No 2D views available.");
	...
	if (initialViewState) return import_react$37.createElement("div", {
		className: "test-syncrhonized-test-view",
		ref: divRef
	}, import_react$37.createElement("div", { id: "floatingviewportcontainerdiv" }, initialViewState && import_react$37.createElement(FloatingViewportContent, {
		contentId,
		initialViewState,
		viewportRef: (v) => {
	...
	else return import_react$37.createElement("div", {
		className: "test-popup-test-view",
		ref: divRef
	}, import_react$37.createElement("div", { className: "no-views-message" }, noViewsMessage));
}
var import_react$37;
...
function IModelViewDialog({ x, y, id, title }) {
	const [viewport] = import_react$36.useState(() => IModelApp.viewManager.selectedView);
	...
	if (!viewport) return null;
	return import_react$36.createElement(Dialog, {
		isOpen: true,
		onClose: () => {
		...
		isResizable: true,
		preventDocumentScroll: true
	}, import_react$36.createElement(Dialog.Main, { style: {
		width: "40vw",
		height: "40vh",
		...initialOffset
	} }, import_react$36.createElement(Dialog.TitleBar, { titleText: title }), import_react$36.createElement(Dialog.Content, { style: { padding: 0 } }, import_react$36.createElement(SynchronizedFloatingView, {
		contentId: id,
		viewport
	}))));
}
var import_react$36, OpenSynchronizedViewToolBase, OpenSynchronizedViewTool;
var init_OpenSynchronizedViewTool = __esmMin((() => {
	...
	OpenSynchronizedViewToolBase = class extends Tool {
		...
		async _run() {
			...
			UiFramework.dialogs.modeless.open(import_react$36.createElement(IModelViewDialog, {
				x,
				y,
	...
	OpenSynchronizedViewTool = ToolUtilities.defineIcon(OpenSynchronizedViewToolBase, import_react$36.createElement(StrataKitIcon, {
		href: panorama_default,
		iconNode: import_react$36.createElement(SvgPanorama, null)
	}));
}));
//#endregion
...
var import_react$35, ToolOptions, SampleToolBase, SampleTool;
var init_SampleTool = __esmMin((() => {
		...
		async onDataButtonDown(ev) {
			if (ev.isAltKey) {
				...
				menuItems.push({
					id: "entry1",
					label: "Label1",
					iconNode: import_react$35.createElement(StrataKitIcon, {
						href: placeholder_default,
						iconNode: import_react$35.createElement(SvgPlaceholder, null)
					}),
					execute: () => {
				...
				menuItems.push({
					...
					iconRightNode: import_react$35.createElement(StrataKitIcon, {
						href: placeholder_default,
						iconNode: import_react$35.createElement(SvgPlaceholder, null)
					})
				});
	...
	SampleTool = ToolUtilities.defineIcon(SampleToolBase, import_react$35.createElement(StrataKitIcon, {
		href: feedback_default,
		iconNode: import_react$35.createElement(SvgFeedback, null)
	}));
}));
//#endregion
//#region ../../node_modules/.pnpm/@stratakit+icons@0.4.3/node_modules/@stratakit/icons/icons/copy.svg
var copy_default;
var init_copy = __esmMin((() => {
	copy_default = "" + new URL("copy-CbsQWmf4.svg", import.meta.url).href;
}));
//#endregion
//#region ../../apps/test-providers/lib/tools/ToolWithDynamicSettings.js
var import_react$34, StateOptions, cities, ToolWithDynamicSettingsBase, ToolWithDynamicSettings;
var init_ToolWithDynamicSettings = __esmMin((() => {
	...
	ToolWithDynamicSettings = ToolUtilities.defineIcon(ToolWithDynamicSettingsBase, import_react$34.createElement(StrataKitIcon, {
		href: copy_default,
		iconNode: import_react$34.createElement(SvgCopy, null)
	}));
}));
//#endregion
...
function EditorExampleComponent() {
	return import_react$32.createElement(Flex, {
		...
		return import_react$32.createElement(Flex, {
			key: index,
			flexDirection: "column"
		}, import_react$32.createElement(Flex, {
			flexDirection: "row",
			gap: "xl"
		}, import_react$32.createElement(Flex.Item, {
			id: `Legacy${editorId}`,
			alignSelf: "flex-start",
			style: { width: "300px" }
		}, import_react$32.createElement(OldEditorRenderer, { record })), import_react$32.createElement(Divider, { orientation: "vertical" }), import_react$32.createElement(Flex.Item, {
			id: `New${editorId}`,
			alignSelf: "flex-end",
			style: { width: "300px" }
		}, import_react$32.createElement(NewEditorRenderer, { record }))), import_react$32.createElement(Flex.Item, { alignSelf: "flex-start" }, import_react$32.createElement(Text, {
			variant: "small",
			isMuted: true
		}, editorKey, record.property.editor && import_react$32.createElement(DropdownMenu, { menuItems: (close) => [import_react$32.createElement(MenuItem, {
			key: 1,
			onClick: close
		}, import_react$32.createElement(Text, { variant: "leading" }, "Editor config:"), import_react$32.createElement("code", { style: {
			whiteSpace: "pre",
			display: "block"
		} }, JSON.stringify(record.property.editor, void 0, 2)))] }, import_react$32.createElement(IconButton, {
			styleType: "borderless",
			size: "small"
		}, import_react$32.createElement(StrataKitIcon, {
			href: "" + new URL("details-B5uGzNgI.svg", import.meta.url).href,
			iconNode: import_react$32.createElement(SvgDetails, null)
		}))))));
	}));
}
function OldEditorRenderer({ record }) {
	return import_react$32.createElement(Flex, {
		...
		flexWrap: "nowrap",
		alignItems: "flex-end"
	}, availableSizes.map((localSize) => import_react$32.createElement(Flex.Item, { key: localSize }, import_react$32.createElement(EditorContainer, {
...
function NewEditorRenderer({ record }) {
	return import_react$32.createElement(Flex, {
		...
		flexWrap: "nowrap",
		alignItems: "flex-end"
	}, availableSizes.map((localSize) => import_react$32.createElement(Flex.Item, { key: localSize }, import_react$32.createElement(PropertyRecordEditor, {
		propertyRecord: record,
		onCommit: () => void 0,
		onCancel: () => void 0,
		editorSystem: "new",
...
var import_react$32, availableSizes, customFormattedNumberParams, inputEditorSizeParams, propertyRecords;
...
function createContentLayoutFrontstage() {
	return FrontstageUtilities.createStandardFrontstage({
		...
		cornerButton: import_react$26.createElement(BackstageAppButton, { icon: "icon-bentley-systems" }),
		usage: StageUsage.General
	});
}
var import_react$26, ContentLayoutStageContentGroupProvider, contentGroupProvider;
		...
		async contentGroup(config) {
			...
			const defaultContent = new ContentGroup({
				...
				contents: [{
					id,
					classId: "",
					content: import_react$26.createElement(ViewportContent, {
						contentId: id,
...
var import_react$25, SampleContentControl;
var init_SampleContentControl = __esmMin((() => {
	...
	SampleContentControl = class extends ContentControl {
		constructor(info, options) {
			super(info, options);
			this.reactNode = import_react$25.createElement("div", { className: "test-content-container" }, import_react$25.createElement(Flex, { justifyContent: "center" }, "Hello World!"));
		}
	};
}));
//#endregion
...
function useActiveContentId() {
	const [activeId, setActiveId] = import_react$24.useState(UiFramework.content.getActiveId());
...
function CustomViewToolWidgetComposer() {
	...
	return import_react$23.createElement(ViewToolWidgetComposer, { hideNavigationAid });
}
function createCustomContentFrontstage() {
	const frontstage = FrontstageUtilities.createStandardFrontstage({
		...
		cornerButton: import_react$23.createElement(BackstageAppButton, null)
	});
	return {
		...frontstage,
		viewNavigation: {
			...frontstage.viewNavigation,
			content: import_react$23.createElement(CustomViewToolWidgetComposer, null)
		}
	};
}
var import_react$23;
...
var init_CustomFrontstageProvider = __esmMin((() => {
	...
	new ContentGroup({
		...
		contents: [{
			id: "content",
			classId: "",
			content: import_react$22.createElement("h1", null, "Custom Content")
		}]
	});
}));
//#endregion
	...
	return FrontstageUtilities.createStandardFrontstage({
		...
		contentGroupProps: {
			...
			contents: [{
				id: "primaryContent",
				classId: "",
				content: import_react$20.createElement(ViewportContent, null)
			}]
		},
		cornerButton: import_react$20.createElement(BackstageAppButton, { icon: "icon-bentley-systems" }),
		usage: StageUsage.General
	});
}
var import_react$20;
...
var init_SampleModelessDialog$1 = __esmMin((() => {})), import_react$12;
...
function Initialized(props) {
	...
	const useStrataKit = import_react.useContext(ThemeBridgeContext) === "useStrataKit";
	import_react.useEffect(() => {
		let ignore = false;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PreviewFeaturesProvider, {
		features: {
			...useStrataKit ? { useStrataKit: enable() } : void 0,
			...props.features
		},
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Provider_default, {
