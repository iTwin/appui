...
import { L as Logger, R as RelativePosition, B as Button } from "./Key.enum-DCghlnp9.js";
import { aS as useDraggedItem, aT as Timer, aU as useCursorInformationStore, aV as CursorPopupManager, aW as CursorInformation, U as UiFramework, aX as Dialog, az as TitleBar, aY as UiStateStorageContext, z as useTranslation, aZ as useActiveTool, a_ as UiStateStorageStatus, M as MessageManager, a$ as ProcessDetector, ay as StatusBarPopover, b0 as StatusBarDialog, A as StrataKitIcon, b1 as SvgPin, aA as Tabs, b2 as ToolAssistanceInputMethod, d as ToolAssistanceImage, b3 as FillCentered } from "./appui-react-BtU_mNFj.js";
import { _ as Point, j as Icon, T as Text, a0 as SvgClose, g as ToggleSwitch, a3 as SvgAdd } from "./components-react-Dj8XcCyt.js";
import { r as reactExports, c as classnames } from "./iframe-CpRh-TYa.js";
...
const svgAdd = async () => __vitePreload(() => import("./add-f_jkmMrd.js"), true ? [] : void 0, import.meta.url);
const svgDismiss = async () => __vitePreload(() => import("./dismiss-DuY5v4rP.js"), true ? [] : void 0, import.meta.url);
const svgCursorClick = async () => __vitePreload(() => import("./cursor-click-B1JJ6MOX.js"), true ? [] : void 0, import.meta.url);
const svgGestureOneFingerDrag = async () => __vitePreload(() => import("./gesture-one-finger-drag-ZHNEOei7.js"), true ? [] : void 0, import.meta.url);
const svgGestureOneFingerTap = async () => __vitePreload(() => import("./gesture-one-finger-tap-CGrN0bmF.js"), true ? [] : void 0, import.meta.url);
const svgGestureOneFingerDoubleTap = async () => __vitePreload(() => import("./gesture-one-finger-double-tap-EpY32PIf.js"), true ? [] : void 0, import.meta.url);
const svgGesturePinch = async () => __vitePreload(() => import("./gesture-pinch-xLzsb4nR.js"), true ? [] : void 0, import.meta.url);
const svgGestureTwoFingerDrag = async () => __vitePreload(() => import("./gesture-two-finger-drag-aZFcyINE.js"), true ? [] : void 0, import.meta.url);
const svgGestureTwoFingerTap = async () => __vitePreload(() => import("./gesture-two-finger-tap-UeYnzlCL.js"), true ? [] : void 0, import.meta.url);
const svgMouseClickLeft = async () => __vitePreload(() => import("./mouse-click-left-C0vf6IjI.js"), true ? [] : void 0, import.meta.url);
const svgMouseClickRight = async () => __vitePreload(() => import("./mouse-click-right-DaDqqF-A.js"), true ? [] : void 0, import.meta.url);
const svgMouseClickMiddle = async () => __vitePreload(() => import("./mouse-click-middle-BesFS6wc.js"), true ? [] : void 0, import.meta.url);
const svgPin = async () => __vitePreload(() => import("./pin-B-VyFvih.js"), true ? [] : void 0, import.meta.url);
  ...
  return reactExports.createElement(
    ...
    { visible, onVisibleChange: setVisible, closeOnOutsideClick: !pinned, content: reactExports.createElement(
      ...
      { buttons: reactExports.createElement(StatusBarDialog.TitleBarButton, { onClick: () => {
        ...
        setPinned(true);
      }, title: translate(pinned ? "dialog.close" : "toolAssistance.pin") }, pinned ? reactExports.createElement(StrataKitIcon, { href: svgDismiss, iconNode: reactExports.createElement(SvgClose, null) }) : reactExports.createElement(StrataKitIcon, { href: svgPin, iconNode: reactExports.createElement(SvgPin, null) })), title: dialogTitle },
      reactExports.createElement(
        "div",
        null,
...
function InstructionSvgImage({ instruction, mediumSize }) {
  ...
  if (typeof instruction.image !== "string" && instruction.image !== ToolAssistanceImage.Keyboard) {
    ...
    image = reactExports.createElement("div", { className }, svgImage || href ? reactExports.createElement(StrataKitIcon, { href, iconNode: (
      // eslint-disable-next-line @typescript-eslint/no-deprecated
      svgImage && reactExports.createElement(Icon, { iconSpec: svgImage })
    ) }) : void 0);
  }
  return image;
}
