...
import { Dc as ExpandableBlock, Oc as init_ExpandableBlock } from "./components-react-2-ltnsUD.js";
...
function init_ExpandableList() {
	return (init_ExpandableList = __esmMin((() => {
...
function init_ExpandableList_stories() {
	return (init_ExpandableList_stories = __esmMin((() => {
		init_ExpandableList();
