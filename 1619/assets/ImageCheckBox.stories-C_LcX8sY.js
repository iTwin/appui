...
import { Mr as init_esm, _s as Svg3D, ys as Svg2D } from "./components-react-2-ltnsUD.js";
...
function init_ImageCheckBox$1() {
	return (init_ImageCheckBox$1 = __esmMin((() => {
...
function init_ImageCheckBox_stories() {
	return (init_ImageCheckBox_stories = __esmMin((() => {
		init_Decorators();
