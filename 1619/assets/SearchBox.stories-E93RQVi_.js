...
import { Mr as init_esm, Uc as Input, Wc as init_Input, _i as SvgSearch, _o as SvgClose } from "./components-react-2-ltnsUD.js";
import { t as require_Key_enum } from "./Key.enum-CqsoxW_A.js";
import { r as init_Decorators, t as AppUiDecorator } from "./Decorators-CkWPhb8P.js";
import { n as init_IconComponent, t as Icon } from "./IconComponent-DHOC3DQH.js";
...
function init_SearchBox$1() {
	return (init_SearchBox$1 = __esmMin((() => {
			...
			_handleKeyDown = (e) => {
				switch (e.key) {
					case import_Key_enum.Key.Escape.valueOf():
						...
						break;
					case import_Key_enum.Key.Enter.valueOf(): if (this.props.onEnterPressed) this.props.onEnterPressed();
				}
			};
...
function init_SearchBox_stories() {
	return (init_SearchBox_stories = __esmMin((() => {
		init_Decorators();
		init_SearchBox$1();
