...
import { Ir as Point3d, Lr as init_Point3dVector3d, Mr as LineSegment3d, Nr as init_LineSegment3d, Ut as WidgetState, rn as StagePanelLocation, t as init_appui_react, tn as StagePanelSection, zt as StagePanelState } from "./appui-react-p-O3mm3j.js";
import { a as removeProperty, i as init_Utils, n as createWidget, t as createFrontstage } from "./Utils-bQd6hcpG.js";
//#region src/frontstage/Frontstage.tsx
...
function init_Frontstage() {
	return (init_Frontstage = __esmMin((() => {
		init_AppUiStory();
		init_Utils();
		import_jsx_runtime$1 = require_jsx_runtime();
		FrontstageStory.__docgenInfo = {
			...
			"methods": [],
			"displayName": "FrontstageStory",
			"props": { "frontstage": {
				"required": false,
				"tsType": {
					"name": "Partial",
					"elements": [{ "name": "StandardFrontstageProps" }],
					"raw": "Partial<StandardFrontstageProps>"
				},
				"description": ""
			} }
		};
...
//#endregion
//#region src/VirtualCursor.ts
function createCursorEvents(initialPosition, onMove, options) {
	let currentPosition = initialPosition;
	const duration = options?.duration ?? 250;
	return { move: async (to) => {
		const start = Date.now();
		const line = LineSegment3d.create(new Point3d(currentPosition.x, currentPosition.y, 0), new Point3d(to.x, to.y, 0));
		return new Promise((resolve) => {
			const move = () => {
				const fraction = (Date.now() - start) / duration;
				if (fraction < 1) {
...
var VirtualCursorElement;
function init_VirtualCursor() {
	return (init_VirtualCursor = __esmMin((() => {
		init_LineSegment3d(), init_Point3dVector3d();
		VirtualCursorElement = class extends HTMLElement {
			_removeListeners = [];
			top = 100;
			left = 100;
			connectedCallback() {
    ...
    `;
				...
				this._removeListeners.push(() => document.removeEventListener("mousemove", handleMouseMove), () => document.removeEventListener("mousedown", handleMouseDown), () => document.removeEventListener("mouseup", handleMouseUp), () => overlay.removeEventListener("mousemove", stopPropagation), () => overlay.removeEventListener("mousedown", stopPropagation), () => overlay.removeEventListener("mouseup", stopPropagation));
		...
		if (!customElements.get("virtual-cursor-element")) customElements.define("virtual-cursor-element", VirtualCursorElement);
	})))();
}
//#endregion
//#region src/frontstage/Frontstage.stories.tsx
async function wait(ms) {
	return new Promise((resolve) => setTimeout(resolve, ms));
}
var import_jsx_runtime, fireEvent, within, meta, Overview, Panels, PanelSections, FloatingWidgets, WidgetContainer, Interaction, __namedExportsOrder;
function init_Frontstage_stories() {
	return (init_Frontstage_stories = __esmMin((() => {
		init_appui_react();
		init_AppUiStory();
		init_Frontstage();
		init_Utils();
		...
		({fireEvent, within} = __STORYBOOK_MODULE_TEST__);
		meta = {
		...
		Panels = { args: {
			...
			itemProviders: [{
				...
				getWidgets: () => [
					createWidget(1, {
						content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Top panel" }),
						layouts: { standard: {
					...
					createWidget(2, {
						content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Left panel" }),
						layouts: { standard: {
					...
					createWidget(3, {
						content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Bottom panel" }),
						layouts: { standard: {
					...
					createWidget(4, {
						content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Right panel" }),
						layouts: { standard: {
							location: StagePanelLocation.Right,
							section: StagePanelSection.Start
						} }
		...
		PanelSections = { args: {
			...
			itemProviders: [{
				...
				getWidgets: () => [
					createWidget(1, {
						content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Start section" }),
						layouts: { standard: {
							location: StagePanelLocation.Bottom,
							section: StagePanelSection.Start
						} }
					...
					createWidget(2, {
						content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "End section" }),
						layouts: { standard: {
							location: StagePanelLocation.Bottom,
		...
		FloatingWidgets = { args: { itemProviders: [{
			id: "widgets",
			getWidgets: () => [createWidget(1, {
				content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Floating widget" }),
				defaultState: WidgetState.Floating,
		...
		WidgetContainer = { args: {
			frontstage: { rightPanelProps: { size: 300 } },
			itemProviders: [{
				id: "widgets",
				getWidgets: () => {
					const layouts = { standard: {
		...
		Interaction = {
			...
			play: async ({ canvasElement, step }) => {
				...
				await step("test", async () => {
					const widget = await canvas.findByTitle("Widget 2", void 0, { timeout: 5e3 });
...
//#endregion
init_Frontstage_stories();
export { FloatingWidgets, Interaction, Overview, PanelSections, Panels, WidgetContainer, __namedExportsOrder, meta as default };
