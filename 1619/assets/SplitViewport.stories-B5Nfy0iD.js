...
import { Fr as SvgWindowSplitVertical, Mr as init_esm, Nr as SvgWindow } from "./components-react-2-ltnsUD.js";
import { K as StandardContentLayouts, r as init_appui_abstract, w as ConditionalBooleanValue } from "./Key.enum-CqsoxW_A.js";
import { i as init_appui_test_providers, n as Page, r as init_AppUiStory, s as ViewportContent, t as AppUiStory } from "./AppUiStory-cZ7dbGZU.js";
import { $t as ToolbarUsage, Qt as ToolbarOrientation, i as ToolbarItemUtilities, lt as UiFramework, sn as SyncUiEventId, t as init_appui_react } from "./appui-react-p-O3mm3j.js";
...
function init_SplitViewport() {
	return (init_SplitViewport = __esmMin((() => {
		init_AppUiStory();
...
function init_SplitViewport_stories() {
	return (init_SplitViewport_stories = __esmMin((() => {
		init_appui_abstract();
		init_appui_react();
		init_esm();
		init_Decorators();
