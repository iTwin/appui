...
import { R as StandardTypeNames, f as PropertyDescriptionHelper, r as init_appui_abstract } from "./Key.enum-CqsoxW_A.js";
...
function init_LockPropertyTool() {
	return (init_LockPropertyTool = __esmMin((() => {
		init_appui_abstract();
		init_StoryTool();
