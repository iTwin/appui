...
import { V as PropertyEditorParamTypes, W as DialogProperty, f as PropertyDescriptionHelper, m as StandardEditorNames, r as init_appui_abstract } from "./Key.enum-CqsoxW_A.js";
import { n as Page, r as init_AppUiStory, t as AppUiStory } from "./AppUiStory-cZ7dbGZU.js";
import { Nn as init_core_frontend, U as IModelViewportControl, Wn as IModelApp, Yn as LengthDescription, dn as PreviewFeaturesProvider, lt as UiFramework, q as StandardContentLayouts, t as init_appui_react } from "./appui-react-p-O3mm3j.js";
...
import { n as createLockPropertyTool, r as init_LockPropertyTool, t as LockPropertyTool } from "./LockPropertyTool-C1BLB94i.js";
...
function init_ToolSettingsLockButton() {
	return (init_ToolSettingsLockButton = __esmMin((() => {
		init_appui_abstract();
		init_appui_react();
		init_core_frontend();
		init_AppUiStory();
...
function init_ToolSettingsLockButton_stories() {
	return (init_ToolSettingsLockButton_stories = __esmMin((() => {
		init_Decorators();
		init_AppUiStory();
...
//#endregion
init_ToolSettingsLockButton_stories();
