...
import { N as MarkupIcon, V as init_dist, d as PopoverProvider, n as Button, o as Form, x as init_components } from "./components-BInfUg2s.js";
import { i as init_chunk_UAWMPV5J, r as __toESM$1, t as __commonJS } from "./chunk-UAWMPV5J-D51fq2Gn.js";
import { r as init_chunk_QQBDHPVZ, t as getControlId } from "./chunk-QQBDHPVZ-C7Xid1BS.js";
import { a as init_theming, u as styled } from "./theming-BErEndj3.js";
//#region ../../node_modules/.pnpm/@storybook+addon-docs@10.5.3_@types+react-dom@19.2.3_@types+react@19.2.14__@types+react_79f0c9ed95d1b34ec286c75f3993b3a1/node_modules/@storybook/addon-docs/dist/_browser-chunks/Color-6AOWCN3U.js
...
var import_react, import_react$1, require_color_name, require_conversions, require_route, require_color_convert, import_color_convert, placeholderSymbol, placeholderSymbol2, s, f, v, d, h, m, g, p, b, _, x, C, E, H, N, w, y, q, k, I, z, D, K, L, S, T, F, P, X, V, $, J, Q, U, W, Z, ee, re, le, ue, Ee, He, Wrapper, TooltipContent, Swatches, swatchBackground, SwatchColor, Input, PopoverTrigger, CycleColorSpaceButton, ColorSpace, COLOR_SPACES, COLOR_REGEXP, RGB_REGEXP, HSL_REGEXP, HEX_REGEXP, SHORTHEX_REGEXP, ColorPicker, fallbackColor, stringToArgs, parseRgb, parseHsl, parseHexOrKeyword, parseValue, getRealValue, useColorInput, id, usePresets, ColorControl, Color_default;
function init_Color_6AOWCN3U() {
	return (init_Color_6AOWCN3U = __esmMin((() => {
		init_chunk_QQBDHPVZ();
		init_chunk_UAWMPV5J();
		...
		require_color_convert = __commonJS({ "../../../node_modules/color-convert/index.js"(exports, module) {
		...
		import_color_convert = __toESM$1(require_color_convert(), 1);
		...
		V = typeof window < "u" ? import_react$1.useLayoutEffect : import_react$1.useEffect;
		$ = function() {
		...
		SwatchColor = styled(Button)(({ value, selected, theme }) => ({
			width: 16,
			height: 16,
		...
		usePresets = (presetColors, currentColor, colorSpace, maxPresetColors = 27) => {
		...
		ColorControl = ({ name, storyId, controlsId, value: initialValue, onChange, onFocus, onBlur, presetColors, maxPresetColors, startOpen = !1, argType, required }) => {
