...
import { $n as require_dist, Uc as Input, Wc as init_Input } from "./components-react-2-ltnsUD.js";
import { Vt as Logger, X as init_core_bentley, t as require_Key_enum } from "./Key.enum-CqsoxW_A.js";
import { r as init_Decorators, t as AppUiDecorator } from "./Decorators-CkWPhb8P.js";
import { n as init_UiCore, t as UiCore } from "./UiCore-DXQsg98D.js";
//#endregion
...
function init_AutoSuggest$1() {
	return (init_AutoSuggest$1 = __esmMin((() => {
			...
			_handleKeyDown = (e) => {
				switch (e.key) {
					...
					case import_Key_enum.Key.Escape.valueOf():
						...
						break;
					case import_Key_enum.Key.Tab.valueOf(): if (this.props.onPressTab) this.props.onPressTab(e);
				}
			};
			_theme = {
...
function init_AutoSuggest_stories() {
	return (init_AutoSuggest_stories = __esmMin((() => {
		init_Decorators();
		init_AutoSuggest$1();
		meta = {
