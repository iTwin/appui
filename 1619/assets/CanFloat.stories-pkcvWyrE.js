...
import { Ut as WidgetState, t as init_appui_react } from "./appui-react-p-O3mm3j.js";
import { i as init_Utils, n as createWidget } from "./Utils-bQd6hcpG.js";
...
function init_CanFloat() {
	return (init_CanFloat = __esmMin((() => {
		init_appui_react();
		init_AppUiStory();
		init_Utils();
...
function init_CanFloat_stories() {
	return (init_CanFloat_stories = __esmMin((() => {
		init_CanFloat();
		init_Decorators();
		init_AppUiStory();
