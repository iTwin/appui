...
import { Nn as init_core_frontend, Wn as IModelApp, Xt as StatusBarSection, c as ToolAssistanceField, g as StatusBarItemUtilities, t as init_appui_react } from "./appui-react-p-O3mm3j.js";
...
function init_OutputPrompt() {
	return (init_OutputPrompt = __esmMin((() => {
...
function init_OutputPrompt_stories() {
	return (init_OutputPrompt_stories = __esmMin((() => {
		init_OutputPrompt();
		init_AppUiStory();
