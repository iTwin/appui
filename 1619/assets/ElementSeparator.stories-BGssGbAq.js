...
import { ir as require_throttle } from "./components-react-2-ltnsUD.js";
...
function init_useThrottledFn() {
	return (init_useThrottledFn = __esmMin((() => {
...
function init_ElementSeparator$1() {
	return (init_ElementSeparator$1 = __esmMin((() => {
		require_react();
...
function init_ElementSeparator_stories() {
	return (init_ElementSeparator_stories = __esmMin((() => {
		init_Decorators();
