...
var DracoLoader$1;
function init_draco_loader() {
	return (init_draco_loader = __esmMin((() => {
		init_version();
		DracoLoader$1 = {
			dataType: null,
			batchType: null,
...
function init_deduce_mesh_schema() {
	return (init_deduce_mesh_schema = __esmMin((() => {})))();
}
//#endregion
...
function init_get_draco_schema() {
	return (init_get_draco_schema = __esmMin((() => {
...
function init_draco_parser() {
	return (init_draco_parser = __esmMin((() => {
...
var VERSION;
function init_version$1() {
	return (init_version$1 = __esmMin((() => {
		VERSION = getVersion();
	})))();
}
//#endregion
...
//#endregion
//#region ../../node_modules/.pnpm/@loaders.gl+worker-utils@4.3.4_@loaders.gl+core@4.3.4/node_modules/@loaders.gl/worker-utils/dist/lib/env-utils/globals.js
var globals, isBrowser, isWorker, matches;
function init_globals() {
	return (init_globals = __esmMin((() => {
		globals = {
...
function init_library_utils() {
	return (init_library_utils = __esmMin((() => {
		init_globals();
		init_version$1();
		loadLibraryPromises = {};
	})))();
...
function init_draco_module_loader() {
	return (init_draco_module_loader = __esmMin((() => {
		init_library_utils();
