...
import { Cc as Textarea, Ct as EditorRenderer, Gc as Slider, Kc as init_Slider, Mt as createEditorSpec, Pt as EditorsRegistryProvider, Rt as isNumeric, St as useCommittableValue, Uc as Input, Wc as init_Input, _c as Flex, gl as init_StatusMessage, hl as StatusMessage, il as init_Text, rl as Text, t as init_components_react, vc as init_Flex, wc as init_Textarea, zt as isText } from "./components-react-2-ltnsUD.js";
...
function init_NewEditors_stories() {
	return (init_NewEditors_stories = __esmMin((() => {
		import_react = /* @__PURE__ */ __toESM(require_react(), 1);
		init_components_react();
		init_Flex(), init_Text(), init_Input(), init_Slider(), init_StatusMessage(), init_Button(), init_Textarea();
