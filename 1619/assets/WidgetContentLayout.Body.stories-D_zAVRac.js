...
function init_WidgetContentLayout_Body() {
	return (init_WidgetContentLayout_Body = __esmMin((() => {
		init_appui_react();
		init_AppUiStory();
		init_Utils();
...
function init_WidgetContentLayout_Body_stories() {
	return (init_WidgetContentLayout_Body_stories = __esmMin((() => {
		init_Decorators();
		init_AppUiStory();
...
//#endregion
init_WidgetContentLayout_Body_stories();
