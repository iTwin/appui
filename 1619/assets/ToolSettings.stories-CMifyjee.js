...
import { J as init_Box, jt as require_classnames, q as Box } from "./SvgCloseSmall-D4ZjyCAN.js";
import { Lc as Tag, Mt as createEditorSpec, Pt as EditorsRegistryProvider, Rc as init_Tag, gt as PropertyEditorManager, ht as PropertyEditorBase, kt as isPropertyRecordEditorMetadata, t as init_components_react, zt as isText } from "./components-react-2-ltnsUD.js";
import { I as PropertyValueFormat, r as init_appui_abstract } from "./Key.enum-CqsoxW_A.js";
import { n as Page, r as init_AppUiStory, t as AppUiStory } from "./AppUiStory-cZ7dbGZU.js";
import { Nn as init_core_frontend, St as StandardLayout, U as IModelViewportControl, Ut as WidgetState, Wn as IModelApp, ir as EventHandled, lt as UiFramework, nr as PrimitiveTool, q as StandardContentLayouts, rn as StagePanelLocation, t as init_appui_react, tn as StagePanelSection } from "./appui-react-p-O3mm3j.js";
import { a as removeProperty, i as init_Utils, t as createFrontstage } from "./Utils-bQd6hcpG.js";
import { r as init_Decorators, t as AppUiDecorator } from "./Decorators-CkWPhb8P.js";
import { n as init_StoryTool, t as StoryPrimitiveTool } from "./StoryTool-C5z1G8Tx.js";
import { r as init_LockPropertyTool, t as LockPropertyTool } from "./LockPropertyTool-C1BLB94i.js";
...
var import_react$2, import_classnames, TagContainer;
function init_TagContainer() {
	return (init_TagContainer = __esmMin((() => {
		import_react$2 = /* @__PURE__ */ __toESM(require_react(), 1);
		import_classnames = /* @__PURE__ */ __toESM(require_classnames(), 1);
		init_Box();
		TagContainer = import_react$2.forwardRef((props, forwardedRef) => {
			let { className, children, overflow, background = "none", ...rest } = props;
			return import_react$2.createElement(Box, {
				className: (0, import_classnames.default)("iui-tag-container", {
...
function init_CustomEditorTool() {
	return (init_CustomEditorTool = __esmMin((() => {
		init_core_frontend();
		init_StoryTool();
...
function init_TagEditorNew() {
	return (init_TagEditorNew = __esmMin((() => {
		import_react$1 = /* @__PURE__ */ __toESM(require_react(), 1);
		init_Tag(), init_TagContainer();
...
function init_ToolSettings() {
	return (init_ToolSettings = __esmMin((() => {
		init_Utils();
		init_AppUiStory();
		init_appui_react();
		init_TagEditorNew();
...
var CustomTool;
function init_CustomTool() {
	return (init_CustomTool = __esmMin((() => {
		init_core_frontend();
...
function init_TagEditorLegacy() {
	return (init_TagEditorLegacy = __esmMin((() => {
...
function init_ToolSettings_stories() {
	return (init_ToolSettings_stories = __esmMin((() => {
		init_appui_react();
		init_core_frontend();
		init_Decorators();
		init_AppUiStory();
