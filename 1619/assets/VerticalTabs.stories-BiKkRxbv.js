...
import { Mr as init_esm, ys as Svg2D } from "./components-react-2-ltnsUD.js";
...
import { n as init_Tabs, t as Tabs } from "./Tabs-CYBq8NCw.js";
...
function init_VerticalTabs() {
	return (init_VerticalTabs = __esmMin((() => {
		require_react();
		init_Tabs();
		init_Orientation();
...
function init_VerticalTabs_stories() {
	return (init_VerticalTabs_stories = __esmMin((() => {
		init_Decorators();
		init_VerticalTabs();
		init_esm();
