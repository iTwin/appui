...
import { Sc as init_MenuItem, xc as MenuItem } from "./components-react-2-ltnsUD.js";
import { Nn as init_core_frontend, Xr as DropdownButton, Zr as init_DropdownButton, dr as NotifyMessageDetails, fr as OutputMessagePriority, m as MessageCenterField, pn as MessageManager, t as init_appui_react } from "./appui-react-p-O3mm3j.js";
...
function init_MessageCenterField_stories() {
	return (init_MessageCenterField_stories = __esmMin((() => {
		import_react = /* @__PURE__ */ __toESM(require_react(), 1);
		init_Decorators();
		init_appui_react();
		init_core_frontend();
		init_DropdownButton(), init_MenuItem();
...
//#endregion
init_MessageCenterField_stories();
