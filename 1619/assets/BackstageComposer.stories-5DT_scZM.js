...
import { lt as UiFramework, pt as BackstageItemUtilities, t as init_appui_react, tt as BackstageComposer } from "./appui-react-p-O3mm3j.js";
...
function init_BackstageComposer_stories() {
	return (init_BackstageComposer_stories = __esmMin((() => {
		init_appui_react();
		init_AppUiStory();
		init_esm();
...
//#endregion
init_BackstageComposer_stories();
