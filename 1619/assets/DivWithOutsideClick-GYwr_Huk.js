...
function init_withOnOutsideClick() {
	return (init_withOnOutsideClick = __esmMin((() => {
...
//#endregion
//#region ../../ui/core-react/src/core-react/base/DivWithOutsideClick.tsx
var import_jsx_runtime, DivWithOutsideClick;
function init_DivWithOutsideClick() {
	return (init_DivWithOutsideClick = __esmMin((() => {
		require_react();
