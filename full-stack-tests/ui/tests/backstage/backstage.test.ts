...
test('backstage test', async ({ page }) => {
  ...
  const backstage = page.locator('#uifw-configurableui-wrapper div').filter({ hasText: 'View iModelReview iModelSimple viewportSimple custom frontstageCustom Contentfro' });
