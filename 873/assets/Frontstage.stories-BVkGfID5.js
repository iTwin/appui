...
import { cL as reactIsExports, cM as LineSegment3d, cN as Point3d, i as StagePanelLocation, W as WidgetState, g as StagePanelState, j as StagePanelSection } from "./DefaultToolSettingsProvider-BJ7jnI_c.js";
import { c as commonjsGlobal, g as getDefaultExportFromCjs } from "./_commonjsHelpers-LQfde5yM.js";
import { b as require$$0, c as createFrontstageProvider, A as AppUiStory, P as Page, r as removeProperty } from "./AppUiStory-DKZH7QVd.js";
...
try {
  ...
  FrontstageStory.__docgenInfo = { "description": "[FrontstageProvider](https://www.itwinjs.org/reference/appui-react/frontstage/frontstageprovider/) can be used to configure a frontstage.", "displayName": "FrontstageStory", "props": { "itemProviders": { "defaultValue": null, "description": "", "name": "itemProviders", "required": false, "type": { "name": "UiItemsProvider[]" } }, "hideStatusBar": { "defaultValue": null, "description": "Set to true if no status bar is needed in stage", "name": "hideStatusBar", "required": false, "type": { "name": "boolean" } }, "hideToolSettings": { "defaultValue": null, "description": "Set to true if no tool setting dock is needed. Typically only used in modal stages.", "name": "hideToolSettings", "required": false, "type": { "name": "boolean" } }, "frontstage": { "defaultValue": null, "description": "", "name": "frontstage", "required": false, "type": { "name": "Partial<StandardFrontstageProps>" } } } };
