...
import { aa as ConditionalStringValue, av as IconHelper, C as CommandItemDef, aw as CustomItemDef, ax as GroupItemDef, ay as isToolbarActionItem, az as isToolbarGroupItem, P as PreviewFeaturesProvider, aA as ToolbarOrientation, aB as ToolbarUsage, B as BadgeType, aC as ConditionalIconItem, aD as ConditionalBooleanValue, aE as ToolbarItemUtilities, aF as SyncUiEventDispatcher } from "./DefaultToolSettingsProvider-BJ7jnI_c.js";
...
import { T as ToolItemDef, a as ToolbarComposer } from "./ToolbarComposer-DdkBAlYT.js";
import { A as AppUiDecorator, I as InitializerDecorator } from "./Decorators-DFtbw1Rc.js";
...
class ToolbarHelper {
  ...
  static createToolbarItemFromItemDef(itemPriority, itemDef, overrides) {
    ...
    const itemBase = {
      ...
      icon: (internalData == null ? void 0 : internalData.get(IconHelper.reactIconKey)) ?? // eslint-disable-line deprecation/deprecation
      (internalData == null ? void 0 : internalData.get(IconHelper.conditionalIconItemKey)) ?? // eslint-disable-line deprecation/deprecation
      icon ?? itemDef.iconSpec,
