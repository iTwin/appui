...
import { L as Logger, b as PropertyValueFormat, d as StandardTypeNames, A as AlternateDateFormats, l as TimeDisplay, c as classnames, m as Id64, K as Key_enum, R as RelativePosition, n as PropertyEditorParamTypes, o as StandardEditorNames, U as UiAdmin, M as MessageSeverity, B as Button, k as PropertyRecord, p as BentleyError, q as BentleyStatus, r as assert, I as IconButton, G as Guid, h as BeEvent, P as ProgressRadial, s as ToolbarItemUtilities, j as BeUiEvent } from "./Key.enum-DfmWeVAv.js";
import { c0 as T, c1 as UiCore, a5 as getObjectClassName, a1 as usePackageTranslation, c2 as LinkifyIt, c3 as Highlighter, bi as Rectangle, c4 as isPromiseLike, bx as from, bo as mergeMap, bp as observeOn, bq as subscribeOn, h as Input, c5 as TimeFormat, au as Icon, c6 as SvgChevronLeft, c7 as SvgChevronRight, c8 as Popup, J as Text, c9 as IconInput, a4 as Checkbox, ca as SvgChevronDown, cb as Div, aX as SvgCheckmark, cc as SvgRemove, cd as svgPlaceholder, A as Select, ce as ImageCheckBox, cf as NumberInput, Y as Slider, cg as Textarea, ch as ToggleSwitch, aL as Orientation, ci as ElementSeparator, cj as UnderlinedButton, ck as ResizableContainerObserver, am as SvgSearch, an as SvgClose, a as MenuItem, cl as ComboBox, F as Flex, bf as SvgAdd, cm as SvgDelete, ad as SvgStatusError, bB as fn, cn as Anchor, bC as UiError, co as L, cp as UiGeometry, E as ExpandableBlock, cq as areEqual, cr as VariableSizeList, cs as useTargeted, b7 as useWidgetOpacityContext, ct as getToolbarBackgroundColor, cu as getToolbarBoxShadow, cv as getToolbarBackdropFilter, cw as TOOLBAR_BOX_SHADOW_OPACITY_DEFAULT, cx as TOOLBAR_BACKDROP_FILTER_BLUR_DEFAULT, cy as calculateToolbarOpacity, cz as calculateBoxShadowOpacity, cA as calculateBackdropFilterBlur, cB as useResizeObserver, cC as useRefState, cD as TOOLBAR_OPACITY_DEFAULT, av as IconHelper, aa as ConditionalStringValue, aD as ConditionalBooleanValue, b1 as Badge, cE as Point, cF as Timer, aC as ConditionalIconItem, bb as SvgPlaceholder, br as isNavigationKey, bs as ItemKeyboardNavigator, bO as Observable, bu as map, bv as concatAll, bw as concat, by as mergeAll, cG as WebFontIcon, cH as TreeNodePlaceholder, cI as TreeNode, cJ as Tree, cK as timer, bH as FillCentered } from "./DefaultToolSettingsProvider-BJ7jnI_c.js";
import { r as reactExports, R as React } from "./index-DM9bPmif.js";
import "./index-EDRsojbr.js";
import { S as Subject, t as tap, q as queueScheduler, a as asapScheduler, o as onErrorResumeNextWith, d as defer, c as connectable, i as iif, E as EMPTY, f as finalize, k as share, s as shareReplay, m as merge, b as of, e as distinctUntilChanged, g as filter, h as concatMap, j as toArray } from "./tap-BGJrnwbl.js";
...
function usePropertyFilterBuilder(props) {
  ...
  const [state, setState] = reactExports.useState(
    initialFilter ? convertFilterToState(initialFilter, props == null ? void 0 : props.allowInitialEmptyRules) : { rootGroup: createEmptyRuleGroup() }
  );
  ...
  const buildFilter = reactExports.useCallback(
    (options) => {
      ...
      return ruleErrors.size === 0 || (options == null ? void 0 : options.allowEmptyRules) ? buildPropertyFilter(state.rootGroup, options == null ? void 0 : options.allowEmptyRules) : void 0;
    },
...
function buildPropertyFilter(groupItem, allowEmptyRules) {
...
function buildPropertyFilterFromRuleGroup(rootGroup, allowEmptyRules) {
...
function buildPropertyFilterFromRule(rule, allowEmptyRules) {
  const { property: property2, operator, value } = rule;
  ...
  if (!allowEmptyRules && !isUnaryPropertyFilterOperator(operator) && isEmptyValue(value)) {
    return void 0;
  }
  return { property: property2, operator, value };
}
function buildPropertyFilterFromRangeRule(rule, allowEmptyRules) {
  const { property: property2, operator, value } = rule;
  if (!allowEmptyRules && (!value || value.valueFormat !== PropertyValueFormat.Primitive || typeof value.value !== "string")) {
    return void 0;
  }
  const { to, from: from2 } = PropertyFilterBuilderRuleRangeValue.parse(value);
  if (!allowEmptyRules && (isEmptyValue(to) || isEmptyValue(from2))) {
    return void 0;
  }
  return {
...
function getRuleGroupItem(filter2, parentId, allowInitialEmptyRules) {
  const id = Guid.createValue();
  if (isPropertyFilterRuleGroup(filter2)) {
    ...
    return rangeRule ? rangeRule : {
      ...
      items: filter2.rules.map(
        (rule) => getRuleGroupItem(rule, id, allowInitialEmptyRules)
      )
    };
  }
...
function getRangeRuleItems(group, parentId, allowInitialEmptyRules) {
  if (group.rules.length !== 2) {
    return void 0;
  }
  const [from2, to] = group.rules;
  if (isPropertyFilterRuleGroup(from2) || isPropertyFilterRuleGroup(to) || from2.property.name !== to.property.name) {
    return void 0;
  }
  if (!allowInitialEmptyRules && (!from2.value || from2.value.valueFormat !== PropertyValueFormat.Primitive || !to.value || to.value.valueFormat !== PropertyValueFormat.Primitive)) {
    return void 0;
  }
  if (from2.value && from2.value.valueFormat !== PropertyValueFormat.Primitive || to.value && to.value.valueFormat !== PropertyValueFormat.Primitive) {
    return void 0;
  }
  if (from2.operator === "greater-or-equal" && to.operator === "less-or-equal" && group.operator === "and") {
    return {
      ...
      value: PropertyFilterBuilderRuleRangeValue.serialize({
        from: from2.value ?? { valueFormat: PropertyValueFormat.Primitive },
...
function convertFilterToState(filter2, allowInitialEmptyRules) {
  const id = Guid.createValue();
  if (isPropertyFilterRuleGroup(filter2)) {
    return {
      rootGroup: {
      ...
      if (ToolbarItemUtilities.isGroupButton(panelItem)) {
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          GroupToolExpander,
          {
            ...
            label,
            icon,
            badge: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { type: panelItem.badgeType }),
            item: panelItem,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              props.badge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "components-badge", children: activeAction ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { type: activeAction.badgeType }) : props.badge }),
...
function PopupItemPopup(props) {
  ...
  return (
    // eslint-disable-next-line deprecation/deprecation
    /* @__PURE__ */ jsxRuntimeExports.jsx(Popup, { className, offset: 0, showShadow: false, ...props })
  );
}
try {
...
function CustomItem({
  ...
  const icon = reactExports.useMemo(
    ...
    IconHelper.getIconReactNode(item.icon, item.internalData) || /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "icon", iconSpec: /* @__PURE__ */ jsxRuntimeExports.jsx(SvgPlaceholder, {}) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    PopupItem,
    {
      ...
      badge: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { type: item.badgeType }),
      addGroupSeparator,
...
NestedCategories.parameters = {
  ...NestedCategories.parameters,
  docs: {
    ...(_k = NestedCategories.parameters) == null ? void 0 : _k.docs,
    source: {
      originalSource: '{\n  args: {\n    orientation: Orientation.Horizontal,\n    dataProvider: {\n      getData: async () => ({\n        label: PropertyRecord.fromString("Record 1"),\n        categories: [{\n          name: "category1",\n          label: "Category 1",\n          expand: true,\n          childCategories: [{\n            name: "category11",\n            label: "Category 1-1",\n            expand: true,\n            childCategories: [{\n              name: "category111",\n              label: "Category 1-1-1",\n              expand: true\n            }, {\n              name: "category112",\n              label: "Category 1-1-2",\n              expand: true\n            }]\n          }, {\n            name: "category12",\n            label: "Category 1-2",\n            expand: true\n          }]\n        }, {\n          name: "category2",\n          label: "Category 2",\n          expand: true,\n          childCategories: [{\n            name: "category21",\n            label: "Category 2-1",\n            expand: true,\n            childCategories: [{\n              name: "category211",\n              label: "Category 2-1-1",\n              expand: true\n            }, {\n              name: "category212",\n              label: "Category 2-1-2",\n              expand: true\n            }]\n          }, {\n            name: "category22",\n            label: "Category 2-2",\n            expand: true\n          }]\n        }],\n        records: {\n          category1: createDefaultRecords(),\n          category11: createDefaultRecords(),\n          category111: createDefaultRecords(),\n          category112: createDefaultRecords(),\n          category12: createDefaultRecords(),\n          category2: createDefaultRecords(),\n          category21: createDefaultRecords(),\n          category211: createDefaultRecords(),\n          category212: createDefaultRecords(),\n          category22: createDefaultRecords()\n        }\n      }),\n      onDataChanged: new PropertyDataChangeEvent()\n    }\n  }\n}',
      ...(_m = (_l = NestedCategories.parameters) == null ? void 0 : _l.docs) == null ? void 0 : _m.source
    }
  }
};
Links.parameters = {
  ...Links.parameters,
  docs: {
    ...(_n = Links.parameters) == null ? void 0 : _n.docs,
    source: {
      originalSource: '{\n  args: {\n    dataProvider: {\n      getData: async () => ({\n        label: PropertyRecord.fromString("Record 1"),\n        categories: [{\n          name: "Group_1",\n          label: "Group 1",\n          expand: true\n        }],\n        records: {\n          Group_1: [PropertyRecord.fromString("https://www.bentley.com"), PropertyRecord.fromString("pw://test")]\n        }\n      }),\n      onDataChanged: new PropertyDataChangeEvent()\n    },\n    onPropertyContextMenu: undefined\n  }\n}',
      ...(_p = (_o = Links.parameters) == null ? void 0 : _o.docs) == null ? void 0 : _p.source
    }
  }
};
