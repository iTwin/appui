import { cI as useTranslation, ao as Select, cJ as parseFormatType, a5 as Label, cK as FormatType, a0 as Input, V as Icon, cL as RatioType, cM as FractionalPrecision, cN as DecimalPrecision, cO as ScientificType, cP as Format, cQ as getTraitString, cR as FormatTraits, aJ as Checkbox, cS as ShowSignOption, cT as SvgHelpCircularHollow, cU as parseRatioType, cV as parseShowSignOption, cW as parseScientificType, cX as FormatterSpec, I as IModelApp, cY as getQuantityTypeKey, cZ as isCustomQuantityTypeDefinition, Q as useTranslation$1, U as UiFramework, c_ as useSaveBeforeActivatingNewSettingsTab, c$ as useSaveBeforeClosingSettingsContainer, d0 as Listbox, d1 as ListboxItem, d2 as QuantityType } from "./appui-react-CLN8J6gc.js";
import { K as Key_enumExports, B as Button, c as Dialog$1 } from "./Key.enum-bWQ0azWJ.js";
import { A as AppUiDecorator, I as InitializerDecorator } from "./Decorators-Dm6oIbea.js";
import { e as enumArgType } from "./Utils-BlPrrr_h.js";
import { r as reactExports, c as classnames, e, I as IconButton, j as jsxRuntimeExports } from "./iframe-qZqPc1fv.js";
...
function AzimuthOptions(props) {
  ...
  return e.createElement(
    ...
    e.createElement(Input, { "aria-labelledby": baseInputId, type: "number", value: formatProps.azimuthBase?.toString() ?? "0", onKeyDown, onChange: handleInputChange, size: "small", disabled })
  );
}
