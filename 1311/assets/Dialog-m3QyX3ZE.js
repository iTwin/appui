...
import { K as Key_enumExports, b as Dialog$1, a as DialogButtonType, B as Button } from "./Dialog-B4AlSohG.js";
import { D as DivWithOutsideClick } from "./DivWithOutsideClick-DJKUCiID.js";
import { u as useTranslation } from "./useTranslation-BTLBtDNM.js";
  ...
  render() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Dialog$1,
      {
        ...
        closeOnEsc: false,
        style,
        className: cx("core-dialog", className),
        isDraggable: movable,
...
function DialogButton({
  ...
  switch (button.type) {
    case DialogButtonType.OK:
      ...
      buttonClass = cx(buttonClass, button.buttonStyle);
